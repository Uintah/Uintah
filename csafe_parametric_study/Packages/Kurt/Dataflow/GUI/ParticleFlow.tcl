...
#         scale $w.f2.scale -to -1.0 -from -0.0001 -orient horizontal \
#             -variable $this-time -resolution 0.0001 
        expscale $w.f2.scale -variable $this-time -orient horizontal \
             -label "Particle life time decrement"
        pack  $w.f1.animate $w.f1.freeze -anchor nw
        pack $w.f2.scale -side top -expand yes -fill x
...
#             -resolution 0.00002 -orient horizontal
        expscale $w.f4.s -variable $this-step-size -orient horizontal \
            -label "step size:  "
#        pack $w.f4.f1.l $w.f4.f2.s -expand yes -fill x
        pack $w.f4.s -side top -expand yes -fill x
        ...
        scale $w.f5.f2.s -variable "$this-nparticles" -from 1 -to 10 \
            -orient horizontal
