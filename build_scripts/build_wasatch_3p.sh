...
run "env GIT_SSL_NO_VERIFY=true git clone --depth 1 https://newsoftware.crsim.utah.edu:8443/James_Research_Group/SpatialOps.git SpatialOps"
...
run "cd src"
run "rm -rf ExprLib"
run "env GIT_SSL_NO_VERIFY=true git clone --depth 1 https://newsoftware.crsim.utah.edu:8443/James_Research_Group/ExprLib.git ExprLib"
...
run "cd src"
run "rm -rf TabProps"
run "env GIT_SSL_NO_VERIFY=true git clone --depth 1 https://newsoftware.crsim.utah.edu:8443/James_Research_Group/TabProps.git TabProps"
...
run "cd src"
run "rm -rf RadProps"
run "env GIT_SSL_NO_VERIFY=true git clone --depth 1 https://newsoftware.crsim.utah.edu:8443/James_Research_Group/RadProps.git RadProps"
