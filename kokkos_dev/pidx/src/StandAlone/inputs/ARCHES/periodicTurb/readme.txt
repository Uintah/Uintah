...
Here, the output_filename designates the pdf filename of the exported figure, base_name denotes the base_name in the lineextract output filename, and figure_title is a string that corresponds to the figure's title. 

For example, energy_spectrum_plot_all('tke_arches_dyn_32','32_arches_dyn','Dynamic Model (dynamicprocedure) - 32x32x32') will look for lineextract files with names:
uvel_32_arches_dyn_t0.0s.txt
vvel_32_arches_dyn_t0.0s.txt
wvel_32_arches_dyn_t0.0s.txt

uvel_32_arches_dyn_t0.28s.txt
vvel_32_arches_dyn_t0.28s.txt
wvel_32_arches_dyn_t0.28s.txt

uvel_32_arches_dyn_t0.66s.txt
vvel_32_arches_dyn_t0.66s.txt
wvel_32_arches_dyn_t0.66s.txt

The output pdf figure will have the title tke_arches_dyn_32.pdf and will have the title: Dynamic Model (dynamicprocedure) - 32x32x32.