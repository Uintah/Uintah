...
void 
Operators::sched_create_patch_operators( const LevelP& level, SchedulerP& sched, const MaterialSet* matls ){ 

  Task* tsk = scinew Task( "Operators::create_patch_operators", this, &Operators::create_patch_operators);
...
void 
Operators::create_patch_operators( const ProcessorGroup* pg,
