...
GeoProbeScene::GeoProbeScene(GuiContext* ctx)
  : Module("GeoProbeScene", ctx, Filter, "Scenes", "rtrt"),
    ...
    xa_(get_ctx()->subVar("xa")),
    xb_(get_ctx()->subVar("xb")),
    ya_(get_ctx()->subVar("ya")),
    yb_(get_ctx()->subVar("yb")),
    za_(get_ctx()->subVar("za")),
    zb_(get_ctx()->subVar("zb")),
    gpfilename_(get_ctx()->subVar("gpfilename")),
    iso_min_(get_ctx()->subVar("iso_min")),
    iso_max_(get_ctx()->subVar("iso_max")),
    iso_val_(get_ctx()->subVar("iso_val")),
    xa_act_(get_ctx()->subVar("xa-active")),
    xa_mat_(get_ctx()->subVar("xa-usemat")),
    xb_act_(get_ctx()->subVar("xb-active")),
    xb_mat_(get_ctx()->subVar("xb-usemat")),
    ya_act_(get_ctx()->subVar("ya-active")),
    ya_mat_(get_ctx()->subVar("ya-usemat")),
    yb_act_(get_ctx()->subVar("yb-active")),
    yb_mat_(get_ctx()->subVar("yb-usemat")),
    za_act_(get_ctx()->subVar("za-active")),
    za_mat_(get_ctx()->subVar("za-usemat")),
    zb_act_(get_ctx()->subVar("zb-active")),
    zb_mat_(get_ctx()->subVar("zb-usemat")),
