...
get_type_description(MaskedTriSurfField<T>*)
{
  ...
  if(!td){
    ...
    (*subs)[0] = sub;
    td = scinew TypeDescription("MaskedTriSurfField", subs, __FILE__, "SCIRun");
  }
  return td;
}
...
template <class T>
const TypeDescription* 
MaskedTriSurfField<T>::get_type_description() const 
{
  return SCIRun::get_type_description((MaskedTriSurfField<T>*)0);
}
