itcl_class ModelCreation_ChangeFieldData_SelectByFieldsData {
   inherit Module

    constructor {config} {
        set name SelectByFieldsData
        set_defaults
    }
    ...
    method ui {} {
        ...
        label $info.info1 -text "Function: SELECT = function(DATA1,DATA2,DATA3,A,B,C,...)"
        label $info.info2 -text "Input array: DATA1 (scalar/vector/tensor: data from field port 1) "
        label $info.info2a -text "Input array: DATA2 (scalar/vector/tensor: data from field port 2) "
        label $info.info2b -text "Input array: DATA3 (scalar/vector/tensor: data from field port 3) "
        ...
        label $info.info9 -text "Output array: SELECT (scalar)"
