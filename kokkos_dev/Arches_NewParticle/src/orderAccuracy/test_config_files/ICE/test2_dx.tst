<start>
<upsFile>test2.ups</upsFile>
<Study>Res.Study</Study>

<gnuplot>
  <script>plotRiemannTests.gp</script>s
  <title>ICE: Toro's Test problem 2  X-direction</title>
  <ylabel>Error</ylabel>
...
<Test>
    ...
    <sus_cmd>sus </sus_cmd>
    <Study>Res.Study</Study>
    <postProcess_cmd>compare_Riemann.m -test 2 -pDir 1 -var press_CC -mat 0</postProcess_cmd>
    <x>100</x>
    <replace_lines>
