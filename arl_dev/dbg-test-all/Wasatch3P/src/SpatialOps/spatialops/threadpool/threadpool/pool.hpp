...
/// The namespace thread pool contains a thread pool and related utility classes.
namespace boost { namespace threadpool
{
  ...
  */
  ...
  public:
     ...
     * @brief constructor.
     *
     * @param initial_threads
     * 	The pool is immediately resized to set the specified number of threads. The pool's actual number threads depends on the SizePolicy.
     */
    ...
    /**
     * @brief Gets the size controller which manages the number of threads in the pool.
