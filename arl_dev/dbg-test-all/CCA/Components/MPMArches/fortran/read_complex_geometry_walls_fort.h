...
#ifndef fspec_read_complex_geometry_walls
#define fspec_read_complex_geometry_walls

#ifdef __cplusplus

extern "C" void read_complex_geometry_walls_(int* iccst,
                                             int* jccst,
                                             int* kccst,
...
static void fort_read_complex_geometry_walls( int & iccst,
                                              int & jccst,
                                              int & kccst,
                                              ...
                                              int & tot_walls )
{
  ...
  read_complex_geometry_walls_( &iccst,
                                &jccst,
                                &kccst,
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine read_complex_geometry_walls(iccst, jccst, kccst, 
     & inext_low_x, inext_low_y, inext_low_z, inext_high_x, 
     & inext_high_y, inext_high_z, inext, jnext_low_x, jnext_low_y, 
     & jnext_low_z, jnext_high_x, jnext_high_y, jnext_high_z, jnext, 
     & knext_low_x, knext_low_y, knext_low_z, knext_high_x, 
     & knext_high_y, knext_high_z, knext, epsg_low_x, epsg_low_y, 
     & epsg_low_z, epsg_high_x, epsg_high_y, epsg_high_z, epsg, 
     & totarea_low_x, totarea_low_y, totarea_low_z, totarea_high_x, 
     & totarea_high_y, totarea_high_z, totarea, nbar1_low_x, 
     & nbar1_low_y, nbar1_low_z, nbar1_high_x, nbar1_high_y, 
     & nbar1_high_z, nbar1, nbar2_low_x, nbar2_low_y, nbar2_low_z, 
     & nbar2_high_x, nbar2_high_y, nbar2_high_z, nbar2, nbar3_low_x, 
     & nbar3_low_y, nbar3_low_z, nbar3_high_x, nbar3_high_y, 
     & nbar3_high_z, nbar3, cbar1_low_x, cbar1_low_y, cbar1_low_z, 
     & cbar1_high_x, cbar1_high_y, cbar1_high_z, cbar1, cbar2_low_x, 
     & cbar2_low_y, cbar2_low_z, cbar2_high_x, cbar2_high_y, 
     & cbar2_high_z, cbar2, cbar3_low_x, cbar3_low_y, cbar3_low_z, 
     & cbar3_high_x, cbar3_high_y, cbar3_high_z, cbar3, gaf_x_low_x, 
     & gaf_x_low_y, gaf_x_low_z, gaf_x_high_x, gaf_x_high_y, 
     & gaf_x_high_z, gaf_x, gaf_xe_low_x, gaf_xe_low_y, gaf_xe_low_z, 
     & gaf_xe_high_x, gaf_xe_high_y, gaf_xe_high_z, gaf_xe, gaf_y_low_x
     & , gaf_y_low_y, gaf_y_low_z, gaf_y_high_x, gaf_y_high_y, 
     & gaf_y_high_z, gaf_y, gaf_yn_low_x, gaf_yn_low_y, gaf_yn_low_z, 
     & gaf_yn_high_x, gaf_yn_high_y, gaf_yn_high_z, gaf_yn, gaf_z_low_x
     & , gaf_z_low_y, gaf_z_low_z, gaf_z_high_x, gaf_z_high_y, 
     & gaf_z_high_z, gaf_z, gaf_zt_low_x, gaf_zt_low_y, gaf_zt_low_z, 
     & gaf_zt_high_x, gaf_zt_high_y, gaf_zt_high_z, gaf_zt, patchindex,
     &  tot_walls)
...
#endif /* fspec_read_complex_geometry_walls */
