...
#ifndef fspec_rordrss
#define fspec_rordrss

#ifdef __cplusplus

extern "C" void rordrss_(int* sn,
...
static void fort_rordrss( int & sn,
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine rordrss(sn, oxi_low, oxi_high, oxi, omu_low, omu_high,
