...
extern "C" void mm_computevel_(int* uu_low_x, int* uu_low_y, int* uu_low_z, int* uu_high_x, int* uu_high_y, int* uu_high_z, double* uu_ptr,
                                ...
                                int & mmwallid )
{
  ...
  mm_computevel_( &uu_low_x, &uu_low_y, &uu_low_z, &uu_high_x, &uu_high_y, &uu_high_z, uu.getPointer(),
