...
private:
  ...
  //======INITIALIZATION: 
  template <typename IT, typename DT>
  void ExampleParticleModel<IT, DT>::register_initialize( std::vector<VariableInformation>& variable_registry ){ 
  ...
  template <typename IT, typename DT>
  void ExampleParticleModel<IT, DT>::register_timestep_init( std::vector<VariableInformation>& variable_registry ){ 
  }
  ...
  template <typename IT, typename DT>
  void ExampleParticleModel<IT, DT>::register_timestep_eval( std::vector<VariableInformation>& variable_registry, const int time_substep ){ 
    ...
    for ( int i = 0; i < _N; i++ ){ 
      ...
      //register_variable( temperature_name, _I_type, REQUIRES, 0, LATEST, variable_registry, time_substep ); 
    ...
    register_variable( _temperature_var_name, _I_type, REQUIRES, 0, LATEST, variable_registry, time_substep ); 
    register_variable( _conc_var_name, _I_type, REQUIRES, 0, LATEST, variable_registry, time_substep ); 
    //end temp: 
