...
*   NIST FIRE PARAMETERS
*___________________________________*/
#define N_THERMAL_ELEMENTS 1000             /* Max. number of thermnal elements             */
#define RAD_COEFFICIENT  0.35               /* chi in the Q_chem equation                   */     

/*__________________________________
*   GEOMETRY DEFINITIONS    
*___________________________________*/
#define X_MAX_LIM       51                  /* Max. array size in the x dir.  xHiLimit + 2 */
#define Y_MAX_LIM       30                  /* Max. array size in the y dir.  yHiLimit + 2 */
...
#define N_ITERATIONS_TO_STABILIZE     20    /* number of iteration for the solution to      */
...
#define LIMIT_GRADIENT_FLAG 1               /* Flag for selecting different                 */
                                            /* of gradient limiters                         */
                                            /*  0 = No limiter                              */
                                            /*  1 = Comptible Flux paper                    */
                                            /*  2 = CFDLIB limiter                          */
#define SECOND_ORDER_ADVECTION 1            /*  0 = First order advection                   */
...
*   PLOTTING VARIABLES
*___________________________________*/
#define PLOT_NEAR_ZERO_CUTOFF 1e-15          /* How sensitive the plots are when ymax and    */
                                            /* ymin are near zero                           */ 
