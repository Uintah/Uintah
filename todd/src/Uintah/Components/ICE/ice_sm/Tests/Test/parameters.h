...
*   of sound
*___________________________________*/
#define compute_delt_based_on_velocity 1      
                                            /* =1 convective velocity                       */
                                            /* =2 speed of sound                            */
                                            /* =3 fabs(velocity) + speed of sounce          */
#define N_ITERATIONS_TO_STABILIZE     1    /* number of iteration for the solution to      */
...
#define SYMBOL               5              /* 2d line symbol                               */
#define SYMBOL_SIZE         0.75            /* 2D Line symbol size                          */
#define GRAPHDESC  "Test bed main"
#define GRAPHDESC2 ""
#define GRAPHDESC3 ""
#define GRAPHDESC4 ""
