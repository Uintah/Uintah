...
/*
 *  ScalarFieldRGfloat.h: float Scalar Fields defined on a Regular grid
 *
 *  Written by:
...
#ifndef SCI_project_ScalarFieldRGfloat_h
#define SCI_project_ScalarFieldRGfloat_h 1
...
class SCICORESHARE ScalarFieldRGfloat : public ScalarFieldRGBase {
public:
    Array3<float> grid;

    void resize(int, int, int);
    ScalarFieldRGfloat();
    ScalarFieldRGfloat(const ScalarFieldRGfloat&);
    virtual ~ScalarFieldRGfloat();
...
inline
double
ScalarFieldRGfloat::get_value( const Point& ivoxel )
{
...
inline
double
ScalarFieldRGfloat::get_value( int x, int y, int z )
{
  return grid( x, y, z );
}
...
// Initial commit
//
// Revision 1.4  1999/07/07 21:10:41  dav
