...
// DO-NOT-DELETE splicer.begin(framework.Services._hincludes)
#include <Framework/Babel/BabelPortInstance.h>
#include <Core/Thread/Mutex.h>

using namespace SCIRun;
// DO-NOT-DELETE splicer.end(framework.Services._hincludes)
...
namespace framework { 
   ...
   */
  class Services_impl : public virtual ::framework::Services 
  ...
  public:
    ...
    // (fixes bug #275)
      Services_impl( struct framework_Services__object * ior ) : StubBase(ior,
        true), 
...
// DO-NOT-DELETE splicer.begin(framework.Services._hmisc)
// insert code here (miscellaneous things)
// DO-NOT-DELETE splicer.end(framework.Services._hmisc)
