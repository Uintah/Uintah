...
/* #define HAVE_LOCKED_STATIC_GLOBALS (1) */
  ...
  static struct pde_Tri__epv s_rem_epv__pde_tri;
  ...
  static void* remote_pde_Tri__cast(
    ...
    const char* name, sidl_BaseInterface* _ex)
  {
    ...
    *_ex = NULL; /* default to no exception */
    ...
    if ((*self->d_epv->f_isType)(self,name, _ex)) {
      ...
      cast =  (*func)(((struct pde_Tri__remote*)self->d_data)->d_ih, _ex);
    }
  ...
  static void remote_pde_Tri__delete(
    struct pde_Tri__object* self,
  ...
  static void remote_pde_Tri__raddRef(
    struct pde_Tri__object* self,struct sidl_BaseInterface__object* *_ex)
  {
    ...
    *_ex = NULL;
    {
      ...
      "Exception unserialized from pde.Tri._set_hooks.",
          &throwaway_exception);
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.Tri._set_contracts.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.Tri._dump_stats.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static void remote_pde_Tri__exec(
    struct pde_Tri__object* self,const char* methodName,
    ...
    /* out */ struct sidl_BaseInterface__object **_ex)
  {
    ...
    *_ex = NULL;
    {
      struct pde_Tri__remote* r_obj = (struct pde_Tri__remote*)self->d_data;
      LOCK_STATIC_GLOBALS;
      r_obj->d_refcount++;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.Tri.isSame.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.Tri.isType.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.Tri.getClassInfo.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.Tri.triangulate.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.Tri.setServices.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static void pde_Tri__init_remote_epv(void)
  {
    // assert( HAVE_LOCKED_STATIC_GLOBALS );
    struct pde_Tri__epv*            epv = &s_rem_epv__pde_tri;
    struct gov_cca_Component__epv*  e0  = &s_rem_epv__gov_cca_component;
    struct gov_cca_Port__epv*       e1  = &s_rem_epv__gov_cca_port;
    struct pdeports_MeshPort__epv*  e2  = &s_rem_epv__pdeports_meshport;
    struct sidl_BaseClass__epv*     e3  = &s_rem_epv__sidl_baseclass;
    struct sidl_BaseInterface__epv* e4  = &s_rem_epv__sidl_baseinterface;

    epv->f__cast               = remote_pde_Tri__cast;
    epv->f__delete             = remote_pde_Tri__delete;
    epv->f__exec               = remote_pde_Tri__exec;
    epv->f__getURL             = remote_pde_Tri__getURL;
    epv->f__raddRef            = remote_pde_Tri__raddRef;
    epv->f__isRemote           = remote_pde_Tri__isRemote;
    epv->f__set_hooks          = remote_pde_Tri__set_hooks;
    epv->f__set_contracts      = remote_pde_Tri__set_contracts;
    epv->f__dump_stats         = remote_pde_Tri__dump_stats;
    epv->f__ctor               = NULL;
    epv->f__ctor2              = NULL;
    epv->f__dtor               = NULL;
    epv->f_addRef              = remote_pde_Tri_addRef;
    epv->f_deleteRef           = remote_pde_Tri_deleteRef;
    epv->f_isSame              = remote_pde_Tri_isSame;
    epv->f_isType              = remote_pde_Tri_isType;
    epv->f_getClassInfo        = remote_pde_Tri_getClassInfo;
    epv->f_triangulate         = remote_pde_Tri_triangulate;
    epv->f_setServices         = remote_pde_Tri_setServices;
    ...
    e2->f__exec          = (void (*)(void*,const char*,struct 
      sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
      sidl_BaseInterface__object **)) epv->f__exec;
    e2->f_triangulate    = (int32_t (*)(void*,struct sidl_double__array*,struct 
  ...
  static struct pde_Tri__object*
  pde_Tri__remoteConnect(const char *url, sidl_bool ar, struct 
    sidl_BaseInterface__object* *_ex)
  {
    struct pde_Tri__object* self = NULL;

    struct pde_Tri__object* s0;
    struct sidl_BaseClass__object* s1;

    struct pde_Tri__remote* r_obj = NULL;
    ...
    *_ex = NULL;
    ...
    if(objectID) {
      struct pde_Tri__object* retobj = NULL;
      struct sidl_BaseInterface__object *throwaway_exception;
      sidl_BaseInterface bi = (
        sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(
        objectID, _ex); SIDL_CHECK(*_ex);
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
      retobj = (struct pde_Tri__object*) (*bi->d_epv->f__cast)(bi->d_object, 
        "pde.Tri", _ex);
      if(!ar) { 
        (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
      }
    ...
    instance = sidl_rmi_ProtocolFactory_connectInstance(url, "pde.Tri", ar, _ex 
      ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct pde_Tri__object*) malloc(
        sizeof(struct pde_Tri__object));

    r_obj =
      (struct pde_Tri__remote*) malloc(
        sizeof(struct pde_Tri__remote));
  ...
  static struct pde_Tri__object*
  pde_Tri__IHConnect(sidl_rmi_InstanceHandle instance, struct 
    sidl_BaseInterface__object* *_ex)
  {
    struct pde_Tri__object* self = NULL;
  ...
  static struct pde_Tri__object*
  pde_Tri__remoteCreate(const char *url, struct sidl_BaseInterface__object 
    **_ex)
  {
    ...
    sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
      url, "pde.Tri", _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct pde_Tri__object*) malloc(
        sizeof(struct pde_Tri__object));
  ...
  pde_Tri__connectI(const char* url, sidl_bool ar, struct 
    sidl_BaseInterface__object **_ex)
  {
    return pde_Tri__remoteConnect(url, ar, _ex);
  }
 ...
 */
int32_t
pde::Tri::triangulate( /* in array<double> */const ::sidl::array<double>& nodes,
  /* in array<int> */const ::sidl::array<int32_t>& boundaries, /* out 
  array<int> */::sidl::array<int32_t>& triangles )

{
  int32_t _result;
  ior_t* const loc_self = (struct pde_Tri__object*) ::pde::Tri::_get_ior();
  struct sidl_int__array* _local_triangles;
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_triangulate))(loc_self, /* in array<double> 
    */ nodes._get_ior(), /* in array<int> */ boundaries._get_ior(), /* out 
    array<int> */ &_local_triangles, &_exception );
  /*dispatch to ior*/
  if (_exception != NULL ) {
 ...
 */
void
pde::Tri::setServices( /* in */const ::gov::cca::Services& services )
// throws:
//   ::gov::cca::CCAException
//   ::sidl::RuntimeException
...
pde::Tri::_create() {
  ...
  ::pde::Tri self( (*_get_ext()->createObject)(NULL, &_exception), false );
  if (_exception != NULL) {
    throwException0("::pde::Tri"
...
::pde::Tri::ior_t*
pde::Tri::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception = NULL;
  ::pde::Tri::ior_t* returnValue = (*_get_ext()->createObject)(private_data ,
    &_exception);
  if (_exception) {
    throwException0("::pde::Tri._wrap", _exception);
  }
  return returnValue;
}
...
// remote constructor
::pde::Tri
pde::Tri::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception = NULL;
  ior_self = pde_Tri__remoteCreate( url.c_str(), &_exception );
  if (_exception != NULL ) {
    throwException0("::pde::Tri remoteCreate", _exception);
  }
  return ::pde::Tri( ior_self, false );
}

// remote connector
::pde::Tri
pde::Tri::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception = NULL;
  ior_self = pde_Tri__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_exception );
  if (_exception != NULL ) {
    throwException0("::pde::Tri connect",_exception);
  }
  return ::pde::Tri( ior_self, false );
}

// copy constructor
pde::Tri::Tri ( const ::pde::Tri& original ) {
  _set_ior((struct pde_Tri__object*) original.::pde::Tri::_get_ior());
  if(d_self) {
    addRef();
  }
...
// assignment operator
::pde::Tri&
pde::Tri::operator=( const ::pde::Tri& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    _set_ior((struct pde_Tri__object*) rhs.::pde::Tri::_get_ior());
    if(d_self) {
      addRef();
    }
    d_weak_reference = false;
...
pde::Tri::Tri ( ::pde::Tri::ior_t* ior, bool isWeak ) : 
...
int ::pde::Tri::_set_ior_typesafe( struct sidl_BaseInterface__object *obj,
...
void ::pde::Tri::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::pde::Tri::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
void
pde::Tri::_set_hooks( /* in */bool enable )
// throws:
//   ::sidl::RuntimeException
 ...
 */
void
pde::Tri::_set_contracts( /* in */bool enable, /* in */const ::std::string& 
 ...
 */
void
pde::Tri::_dump_stats( /* in */const ::std::string& filename, /* in */const 
  ::std::string& prefix )
// throws:
//   ::sidl::RuntimeException
...
struct pde_Tri__object* pde::Tri::_cast(const void* src)
{
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("pde.Tri", (
      void*)pde_Tri__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "pde.Tri", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::pde::Tri::ext_t * pde::Tri::s_ext = 0;
  ...
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    ...
    s_ext = pde_Tri__externals();
#else
    s_ext = (struct pde_Tri__external*)sidl_dynamicLoadIOR("pde.Tri",
      "pde_Tri__externals") ;
#endif
    sidl_checkIORVersion("pde.Tri", s_ext->d_ior_major_version, 
