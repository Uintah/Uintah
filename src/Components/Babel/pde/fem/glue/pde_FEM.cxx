...
/* #define HAVE_LOCKED_STATIC_GLOBALS (1) */
  ...
  static struct pde_FEM__epv s_rem_epv__pde_fem;
  ...
  static void* remote_pde_FEM__cast(
    ...
    const char* name, sidl_BaseInterface* _ex)
  {
    ...
    *_ex = NULL; /* default to no exception */
    ...
    if ((*self->d_epv->f_isType)(self,name, _ex)) {
      ...
      cast =  (*func)(((struct pde_FEM__remote*)self->d_data)->d_ih, _ex);
    }
  ...
  static void remote_pde_FEM__delete(
    struct pde_FEM__object* self,
  ...
  static void remote_pde_FEM__raddRef(
    struct pde_FEM__object* self,struct sidl_BaseInterface__object* *_ex)
  {
    ...
    *_ex = NULL;
    {
      ...
      "Exception unserialized from pde.FEM._set_hooks.",
          &throwaway_exception);
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.FEM._set_contracts.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.FEM._dump_stats.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static void remote_pde_FEM__exec(
    struct pde_FEM__object* self,const char* methodName,
    ...
    /* out */ struct sidl_BaseInterface__object **_ex)
  {
    ...
    *_ex = NULL;
    {
      struct pde_FEM__remote* r_obj = (struct pde_FEM__remote*)self->d_data;
      LOCK_STATIC_GLOBALS;
      r_obj->d_refcount++;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.FEM.isSame.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.FEM.isType.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.FEM.getClassInfo.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static int32_t
  remote_pde_FEM_makeFEMmatrices(
    /* in */ struct pde_FEM__object*self ,
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.FEM.makeFEMmatrices.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.FEM.setServices.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static void pde_FEM__init_remote_epv(void)
  {
    // assert( HAVE_LOCKED_STATIC_GLOBALS );
    struct pde_FEM__epv*                epv = &s_rem_epv__pde_fem;
    struct gov_cca_Component__epv*      e0  = &s_rem_epv__gov_cca_component;
    struct gov_cca_Port__epv*           e1  = &s_rem_epv__gov_cca_port;
    struct pdeports_FEMmatrixPort__epv* e2  = 
    ...
    epv->f__cast                = remote_pde_FEM__cast;
    epv->f__delete              = remote_pde_FEM__delete;
    epv->f__exec                = remote_pde_FEM__exec;
    epv->f__getURL              = remote_pde_FEM__getURL;
    epv->f__raddRef             = remote_pde_FEM__raddRef;
    epv->f__isRemote            = remote_pde_FEM__isRemote;
    epv->f__set_hooks           = remote_pde_FEM__set_hooks;
    epv->f__set_contracts       = remote_pde_FEM__set_contracts;
    epv->f__dump_stats          = remote_pde_FEM__dump_stats;
    epv->f__ctor                = NULL;
    epv->f__ctor2               = NULL;
    epv->f__dtor                = NULL;
    epv->f_addRef               = remote_pde_FEM_addRef;
    epv->f_deleteRef            = remote_pde_FEM_deleteRef;
    epv->f_isSame               = remote_pde_FEM_isSame;
    epv->f_isType               = remote_pde_FEM_isType;
    epv->f_getClassInfo         = remote_pde_FEM_getClassInfo;
    epv->f_makeFEMmatrices      = remote_pde_FEM_makeFEMmatrices;
    epv->f_setServices          = remote_pde_FEM_setServices;
    ...
    e2->f__exec           = (void (*)(void*,const char*,struct 
      sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
      sidl_BaseInterface__object **)) epv->f__exec;
    e2->f_makeFEMmatrices = (int32_t (*)(void*,struct sidl_int__array*,struct 
  ...
  static struct pde_FEM__object*
  pde_FEM__remoteConnect(const char *url, sidl_bool ar, struct 
    sidl_BaseInterface__object* *_ex)
  {
    struct pde_FEM__object* self = NULL;

    struct pde_FEM__object* s0;
    struct sidl_BaseClass__object* s1;

    struct pde_FEM__remote* r_obj = NULL;
    ...
    *_ex = NULL;
    ...
    if(objectID) {
      struct pde_FEM__object* retobj = NULL;
      struct sidl_BaseInterface__object *throwaway_exception;
      sidl_BaseInterface bi = (
        sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(
        objectID, _ex); SIDL_CHECK(*_ex);
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
      retobj = (struct pde_FEM__object*) (*bi->d_epv->f__cast)(bi->d_object, 
        "pde.FEM", _ex);
      if(!ar) { 
        (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
      }
    ...
    instance = sidl_rmi_ProtocolFactory_connectInstance(url, "pde.FEM", ar, _ex 
      ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct pde_FEM__object*) malloc(
        sizeof(struct pde_FEM__object));

    r_obj =
      (struct pde_FEM__remote*) malloc(
        sizeof(struct pde_FEM__remote));
  ...
  static struct pde_FEM__object*
  pde_FEM__IHConnect(sidl_rmi_InstanceHandle instance, struct 
    sidl_BaseInterface__object* *_ex)
  {
    struct pde_FEM__object* self = NULL;
  ...
  static struct pde_FEM__object*
  pde_FEM__remoteCreate(const char *url, struct sidl_BaseInterface__object 
    **_ex)
  {
    ...
    sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
      url, "pde.FEM", _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct pde_FEM__object*) malloc(
        sizeof(struct pde_FEM__object));
  ...
  pde_FEM__connectI(const char* url, sidl_bool ar, struct 
    sidl_BaseInterface__object **_ex)
  {
    return pde_FEM__remoteConnect(url, ar, _ex);
  }
 ...
 */
int32_t
pde::FEM::makeFEMmatrices( /* in array<int> */const ::sidl::array<int32_t>& 
  mesh, /* in array<double> */const ::sidl::array<double>& nodes, /* in 
  array<int> */const ::sidl::array<int32_t>& dirichletNodes, /* in 
  array<double> */const ::sidl::array<double>& dirichletValues, /* out 
  array<double,2> */::sidl::array<double>& Ag, /* out array<double> 
  */::sidl::array<double>& fg, /* out */int32_t& size )

{
  int32_t _result;
  ior_t* const loc_self = (struct pde_FEM__object*) ::pde::FEM::_get_ior();
  struct sidl_double__array* _local_Ag;
  struct sidl_double__array* _local_fg;
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_makeFEMmatrices))(loc_self, /* in array<int> 
    */ mesh._get_ior(), /* in array<double> */ nodes._get_ior(), /* in 
    array<int> */ dirichletNodes._get_ior(), /* in array<double> */ 
 ...
 */
void
pde::FEM::setServices( /* in */const ::gov::cca::Services& services )
// throws:
//   ::gov::cca::CCAException
//   ::sidl::RuntimeException
...
pde::FEM::_create() {
  ...
  ::pde::FEM self( (*_get_ext()->createObject)(NULL, &_exception), false );
  if (_exception != NULL) {
    throwException0("::pde::FEM"
...
::pde::FEM::ior_t*
pde::FEM::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception = NULL;
  ::pde::FEM::ior_t* returnValue = (*_get_ext()->createObject)(private_data ,
    &_exception);
  if (_exception) {
    throwException0("::pde::FEM._wrap", _exception);
  }
  return returnValue;
}
...
// remote constructor
::pde::FEM
pde::FEM::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception = NULL;
  ior_self = pde_FEM__remoteCreate( url.c_str(), &_exception );
  if (_exception != NULL ) {
    throwException0("::pde::FEM remoteCreate", _exception);
  }
  return ::pde::FEM( ior_self, false );
}

// remote connector
::pde::FEM
pde::FEM::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception = NULL;
  ior_self = pde_FEM__remoteConnect( url.c_str(), ar?TRUE:FALSE, &_exception );
  if (_exception != NULL ) {
    throwException0("::pde::FEM connect",_exception);
  }
  return ::pde::FEM( ior_self, false );
}

// copy constructor
pde::FEM::FEM ( const ::pde::FEM& original ) {
  _set_ior((struct pde_FEM__object*) original.::pde::FEM::_get_ior());
  if(d_self) {
    addRef();
  }
...
// assignment operator
::pde::FEM&
pde::FEM::operator=( const ::pde::FEM& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    _set_ior((struct pde_FEM__object*) rhs.::pde::FEM::_get_ior());
    if(d_self) {
      addRef();
    }
    d_weak_reference = false;
...
pde::FEM::FEM ( ::pde::FEM::ior_t* ior ) : 
  ...
  ::pdeports::FEMmatrixPort((ior==NULL) ? NULL : &((
    *ior).d_pdeports_femmatrixport)) {}

// Alternate constructor: does not call addRef()
// (sets d_weak_reference=isWeak)
// For internal use by Impls (fixes bug#275)
pde::FEM::FEM ( ::pde::FEM::ior_t* ior, bool isWeak ) : 
...
int ::pde::FEM::_set_ior_typesafe( struct sidl_BaseInterface__object *obj,
...
void ::pde::FEM::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::pde::FEM::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
void
pde::FEM::_set_hooks( /* in */bool enable )
// throws:
//   ::sidl::RuntimeException
 ...
 */
void
pde::FEM::_set_contracts( /* in */bool enable, /* in */const ::std::string& 
  enfFilename, /* in */bool resetCounters )
// throws:
//   ::sidl::RuntimeException
 ...
 */
void
pde::FEM::_dump_stats( /* in */const ::std::string& filename, /* in */const 
  ::std::string& prefix )
// throws:
//   ::sidl::RuntimeException
...
struct pde_FEM__object* pde::FEM::_cast(const void* src)
{
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("pde.FEM", (
      void*)pde_FEM__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "pde.FEM", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::pde::FEM::ext_t * pde::FEM::s_ext = 0;
  ...
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
    ...
    s_ext = pde_FEM__externals();
#else
    s_ext = (struct pde_FEM__external*)sidl_dynamicLoadIOR("pde.FEM",
      "pde_FEM__externals") ;
#endif
    sidl_checkIORVersion("pde.FEM", s_ext->d_ior_major_version, 
