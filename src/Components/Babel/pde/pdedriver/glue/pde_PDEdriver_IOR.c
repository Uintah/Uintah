...
static struct pde_PDEdriver__epv s_my_epv__pde_pdedriver;

static struct pde_PDEdriver__epv s_my_epv_contracts__pde_pdedriver;

static struct pde_PDEdriver__epv s_my_epv_hooks__pde_pdedriver;
...
static struct pde_PDEdriver__pre_epv s_preEPV;
static struct pde_PDEdriver__post_epv s_postEPV;
...
extern void pde_PDEdriver__set_epv(
  struct pde_PDEdriver__epv* epv,
    struct pde_PDEdriver__pre_epv* pre_epv,
    struct pde_PDEdriver__post_epv* post_epv);

extern void pde_PDEdriver__call_load(void);
#ifdef __cplusplus
}
#endif

static void
pde_PDEdriver_addRef__exec(
...
pde_PDEdriver_isSame__exec(
  ...
  iobj = skel_pde_PDEdriver_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct pde_PDEdriver__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, 
      "pde.PDEdriver", _ex);
    if(iobj != NULL) {
...
static void
pde_PDEdriver_getClassInfo__exec(
        struct pde_PDEdriver__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
pde_PDEdriver_setServices__exec(
        struct pde_PDEdriver__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  services = skel_pde_PDEdriver_fconnect_gov_cca_Services(services_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  services_bc = sidl_rmi_InstanceRegistry_getInstanceByString(services_str, 
    _ex);SIDL_CHECK(*_ex);
  if(services_bc != NULL) {
    services= (struct pde_PDEdriver__object*) (*services_bc->d_epv->f__cast)(
      services_bc, "pde.PDEdriver", _ex);
    if(services != NULL) {
...
static void ior_pde_PDEdriver__set_contracts(
  struct pde_PDEdriver__object* self,
  sidl_bool   enable,
...
static void ior_pde_PDEdriver__dump_stats(
  struct pde_PDEdriver__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_pde_PDEdriver__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    pde_PDEdriver__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_pde_PDEdriver__cast(
  struct pde_PDEdriver__object* self,
...
static void ior_pde_PDEdriver__set_hooks(
  struct pde_PDEdriver__object* self,
...
static void ior_pde_PDEdriver__delete(
  struct pde_PDEdriver__object* self, struct sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  pde_PDEdriver__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct pde_PDEdriver__object));
  free((void*) self);
}

static char*
ior_pde_PDEdriver__getURL(
  struct pde_PDEdriver__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_pde_PDEdriver__raddRef(
    struct pde_PDEdriver__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_pde_PDEdriver__isRemote(
    struct pde_PDEdriver__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct pde_PDEdriver__method {
  const char *d_name;
  void (*d_func)(struct pde_PDEdriver__object*,
...
ior_pde_PDEdriver__exec(
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct pde_PDEdriver__method  s_methods[] = {
    { "_cast", pde_PDEdriver__cast__exec },
    { "addRef", pde_PDEdriver_addRef__exec },
    { "deleteRef", pde_PDEdriver_deleteRef__exec },
    { "getClassInfo", pde_PDEdriver_getClassInfo__exec },
    { "go", pde_PDEdriver_go__exec },
    { "isSame", pde_PDEdriver_isSame__exec },
    { "isType", pde_PDEdriver_isType__exec },
    { "setServices", pde_PDEdriver_setServices__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct pde_PDEdriver__method);
  *_ex  = NULL; /* default to no exception */
...
static void pde_PDEdriver__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct pde_PDEdriver__epv*        epv  = &s_my_epv__pde_pdedriver;
  struct gov_cca_Component__epv*    e0   = &s_my_epv__gov_cca_component;
  struct gov_cca_Port__epv*         e1   = &s_my_epv__gov_cca_port;
  struct gov_cca_ports_GoPort__epv* e2   = &s_my_epv__gov_cca_ports_goport;
  ...
  epv->f__cast                 = ior_pde_PDEdriver__cast;
  epv->f__delete               = ior_pde_PDEdriver__delete;
  epv->f__exec                 = ior_pde_PDEdriver__exec;
  epv->f__getURL               = ior_pde_PDEdriver__getURL;
  epv->f__raddRef              = ior_pde_PDEdriver__raddRef;
  epv->f__isRemote             = ior_pde_PDEdriver__isRemote;
  epv->f__set_hooks            = ior_pde_PDEdriver__set_hooks;
  epv->f__set_contracts        = ior_pde_PDEdriver__set_contracts;
  epv->f__dump_stats           = ior_pde_PDEdriver__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct pde_PDEdriver__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct pde_PDEdriver__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct pde_PDEdriver__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct pde_PDEdriver__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct pde_PDEdriver__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_setServices           = NULL;
  epv->f_go                    = NULL;

  pde_PDEdriver__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  e2->f_go                    = (int32_t (*)(void*,struct sidl_BaseInterface__object **)) epv->f_go;
  ...
  ior_pde_PDEdriver__ensure_load_called();
}

/*
 * pde_PDEdriver__getEPVs: Get my version of all relevant EPVs.
 */

void pde_PDEdriver__getEPVs (
  ...
  struct pde_PDEdriver__epv **s_arg_epv_hooks__pde_pdedriver)
{
  ...
  *s_arg_epv__pde_pdedriver = &s_my_epv__pde_pdedriver;
  *s_arg_epv_hooks__pde_pdedriver = &s_my_epv_hooks__pde_pdedriver;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* pde_PDEdriver__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "pde.PDEdriver", _ex);
...
static void
initMetadata(struct pde_PDEdriver__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * pde_PDEdriver__createObject: Allocate the object and initialize it.
 */

struct pde_PDEdriver__object*
pde_PDEdriver__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct pde_PDEdriver__object* self =
    (struct pde_PDEdriver__object*) sidl_malloc(
      sizeof(struct pde_PDEdriver__object),
      "Object allocation failed for struct pde_PDEdriver__object",
        __FILE__, __LINE__, "pde_PDEdriver__createObject", _ex);
  if (!self) goto EXIT;
  pde_PDEdriver__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void pde_PDEdriver__init(
  struct pde_PDEdriver__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct pde_PDEdriver__object*  s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_epv                        = &s_my_epv__pde_pdedriver;
...
void
pde_PDEdriver__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct pde_PDEdriver__external
s_externalEntryPoints = {
  pde_PDEdriver__createObject,
  pde_PDEdriver__getSuperEPV,
  2, 
  0
};
