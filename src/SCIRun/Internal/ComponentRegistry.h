...
namespace SCIRun {
  ...
  class ComponentRegistry : public gov::cca::ComponentRegistry_interface, public InternalComponentInstance {
  public:
    ...
    virtual CIA::array1<gov::cca::ComponentDescription> listAllComponentTypes();
  private:
