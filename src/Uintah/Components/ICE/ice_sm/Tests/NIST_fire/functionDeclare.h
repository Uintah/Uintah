...
void   compute_initial_constants_NIST_TE(
                    ...
                    double ****Temp_CC,     double ****rho_CC,          double *grav,
                    double del_H_fuel,      double rho_fuel,            double Q_fire,
                    double *u_inject_TE,    double *t_burnout_TE,       
                    int m );
void    update_Q_TE_and_add_Q_cell(
                    ...
                    double t,
                    double *x_TE,           double *y_TE,               double *z_TE,
                    double Q_fire,
                    double *t_inject_TE,    double *t_inject_TE_parms,  double t_burnout_TE,
                    int N_inject_TE,        int nThermalElements,      
                    double *Q_TE,           double ***Q_chem,       
                    int m);                
...
void   update_TE_position(
                    ...
                    int xHiLimit,           int yHiLimit,               int zHiLimit,
                    double delX,            double delY,                double delZ,
                    int nThermalElements,   int **cell_index_TE,    
                    double *x_TE,           double *y_TE,               double *z_TE,
                    double ****uvel_CC,     double ****vvel_CC,         double ****wvel_CC,
                    double delt,            int m);
 
 void   inject_TE(
                    int *index_inject_TE,   int N_inject_TE,            double *t_inject_TE_parms,
                    double t,            
                    double delX,            double delY,                double delZ,
                    double u_inject_TE,     double *t_inject_TE, 
                    double *x_TE,           double *y_TE,               double *z_TE,
                    int *nThermalElements );   
...
void readInputFile( int *xLoLimit,          int *yLoLimit,              int *zLoLimit,
                    ...
                    double *t_inject_TE_parms,double *Q_fire,           int *N_inject_TE,
                    double *del_H_fuel,     double *rho_fuel,           int *index_inject_TE,       
                    int *nMaterials);                                            
...
void accumulate_energy_source_sinks(
                    ...
                    double ****uvel_CC,     double ****vvel_CC,         double ****wvel_CC,           
                    double ****div_velFC_CC,double ***Q_chem,
                    double ****int_eng_source,
                    int nMaterials   );
/*______________________________________________________________________
