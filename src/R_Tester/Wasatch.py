...
NIGHTLYTESTS = [
  ...
  ("varden-projection-mms",                    "varden-projection-mms.ups",   3,  "Linux",  ["exactComparison","no_restart"] ), \
  ("varden-projection-advection",              "varden-projection-advection.ups",   1.1,  "Linux",  ["exactComparison","no_restart"] ), \
  ...
  ("qmom-aggregation-test",         "qmom-aggregation-test.ups",         1,  "Linux",  ["exactComparison","no_restart"] ),   \
  ("qmom-birth-test",               "qmom-birth-test.ups",               1,  "Linux",  ["exactComparison","no_restart"] ),   \
  ("qmom-ostwald-test",             "qmom-ostwald-test.ups",             1,  "Linux",  ["exactComparison","no_restart"] ),   \
  ("qmom-surface-energy-test",      "qmom-surface-energy-test.ups",      1,  "Linux",  ["exactComparison","no_restart"] ),   \
