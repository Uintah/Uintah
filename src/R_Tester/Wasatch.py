...
liddrivencavity3Dlaminarperf_ups = modUPS( the_dir, \
                                       "lid-driven-cavity-3D-Re1000.ups", \
                                       ["<max_Timesteps> 70 </max_Timesteps>","<resolution>[64,64,64]</resolution>","<patches>[1,1,1]</patches>"])
...
NIGHTLYTESTS = [
  ...
  ("turb-lid-driven-cavity-3D-LAMINAR_perf",   liddrivencavity3Dlaminarperf_ups,   1.1,  "Linux",  ["no_uda_comparison","no_restart","do_performance_test"] ),         \
