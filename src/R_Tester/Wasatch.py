...
DEBUGTESTS = [
    ("gpu-compressible-1d"  , gpu_compressible_1d_ups,   1, "Linux", ["gpu", "abs_tolerance=1e-10", "no_restart", "no_memoryTest", "sus_options=-gpu -nthreads 2 "]),
  ]
...
#  ("species-transport",             "species-transport.ups",               1,  "All",  ["exactComparison","no_restart","no_memoryTest"] ),  
  ...
  ("decay-isotropic-turbulence-dsmag32",       "TurbulenceVerification/"+decayIsotropicTurbulenceDSmag32_ups,  8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("decay-isotropic-turbulence-dsmag64",       "TurbulenceVerification/"+decayIsotropicTurbulenceDSmag64_ups,  8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("decay-isotropic-turbulence-csmag32",       "TurbulenceVerification/"+decayIsotropicTurbulenceCSmag32_ups,  8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("decay-isotropic-turbulence-csmag64",       "TurbulenceVerification/"+decayIsotropicTurbulenceCSmag64_ups,  8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("decay-isotropic-turbulence-vreman32",      "TurbulenceVerification/"+decayIsotropicTurbulenceVreman32_ups, 8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("decay-isotropic-turbulence-vreman64",      "TurbulenceVerification/"+decayIsotropicTurbulenceVreman64_ups, 8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("decay-isotropic-turbulence-wale32",        "TurbulenceVerification/"+decayIsotropicTurbulenceWale32_ups,   8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("decay-isotropic-turbulence-wale64",        "TurbulenceVerification/"+decayIsotropicTurbulenceWale64_ups,   8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("turbulent-inlet-test-xminus",              "turbulent-inlet-test-xminus.ups",    12,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ...
  ("bc-modifier-expression-test-multiple",   "bc-modifier-expression-test-multiple.ups",   8,  "Linux",   ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("read-from-file-test",   "read-from-file-test.ups",   8,  "Linux",   ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("channel-flow-symmetry-bc",   "channel-flow-symmetry-bc.ups",   6,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("turb-lid-driven-cavity-3D-WALE",   "turb-lid-driven-cavity-3D-WALE.ups",   8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("turb-lid-driven-cavity-3D-SMAGORINSKY",   "turb-lid-driven-cavity-3D-SMAGORINSKY.ups",   8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("turb-lid-driven-cavity-3D-scalar",   "turb-lid-driven-cavity-3D-SMAGORINSKY-scalar.ups",   8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("varden-3D-lowres-jet-IMPULSE",                  "varden-3D-lowres-jet-IMPULSE.ups",       8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("varden-projection-mms",                         "varden-projection-mms.ups",              3,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("varden-projection-2d-oscillating-periodic-mms-xy", "varden-projection-2d-oscillating-periodic-mms-xy.ups", 4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("varden-projection-2d-oscillating-periodic-mms-xz", "varden-projection-2d-oscillating-periodic-mms-xz.ups", 4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("varden-projection-2d-oscillating-periodic-mms-yz", "varden-projection-2d-oscillating-periodic-mms-yz.ups", 4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("varden-projection-advection-xdir",              "varden-projection-advection-xdir.ups",   3,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("varden-projection-advection-ydir",              "varden-projection-advection-ydir.ups",   3,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("varden-projection-advection-zdir",              "varden-projection-advection-zdir.ups",   3,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("varden-projection-advection-xdir-analytic-dens","varden-projection-advection-xdir-analytic-dens.ups", 3, "Linux", ["exactComparison","no_restart","sus_options=-do_not_validate","no_memoryTest"] ),
  ("channel-flow-xy-xminus-pressure-outlet",   "channel-flow-xy-xminus-pressure-outlet.ups",   6,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("channel-flow-xy-xplus-pressure-outlet",    "channel-flow-xy-xplus-pressure-outlet.ups",    6,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("channel-flow-xz-zminus-pressure-outlet",   "channel-flow-xz-zminus-pressure-outlet.ups",   6,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("channel-flow-xz-zplus-pressure-outlet",    "channel-flow-xz-zplus-pressure-outlet.ups",    6,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("channel-flow-yz-yminus-pressure-outlet",   "channel-flow-yz-yminus-pressure-outlet.ups",   6,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("channel-flow-yz-yplus-pressure-outlet",    "channel-flow-yz-yplus-pressure-outlet.ups",    6,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("lid-driven-cavity-3D-Re1000",   "lid-driven-cavity-3D-Re1000.ups",   8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("liddrivencavity3DRe1000rk3",    liddrivencavity3DRe1000rk3_ups,   8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("lid-driven-cavity-xy-Re1000",   "lid-driven-cavity-xy-Re1000.ups",   4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("lid-driven-cavity-xz-Re1000",   "lid-driven-cavity-xz-Re1000.ups",   4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("lid-driven-cavity-yz-Re1000",   "lid-driven-cavity-yz-Re1000.ups",   4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("hydrostatic-pressure-test",     "hydrostatic-pressure-test.ups",     8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("BasicScalarTransportEquation",  "BasicScalarTransportEquation.ups",  1,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ...
  ("bc-test-mixed",                 "bc-test-mixed.ups",                 4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("ScalarTransportEquation",       "ScalarTransportEquation.ups",       1,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("taylor-green-vortex-2d-xy",     "taylor-green-vortex-2d-xy.ups",          4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("taylor-green-vortex-2d-xz",     "taylor-green-vortex-2d-xz.ups",          4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("taylor-green-vortex-2d-yz",     "taylor-green-vortex-2d-yz.ups",          4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("scalability-test",              "scalability-test.ups",              1,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("scalability-test-uncoupled",    "scalability-test-uncoupled.ups",    1,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),  
  ("taylor-green-vortex-3d",        "taylor-green-vortex-3d.ups",          8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ...
  ("qmom-realizable-test",          "qmom-realizable-test.ups",          8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("qmom-test",                     "qmom-test.ups",                     4,  "Linux",  ["exactComparison","no_restart","no_memoryTest"] ),
  ("qmom-aggregation-test",         "qmom-aggregation-test.ups",         1,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("qmom-birth-test",               "qmom-birth-test.ups",               1,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("qmom-ostwald-test",             "qmom-ostwald-test.ups",             1,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("qmom-surface-energy-test",      "qmom-surface-energy-test.ups",      1,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("convection-test-svol-xdir",     "convection-test-svol-xdir.ups",     4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("convection-test-svol-ydir",     "convection-test-svol-ydir.ups",     4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("convection-test-svol-zdir",     "convection-test-svol-zdir.ups",     4,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("convection-test-svol-xdir-bc",  "convection-test-svol-xdir-bc.ups",  8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("convection-test-svol-ydir-bc",  "convection-test-svol-ydir-bc.ups",  8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("convection-test-svol-zdir-bc",  "convection-test-svol-zdir-bc.ups",  8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
  ("convection-test-svol-mixed-bc", "convection-test-svol-mixed-bc.ups", 8,  "Linux",  ["exactComparison","no_restart","sus_options=-do_not_validate"] ),
...
GPUTESTS=[
  ...
  ("gpu-compressible-1d"  , gpu_compressible_1d_ups, 1, "Linux", ["gpu", "abs_tolerance=1e-7", "no_restart", "no_memoryTest", "sus_options=-gpu -nthreads 2 "]),  
  ("gpu-compressible-2d"  , gpu_compressible_2d_ups, 1, "Linux", ["gpu", "abs_tolerance=1e-7", "no_restart", "no_memoryTest", "sus_options=-gpu -nthreads 2 "])
#  ("gpu-tabprops"         , TabPropsInterface.ups,   1, "Linux", ["gpu", "abs_tolerance=1e-7", "no_restart", "no_memoryTest", "sus_options=-gpu -nthreads 2 "])  
