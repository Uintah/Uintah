...
DIFFUSION  = [     ("Poiseuille_XY", "CouettePoiseuille/XY.ups",     1, "All", ["exactComparison"]),         
                   ...
                   ("Poiseuille_XY_freeSlip", "CouettePoiseuille/XY_freeSlip.ups", 
                                                                     1, "All", ["exactComparison"]),
...
RX_MODELS =   [("cvHydrogen1",       "RX_MODELS/cvHydrogen1.ups",       1, "All", ["exactComparison"]),
               ...
               ("hydrogenFlame1",    "RX_MODELS/hydrogenFlame1.ups",   12, "All", ["exactComparison", "no_dbg"]),
               ("hydrogenFlame2",    "RX_MODELS/hydrogenFlame2.ups",   10, "All", ["exactComparison", "no_dbg"])
              ]
