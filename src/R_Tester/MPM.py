...
#                  ("adiCuZA4000s696K",                    "adiCuZA4000s696K.ups",                    1,  "Linux", ["exactComparison"] ),
                  ...
                  #----------  Darwin Tests ---------  #
                  ("disks_complex",                       "disks_complex.ups",                       4,  "Darwin", ["exactComparison"]    ),
                  ("heatcond2mat",                        "heatcond2mat.ups",                        1,  "Darwin", ["exactComparison"]    ),
                  ("inclined_plane_sphere",               "inclined_plane_sphere.ups",               1,  "Darwin", ["exactComparison"]    ),
                  ("const_test_cmr",                      "const_test_cmr.ups",                      1,  "Darwin", ["exactComparison"]    ),
                  ("const_test_nhp",                      "const_test_nhp.ups",                      1,  "Darwin", ["exactComparison"]    ),
                  ("adiCuJC4000s696K",                    "adiCuJC4000s696K.ups",                    1,  "Darwin", ["exactComparison"]    ),
                  ("adiCuMTS4000s696K",                   "adiCuMTS4000s696K.ups",                   1,  "Darwin", ["exactComparison"]    ),
                  ("adiCuPTW4000s696K",                   "adiCuPTW4000s696K.ups",                   1,  "Darwin", ["exactComparison"]    ),
                  ("adiCuSCG4000s696K",                   "adiCuSCG4000s696K.ups",                   1,  "Darwin", ["exactComparison"]    ),
                  ("adiCuZA4000s696K",                    "adiCuZA4000s696K.ups",                    1,  "Darwin", ["exactComparison"]    ),
                  ("test_cyl_pene_no_ero",                "test_cyl_pene_no_ero.ups",                1,  "Darwin", ["exactComparison"]    ),
                  ("test_gurson_beckerdrucker_mts",       "test_gurson_beckerdrucker_mts.ups",       1,  "Darwin", ["exactComparison"]    ),
                  ("NanoPillar",                          "ARL/NanoPillar2D_FBC_Sym.ups",            1,  "Darwin", ["exactComparison"] ),
