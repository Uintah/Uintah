...
NIGHTLYTESTS = [
   ...
   ("dqmom_test_1"                      , "DQMOM_regression/dqmom_test_1.ups"                       , 1   , "Linux" , ["exactComparison"])   , 
   ("dqmom_test_2"                      , "DQMOM_regression/dqmom_test_2.ups"                       , 1   , "Linux" , ["exactComparison"])   , 
   ("dqmom_test_3"                      , "DQMOM_regression/dqmom_test_3.ups"                       , 1   , "Linux" , ["exactComparison"])   , 
   ("dqmom_test_4"                      , "DQMOM_regression/dqmom_test_4.ups"                       , 1   , "Linux" , ["exactComparison"])   , 
   ("dqmom_test_5"                      , "DQMOM_regression/dqmom_test_5.ups"                       , 1   , "Linux" , ["exactComparison"])   , 
   ("birth_test"                        , "DQMOM_regression/birth_test.ups"                         , 1   , "Linux" , ["exactComparison"])   , 
   ("upwind_birth_test"                 , "DQMOM_regression/upwind_birth_test.ups"                  , 1   , "Linux" , ["exactComparison"])   , 
   ("methane_jet"                       , "ClassicMixingTables/ups/methane_jet.ups"                 , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("acidbase_jet"                      , "ClassicMixingTables/ups/acidbase_jet.ups"                , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("acidbase_jet_2D"                   , "ClassicMixingTables/ups/acidbase_jet_2D.ups"             , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("1Dtabletest"                       , "ClassicMixingTables/ups/1DTableTest.ups"                 , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("xplus_scalar_test"                 , "ScalarTests/xplus_scalar_test.ups"                       , 6   , "Linux" , ["exactComparison"]) , 
   ("yplus_scalar_test"                 , "ScalarTests/yplus_scalar_test.ups"                       , 6   , "Linux" , ["exactComparison"]) , 
   ("zplus_scalar_test"                 , "ScalarTests/zplus_scalar_test.ups"                       , 6   , "Linux" , ["exactComparison"]) , 
   ("xminus_scalar_test"                , "ScalarTests/xminus_scalar_test.ups"                      , 6   , "Linux" , ["exactComparison"]) , 
   ("yminus_scalar_test"                , "ScalarTests/yminus_scalar_test.ups"                      , 6   , "Linux" , ["exactComparison"]) , 
   ("zminus_scalar_test"                , "ScalarTests/zminus_scalar_test.ups"                      , 6   , "Linux" , ["exactComparison"]) , 
   ("turbulent_inlet_test"              , "DigitalFilter/TurbulentInletChannel.ups"                 , 6   , "Linux" , ["exactComparison"]) , 
   ("masssource_con_den"                , "verify_masssource/source_channel_conden.ups"             , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("masssource_var_den"                , "verify_masssource/source_channel_varden.ups"             , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("heptane_pipe"                      , "heptane_pipe.ups"                                        , 1   , "Linux" , ["exactComparison"])   , 
   ("coal_table_pipe"                   , "coal_table_pipe.ups"                                     , 1   , "Linux" , ["exactComparison"])   , 
   ...
   ("coal_channel_FOWY"                 , "Coal/coal_channel_FOWY.ups"                              , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("pcoal_drag"                        , "Coal/pcoal_drag.ups"                                     , 1   , "Linux" , ["exactComparison"])   , 
   ("methane_RCCE"                      , "methane_RCCE.ups"                                        , 1   , "Linux" , ["exactComparison"])   , 
   ("channel_WD_CO"                     , "channel_WD_CO.ups"                                       , 1   , "Linux" , ["exactComparison"])   , 
   ...
   ("CQMOM_1x1"                         , "CQMOM_regression/CQMOM_1x1.ups"                          , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ...
   ("SimpleBoxPTC"                      , "CQMOM_regression/SimpleBoxPTC.ups"                       , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("PTC_2D"                            , "CQMOM_regression/PTC_2D.ups"                             , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("PTC_3D"                            , "CQMOM_regression/PTC_3D.ups"                             , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("CQMOM_4D"                          , "CQMOM_regression/CQMOM_4D.ups"                           , 1   , "Linux" , ["exactComparison"     , "no_restart"]) ,
   ("CQMOM_7D"                          , "CQMOM_regression/CQMOM_7D.ups"                           , 1   , "Linux" , ["exactComparison"     , "no_restart"]) ,
   ("singleJet_poly"                    , "CQMOM_regression/singleJet_poly.ups"                     , 1   , "Linux" , ["exactComparison"     , "no_restart"]) ,
   ("angledWall"                        , "CQMOM_regression/angledWall.ups"                         , 1   , "Linux" , ["exactComparison"     , "no_restart"]) ,
   ("angledWall3D"                      , "CQMOM_regression/angledWall3D.ups"                       , 1   , "Linux" , ["exactComparison"     , "no_restart"]) ,
   ("Constant_Deposition"               , "CQMOM_regression/Constant_Deposition.ups"                , 1   , "Linux" , ["exactComparison"     , "no_restart"]) ,
   ("CQMOM_coal_test"                   , "CQMOM_regression/CQMOM_coal_test.ups"                    , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
   ("channel_LagPart_inlet"             , "LagrangianParticles/channel_flow_x_lagrangian_inlet.ups" , 1   , "Linux" , ["exactComparison"     , "no_restart", "no_cuda"]) ,  # 11/1/16 bug with gpu support with particles  
...
#   ("coal_channel_Yamamoto"             , "Coal/coal_channel_Yamamoto.ups"                          , 1   , "Linux" , ["exactComparison"     , "no_restart"]) , 
