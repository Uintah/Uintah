...
NIGHTLYTESTS = [
   ...
   ("methane_jet"            , "ClassicMixingTables/ups/methane_jet.ups" , 1.1 , "Linux"  , ["exactComparison"])     , 
]
...
LOCALTESTS = [
   ...
   ("methane_jet"            , "ClassicMixingTables/ups/methane_jet.ups" , 1.1 , "All" , ["exactComparison"])     
]
