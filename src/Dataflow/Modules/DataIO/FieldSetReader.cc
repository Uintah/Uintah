...
public:
  FieldSetReader(GuiContext* ctx);
};

DECLARE_MAKER(FieldSetReader)
FieldSetReader::FieldSetReader(GuiContext* ctx)
  : GenericReader<FieldSetHandle>("FieldSetReader", ctx, "DataIO", "SCIRun")
{
}
