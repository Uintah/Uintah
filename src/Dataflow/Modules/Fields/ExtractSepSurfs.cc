...
/*
 *  ExtractSepSurfs.cc:  Unfinished modules
 *
 *  Written by:
 *   Steven G. Parker
...
public:
    ...
    ExtractSepSurfs(const clString& id);
    virtual ~ExtractSepSurfs();
    virtual void execute();
};

extern "C" Module* make_ExtractSepSurfs(const clString& id)
{
    return new ExtractSepSurfs(id);
}

ExtractSepSurfs::ExtractSepSurfs(const clString& id)
: Module("ExtractSepSurfs", id, Filter)
{
