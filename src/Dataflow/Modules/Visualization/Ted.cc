  ...
  negative("negative", id, this)
{
  ...
  inscalarfield = scinew ScalarFieldIPort( this, "Image",
					  ScalarFieldIPort::Atomic);
  inscalarfield2 = scinew ScalarFieldIPort( this, "Overlay",
					  ScalarFieldIPort::Atomic);
  inscalarfield3 = scinew ScalarFieldIPort( this, "2nd Overlay",
					  ScalarFieldIPort::Atomic);
