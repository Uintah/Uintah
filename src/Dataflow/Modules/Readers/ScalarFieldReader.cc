...
public:
    ...
    ScalarFieldReader(const ScalarFieldReader&, int deep=0);
...
ScalarFieldReader::ScalarFieldReader(const ScalarFieldReader& copy, int deep)
: Module(copy, deep), filename("filename", id, this)
{
    NOT_FINISHED("ScalarFieldReader::ScalarFieldReader");
}
...
Module* ScalarFieldReader::clone(int deep)
{
    return scinew ScalarFieldReader(*this, deep);
}
