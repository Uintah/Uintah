...
class CBDBuildSimulation : public Module {
public:
  CBDBuildSimulation(GuiContext*);
...
DECLARE_MAKER(CBDBuildSimulation)
CBDBuildSimulation::CBDBuildSimulation(GuiContext* ctx)
  : Module("CBDBuildSimulation", ctx, Source, "ContinuousBiDomain", "CardioWave"),
...
void CBDBuildSimulation::execute()
{
