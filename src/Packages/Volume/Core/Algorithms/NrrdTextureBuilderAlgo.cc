...
static Point t_min_point( Point min, double dx, double dy, double dz,
                int i, int j, int k, int nx, int ny, int nz) {
...
static Point t_max_point( Point min, double dx, double dy, double dz,
...
// static Point node_point(Point min, double dx, double dy, double dz,
//                 int i, int j, int k )
// {
...
//       dbg <<" to "<< _nk<<" and "<<_vk<<"\n";
    ...
    child0 = buildTree(mi, mj, mk, _ni, _nj, _nk, nc, nb, bbox,
