...
# GUI for MeshBuilder module
# by Allen R. Sanderson
# March 2002

itcl_class Fusion_Fields_MeshBuilder {
    inherit Module
    constructor {config} {
        set name MeshBuilder
        set_defaults
    }
...
#	grid $w.l.direction $w.l.start $w.l.delta $w.l.skip 
	...
	scaleEntry2 $w.i.skip \
		1 25 100 $this-iskip $this-iskip2
...
#	grid $w.i.l $w.i.start $w.i.delta $w.i.skip
	...
	scaleEntry2 $w.j.skip \
		1 25 100 $this-jskip $this-jskip2
...
#	grid $w.k.start $w.k.delta $w.k.skip
	...
	if { [set $this-iskip2] > 10 } { set $this-iskip2 10 }
	if { [set $this-jskip2] > 10 } { set $this-jskip2 10 }
