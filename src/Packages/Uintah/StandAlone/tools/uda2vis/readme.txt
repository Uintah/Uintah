...
Also, the location of the header file 'particleData.h' (in the folder uda2nrrd) has been hardcoded into avtudaReaderMTMDFileFormat.h and needs to be changed by the user accordingly. 
