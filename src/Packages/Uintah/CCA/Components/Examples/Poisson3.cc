...
void Poisson3::scheduleRefine(LevelP& fineLevel, SchedulerP& sched)
{
...
void Poisson3::scheduleRefineInterface(LevelP& fineLevel, SchedulerP& sched,
				       int step, int nsteps)
{
...
void Poisson3::scheduleCoarsen(LevelP& coarseLevel, SchedulerP& sched)
{
