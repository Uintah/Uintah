                         ...
                         DenseMatrix& a_inverse)
{
  ...
  if (numMatls == 2) {
    ...
    a_inverse[0][0] =  a[1][1]/denom;
    a_inverse[0][1] = -a[0][1]/denom;
    a_inverse[1][0] = -a[1][0]/denom;
  ...
  if (numMatls == 4) {   // 4 X 4 matrix
    ...
    (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
     a02*a10*a23*a31 + a00*a12*a23*a31 + a03*a11*a20*a32 - 
     a01*a13*a20*a32 - a03*a10*a21*a32 + a00*a13*a21*a32 + 
     a01*a10*a23*a32 - a00*a11*a23*a32 - a02*a11*a20*a33 + 
     a01*a12*a20*a33 + a02*a10*a21*a33 - a00*a12*a21*a33 - 
     a01*a10*a22*a33 + a00*a11*a22*a33);

   a_inverse[0][1] =
   (a03*a22*a31 - a02*a23*a31 - a03*a21*a32 + a01*a23*a32 + a02*a21*a33 - 
     a01*a22*a33)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[0][2] =
   (-(a03*a12*a31) + a02*a13*a31 + a03*a11*a32 - a01*a13*a32 - a02*a11*a33 + 
     a01*a12*a33)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[0][3] =
   (a03*a12*a21 - a02*a13*a21 - a03*a11*a22 + a01*a13*a22 + a02*a11*a23 - 
     a01*a12*a23)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[1][1] =
   (-(a03*a22*a30) + a02*a23*a30 + a03*a20*a32 - a00*a23*a32 - a02*a20*a33 + 
     a00*a22*a33)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[1][2] =
   (a03*a12*a30 - a02*a13*a30 - a03*a10*a32 + a00*a13*a32 + a02*a10*a33 - 
     a00*a12*a33)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[1][3] =
   (-(a03*a12*a20) + a02*a13*a20 + a03*a10*a22 - a00*a13*a22 - a02*a10*a23 + 
     a00*a12*a23)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[2][1] =
   (a03*a21*a30 - a01*a23*a30 - a03*a20*a31 + a00*a23*a31 + a01*a20*a33 - 
     a00*a21*a33)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[2][2] =
   (-(a03*a11*a30) + a01*a13*a30 + a03*a10*a31 - a00*a13*a31 - a01*a10*a33 + 
     a00*a11*a33)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[2][3] =
   (a03*a11*a20 - a01*a13*a20 - a03*a10*a21 + a00*a13*a21 + a01*a10*a23 - 
     a00*a11*a23)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[3][1] =
   (-(a02*a21*a30) + a01*a22*a30 + a02*a20*a31 - a00*a22*a31 - a01*a20*a32 + 
     a00*a21*a32)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
   ...
   a_inverse[3][2] =
  (a02*a11*a30 - a01*a12*a30 - a02*a10*a31 + a00*a12*a31 + a01*a10*a32 - 
     a00*a11*a32)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
     ...
     a01*a10*a22*a33 + a00*a11*a22*a33);
   a_inverse[3][3] =
   (-(a02*a11*a20) + a01*a12*a20 + a02*a10*a21 - a00*a12*a21 - a01*a10*a22 + 
     a00*a11*a22)/
   (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
                        ...
                        vector<double>& X  )
{
  ...
  X[1] =    
   (a13*a22*a30 - a12*a23*a30 - a13*a20*a32 + a10*a23*a32 + a12*a20*a33 - 
      a10*a22*a33)*b0/
    (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
  ...
  X[2] =    
   (-(a13*a21*a30) + a11*a23*a30 + a13*a20*a31 - a10*a23*a31 - a11*a20*a33 + 
      a10*a21*a33)*b0/
    (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
  ...
  X[3] =    
   (a12*a21*a30 - a11*a22*a30 - a12*a20*a31 + a10*a22*a31 + a11*a20*a32 - 
      a10*a21*a32)*b0/
    (a03*a12*a21*a30 - a02*a13*a21*a30 - a03*a11*a22*a30 + a01*a13*a22*a30 + 
     a02*a11*a23*a30 - a01*a12*a23*a30 - a03*a12*a20*a31 + 
     a02*a13*a20*a31 + a03*a10*a22*a31 - a00*a13*a22*a31 - 
