...
{
  MPI::Allreduce(&time, &mint, 1, MPI_DOUBLE, MPI_MIN, MPI_COMM_WORLD );
  MPI::Allreduce(&time, &maxt, 1, MPI_DOUBLE, MPI_MAX, MPI_COMM_WORLD );
  MPI::Allreduce(&time, &avgt, 1, MPI_DOUBLE, MPI_SUM, MPI_COMM_WORLD );
  avgt /= num_procs;
}
