...
public:
    ...
    VectorFieldReader(const VectorFieldReader&, int deep=0);
...
VectorFieldReader::VectorFieldReader(const VectorFieldReader& copy, int deep)
: Module(copy, deep), filename("filename", id, this)
{
    NOT_FINISHED("VectorFieldReader::VectorFieldReader");
}
...
Module* VectorFieldReader::clone(int deep)
{
    return scinew VectorFieldReader(*this, deep);
}
