...
set label sprintf( 'a = %2.3g',a1 )      at screen 0.2,0.45

set label 'x_Error = a * (#Grid Cells)^b' at screen 0.2,0.4
set label sprintf( 'a = %2.3g',a1 )       at screen 0.2,0.375
set label sprintf( 'b = %2.3g',b1 )       at screen 0.2,0.35

set label 'y_Error = a * (#Grid Cells)^b' at screen 0.2,0.3
set label sprintf( 'a = %2.3g',a2 )       at screen 0.2,0.275
set label sprintf( 'b = %2.3g',b2 )       at screen 0.2,0.25

set label 'z_Error = a * (#Grid Cells)^b' at screen 0.2,0.2
set label sprintf( 'a = %2.3g',a3 )       at screen 0.2,0.175
set label sprintf( 'b = %2.3g',b3 )       at screen 0.2,0.15
