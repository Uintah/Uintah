<start>
<upsFile>RMCRT_hotspot.ups</upsFile>
<gnuplot>
  <script>plotScript_noFit.gp</script>s
  <title>Double:CPU:RMCRT \\n Benchmark #7 \\n 25^3, Random Seed</title>
...
<Test>
    ...
    <postProcess_cmd>RMCRT_wrapper -bm 7 -L 0 -plot false</postProcess_cmd>
    <x>8</x>
    <replace_lines>
