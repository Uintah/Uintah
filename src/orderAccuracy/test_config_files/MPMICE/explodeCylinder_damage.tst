...
<Test>
    ...
    <x>FM-3e8_FSTD_2.5</x>
    <replace_values>
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/constitutive_model/failure_mean :3e8
...
<Test>
    ...
    <x>FM-8e8_FSTD_2.5</x>
    <replace_values>
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/constitutive_model/failure_mean :8e8
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/constitutive_model/failure_std :2.5
    </replace_values>
</Test>
<Test>
    ...
    <replace_values>
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/constitutive_model/failure_mean :1.3e9
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/constitutive_model/failure_std :2.5
    </replace_values>
</Test>
