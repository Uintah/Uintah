...
a = dlmread('outputs/MMS_u_n.txt',' ', 2, 0); 
for i=1:257 
    b(:,i)=a((a(:,1)==i-1),4);
end
u_mms_n=b';
clear ans a i b
a = dlmread('outputs/MMS_u.txt',' ', 2, 0); 
for i=1:257 
    b(:,i)=a((a(:,1)==i-1),4);
end
u_mms=b';
...
for i=1:length(tvec)
    ...
    plot(xxvol,S,xxvol,u_mms(:,tvec(i)),'--',xxvol,u_mms_n(:,tvec(i)),'--','LineWidth',2);
    axis([-15 15 -2.5 2.5]);
    ...
    figure('OuterPosition',[300,300,800,600],'Color','w');
    axes('FontSize',40,'FontName','Times New Roman');    
    plot(xxvol,abs(S-u_mms(:,tvec(i))),xxvol,abs(S-u_mms_n(:,tvec(i))),'--','LineWidth',2);
    axis([-15 15 0 0.01]);
...
a = dlmread('outputs/MMS_f_n.txt',' ', 2, 0); 
for i=1:257 
    b(:,i)=a((a(:,1)==i-1),4);
end
f_mms_n=b';
clear ans a i b
a = dlmread('outputs/MMS_f.txt',' ', 2, 0); 
for i=1:257 
    b(:,i)=a((a(:,1)==i-1),4);
end
f_mms=b';
