...
TaskAssignedExecutionSpace UpdateParticlePosition::loadTaskInitializeFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::INITIALIZE>( this
                                     ...
                                     //, &UpdateParticlePosition::initialize<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                     );
}
...
TaskAssignedExecutionSpace UpdateParticlePosition::loadTaskEvalFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::TIMESTEP_EVAL>( this
                                     ...
                                     //, &UpdateParticlePosition::eval<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                     );
}
...
UpdateParticlePosition::register_timestep_eval(
  ...
  register_variable( _px_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::OLDDW,  variable_registry, m_task_name );
  register_variable( _py_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::OLDDW,  variable_registry, m_task_name );
  register_variable( _pz_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::OLDDW,  variable_registry, m_task_name );
