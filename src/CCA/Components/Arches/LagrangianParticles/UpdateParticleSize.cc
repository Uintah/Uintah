...
TaskAssignedExecutionSpace UpdateParticleSize::loadTaskInitializeFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::INITIALIZE>( this
                                     ...
                                     //, &UpdateParticleSize::initialize<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                     );
}
...
TaskAssignedExecutionSpace UpdateParticleSize::loadTaskEvalFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::TIMESTEP_EVAL>( this
                                     ...
                                     //, &UpdateParticleSize::eval<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                     );
}
...
UpdateParticleSize::register_timestep_eval(
  ...
  register_variable( _size_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::OLDDW,
