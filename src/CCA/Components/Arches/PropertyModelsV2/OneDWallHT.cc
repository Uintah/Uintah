...
TaskAssignedExecutionSpace OneDWallHT::loadTaskInitializeFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::INITIALIZE>( this
                                     ...
                                     //, &OneDWallHT::initialize<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                     );
}
...
TaskAssignedExecutionSpace OneDWallHT::loadTaskEvalFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::TIMESTEP_EVAL>( this
                                     ...
                                     //, &OneDWallHT::eval<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                     );
}
...
TaskAssignedExecutionSpace OneDWallHT::loadTaskTimestepInitFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::TIMESTEP_INITIALIZE>( this
                                     ...
                                     //, &OneDWallHT::timestep_init<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                     );
}
...
void OneDWallHT::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
  ...
  constCCVariable<double>& emissivity = tsk_info->get_field<constCCVariable<double > >( _emissivity_label );
  constCCVariable<double>& Tsh = tsk_info->get_field<constCCVariable<double > >( _Tshell_label );
  constCCVariable<double>& R_tot = tsk_info->get_field<constCCVariable<double > >( _wall_resistance_label );
  constCCVariable<double>& wall_HF_area = tsk_info->get_field<constCCVariable<double > >( "wall_HF_area" );
