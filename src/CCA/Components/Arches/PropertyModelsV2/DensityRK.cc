...
TaskAssignedExecutionSpace DensityRK::loadTaskComputeBCsFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::BC>( this
                                     , &DensityRK::compute_bcs<UINTAH_CPU_TAG>     // Task supports non-Kokkos builds
                                     , &DensityRK::compute_bcs<KOKKOS_OPENMP_TAG>  // Task supports Kokkos::OpenMP builds
                                     , &DensityRK::compute_bcs<KOKKOS_CUDA_TAG>    // Task supports Kokkos::Cuda builds
                                     );
}
...
TaskAssignedExecutionSpace DensityRK::loadTaskTimestepInitFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::TIMESTEP_INITIALIZE>( this
                                     , &DensityRK::timestep_init<UINTAH_CPU_TAG>     // Task supports non-Kokkos builds
                                     , &DensityRK::timestep_init<KOKKOS_OPENMP_TAG>  // Task supports Kokkos::OpenMP builds
                                     , &DensityRK::timestep_init<KOKKOS_CUDA_TAG>  // Task supports Kokkos::OpenMP builds
                                     );
}
...
DensityRK::register_timestep_eval( std::vector<ArchesFieldContainer::VariableInformation>&
  ...
  register_variable( m_label_densityRK, ArchesFieldContainer::MODIFIES, variable_registry, time_substep );
