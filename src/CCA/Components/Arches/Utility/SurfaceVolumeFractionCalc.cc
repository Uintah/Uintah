...
TaskAssignedExecutionSpace SurfaceVolumeFractionCalc::loadTaskInitializeFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::INITIALIZE>( this
                                     ...
                                     //, &SurfaceVolumeFractionCalc::initialize<KOKKOS_DEFAULT_DEVICE_TAG>  // Task supports Kokkos builds
                                     );
}
...
TaskAssignedExecutionSpace SurfaceVolumeFractionCalc::loadTaskTimestepInitFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::TIMESTEP_INITIALIZE>( this
                                     ...
                                     , &SurfaceVolumeFractionCalc::timestep_init<KOKKOS_DEFAULT_DEVICE_TAG>    // Task supports Kokkos builds
                                     );
}
