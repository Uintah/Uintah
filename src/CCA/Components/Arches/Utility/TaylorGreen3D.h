...
private:
  ...
  void TaylorGreen3D<T>::register_initialize(
    ...
    register_variable( m_x_name, AFC::NEEDSLABEL, 0, AFC::NEWDW, variable_registry, m_task_name );
    register_variable( m_y_name, AFC::NEEDSLABEL, 0, AFC::NEWDW, variable_registry, m_task_name );
    register_variable( m_z_name, AFC::NEEDSLABEL, 0, AFC::NEWDW, variable_registry, m_task_name );
