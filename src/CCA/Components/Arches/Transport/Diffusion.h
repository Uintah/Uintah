...
private:
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemorySpace>
  void Diffusion<T>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemorySpace>
  void Diffusion<T>::compute_bcs( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
