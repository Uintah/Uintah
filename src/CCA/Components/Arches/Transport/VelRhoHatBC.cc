...
void VelRhoHatBC::set_mom_bc( ExecutionObject<ExecutionSpace,MemSpace> &exObj,grid_T& var, Cgrid_T& old_var, IntVector& iDir,  const double &possmall , const int sign, ListOfCellsIterator& cell_iter){
