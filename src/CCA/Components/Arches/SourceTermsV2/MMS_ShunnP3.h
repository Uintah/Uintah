...
//--------------------------------------------------------------------------------------------------
template <typename T>
TaskAssignedExecutionSpace MMS_ShunnP3<T>::loadTaskComputeBCsFunctionPointers()
{
...
//--------------------------------------------------------------------------------------------------
template <typename T>
TaskAssignedExecutionSpace MMS_ShunnP3<T>::loadTaskInitializeFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::INITIALIZE>( this
                                     , &MMS_ShunnP3<T>::initialize<UINTAH_CPU_TAG>               // Task supports non-Kokkos builds
                                     ...
                                     //, &MMS_ShunnP3<T>::initialize<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                     );
}
...
TaskAssignedExecutionSpace MMS_ShunnP3<T>::loadTaskEvalFunctionPointers()
{
  return create_portable_arches_tasks<TaskInterface::TIMESTEP_EVAL>( this
                                     ...
                                     //, &MMS_ShunnP3<T>::eval<KOKKOS_DEFAULT_DEVICE_TAG>                // Task supports Kokkos builds
                                     );
}
...
void MMS_ShunnP3<T>::register_initialize( std::vector<VarInfo>&
  ...
  register_variable( m_x_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry );
  register_variable( m_y_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry );
...
template <typename T>
template <typename ExecSpace, typename MemSpace>
void MMS_ShunnP3<T>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
...
template <typename T>
template <typename ExecSpace, typename MemSpace>
void MMS_ShunnP3<T>::timestep_init( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
...
void MMS_ShunnP3<T>::register_timestep_eval( std::vector<VarInfo>&
 ...
 // register_variable( m_MMS_source_t_label,    ArchesFieldContainer::COMPUTES ,  variable_registry, time_substep );
  ...
  register_variable( m_x_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry, time_substep );
  register_variable( m_y_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry, time_substep );
...
template <typename T>
template <typename ExecSpace, typename MemSpace>
void MMS_ShunnP3<T>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
...
void MMS_ShunnP3<T>::compute_source( const Patch* patch, ArchesTaskInfoManager* tsk_info ){
  ...
  T& rho_f_mms = tsk_info->get_field<T>(m_rho_u_label);
  CCVariable<double>& rho_mms = tsk_info->get_field<CCVariable<double> >(m_MMS_rho_label);
  T& f_source_mms = tsk_info->get_field<T>(m_MMS_source_label);
  T& drhodt_mms = tsk_info->get_field<T>(m_MMS_drhodt_label);
  T& continuity_mms = tsk_info->get_field<T>(m_MMS_continuity_label);
