...
namespace Uintah{
  ...
  template <typename IT, typename DT>
  template<typename ExecutionSpace, typename MemorySpace>
  void BodyForce<IT,DT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
  ...
  template <typename IT, typename DT>
  template<typename ExecutionSpace, typename MemorySpace>
  void BodyForce<IT,DT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
