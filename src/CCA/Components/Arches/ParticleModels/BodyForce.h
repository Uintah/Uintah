...
namespace Uintah{
  ...
  template <typename IT, typename DT>
  template<typename ExecutionSpace, typename MemSpace>
  void BodyForce<IT,DT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
  ...
  BodyForce<IT,DT>::timestep_init( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){}
  ...
  template <typename IT, typename DT>
  template<typename ExecutionSpace, typename MemSpace>
  void BodyForce<IT,DT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
