...
private:
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemSpace>
  void FaceParticleVel<T>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
  ...
  FaceParticleVel<T>::timestep_init( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){}
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemSpace>
  void FaceParticleVel<T>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
