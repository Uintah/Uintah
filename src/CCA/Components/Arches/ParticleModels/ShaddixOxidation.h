...
namespace Uintah{
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemSpace>
  void ShaddixOxidation<T>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemSpace>
  void ShaddixOxidation<T>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
