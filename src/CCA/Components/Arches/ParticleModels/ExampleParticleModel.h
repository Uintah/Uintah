...
private:
  ...
  template <typename IT, typename DT>
  template<typename ExecutionSpace, typename MemSpace>
  void ExampleParticleModel<IT,DT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& executionObject ){
  ...
  template <typename IT, typename DT>
  template<typename ExecutionSpace, typename MemSpace>
  void ExampleParticleModel<IT,DT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& executionObject ){
