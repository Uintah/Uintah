...
namespace Uintah{
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemSpace>
  void FOWYDevol<T>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
  ...
  FOWYDevol<T>::timestep_init( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){}
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemSpace>
  void FOWYDevol<T>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
