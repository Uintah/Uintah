...
namespace Uintah{
  ...
  template <typename IT, typename DT>
  template <typename ExecSpace, typename MemSpace>
  void DragModel<IT,DT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
  ...
  DragModel<IT,DT>::timestep_init( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
  ...
  void DragModel<IT, DT>::register_timestep_eval( std::vector<ArchesFieldContainer::VariableInformation>& variable_registry, const int time_substep , const bool packed_tasks){
    ...
    for ( int i = 0; i < _N; i++ ){
      ...
      register_variable( diameter_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry, time_substep );

      const std::string density_name = get_name( i, _base_density_name );
      register_variable( density_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry, time_substep );
      ...
      register_variable( u_velocity_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry, time_substep );

      const std::string v_velocity_name = get_name( i, _base_v_velocity_name );
      register_variable( v_velocity_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry, time_substep );

      const std::string w_velocity_name = get_name( i, _base_w_velocity_name );
      register_variable( w_velocity_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::NEWDW, variable_registry, time_substep );
    }

    register_variable( _gas_u_velocity_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::LATEST, variable_registry, time_substep );
    register_variable( _gas_v_velocity_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::LATEST, variable_registry, time_substep );
    register_variable( _gas_w_velocity_name, ArchesFieldContainer::NEEDSLABEL, 0, ArchesFieldContainer::LATEST, variable_registry, time_substep );
  ...
  template <typename IT, typename DT>
  template <typename ExecSpace, typename MemSpace>
  void DragModel<IT,DT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
