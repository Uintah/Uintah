...
namespace Uintah{
  ...
  template <typename IT, typename DT>
  template<typename ExecutionSpace, typename MemSpace>
  void DragModel<IT,DT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
  ...
  DragModel<IT,DT>::timestep_init( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
  ...
  template <typename IT, typename DT>
  template<typename ExecutionSpace, typename MemSpace>
  void DragModel<IT,DT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
