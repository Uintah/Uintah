...
private:
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemSpace>
  void WDragModel<T>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
  ...
  WDragModel<T>::timestep_init( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){}
  ...
  template <typename T>
  template<typename ExecutionSpace, typename MemSpace>
  void WDragModel<T>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& execObj ){
