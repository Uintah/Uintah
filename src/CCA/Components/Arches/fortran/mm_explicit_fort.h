...
#ifndef fspec_mm_explicit
#define fspec_mm_explicit

#ifdef __cplusplus

#include <CCA/Components/Arches/fortran/FortranNameMangle.h>

extern "C" void F_mm_explicit(int* idxLo,
                            int* idxHi,
...
static void fort_mm_explicit( Uintah::IntVector & idxLo,
                              ...
                              int & mmwallid )
{
  ...
  F_mm_explicit( idxLo.get_pointer(),
               idxHi.get_pointer(),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine MM_EXPLICIT(idxLo, idxHi, phi_low_x, phi_low_y,
