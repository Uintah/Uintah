...
extern "C" void F_vvelcoef_hybrid(int* vv_low_x, int* vv_low_y, int* vv_low_z, int* vv_high_x, int* vv_high_y, int* vv_high_z, double* vv_ptr,
                                  ...
                                  Uintah::IntVector & idxHiV )
{
  ...
  F_vvelcoef_hybrid( &vv_low_x, &vv_low_y, &vv_low_z, &vv_high_x, &vv_high_y, &vv_high_z, const_cast<double*>(vv.getPointer()),
