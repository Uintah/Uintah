...
extern "C" void F_uvelcoef_mixed(int* uu_low_x, int* uu_low_y, int* uu_low_z, int* uu_high_x, int* uu_high_y, int* uu_high_z, double* uu_ptr,
                                 ...
                                 Uintah::IntVector & idxHiU )
{
  ...
  F_uvelcoef_mixed( &uu_low_x, &uu_low_y, &uu_low_z, &uu_high_x, &uu_high_y, &uu_high_z, const_cast<double*>(uu.getPointer()),
