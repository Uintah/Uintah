  ...
  private:
	...
	pokluda_NP(ProblemSpecP db_model){
	  ...
	  if (ash_type == "indonesian"){
	    ...
	    emiss_coeff = {0.04978607, 0.65430545, 0.08629639, -1.75672827, 1.45914076, -0.01707935, -0.13670212, 0.17172430, 0.24061823, -0.31837729, 0.08629314, -0.01271561, 0.03524635, 0.10813791, -0.17209742, 0.05371448, -0.02050606, 0.04920449, -0.07684929, 0.03004254, 0.02760881, -0.01698901, 0.01041209, 0.00734373, -0.00292135, 0.67640859, -0.00778324, -0.34119341};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.30449442e-01;
	    ystd = 2.95378912e-01;
	    surfT = {5.71301560e-01,-8.13809376e-05};
	    pokluda={-6.72177168e-01, 9.11331653e+00};
	    fresnel={9.65956691e-01, -1.01672652e-06, -1.66019472e-01, -5.75462151e-03};
	  } else if (ash_type == "sufco"){
	    ...
	    emiss_coeff = {0.15348420, 0.49309670, 0.12437225, -1.54770870, 1.27074074, -0.04060095, -0.07210374, 0.11675298, 0.18902918, -0.24102655, 0.06404351, 0.01876102, 0.01881766, 0.09034235, -0.14317094, 0.04385866, -0.02904415, 0.04595658, -0.07432532, 0.02903115, 0.02670832, -0.01895771, 0.01239302, 0.00862039, -0.00199459, 0.63424107, -0.00833578, -0.29596948};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.03334912e-01;
	    ystd = 3.04153677e-01;
	    surfT = {6.65291222e-01,-1.01493847e-04};
	    pokluda={2.03282591e-01, 7.53988691e+00};
	    fresnel={9.63543007e-01, -1.79457579e-06, -1.72927076e-01, -6.71671596e-03};
	    ...
	    emiss_coeff = {-0.16140486, 1.16816488, -0.14362905, -2.29925933, 2.00263826, -0.02253336, -0.21850271, 0.31236856, 0.23446614, -0.38272291, 0.10747579, -0.05322051, 0.10969109, 0.11793409, -0.23614440, 0.07683315, 0.00823011, 0.04534869, -0.10161283, 0.04093345, 0.02350549, -0.02492788, 0.01378624, 0.00252012, -0.00067084, 0.71130179, -0.00566857, -0.47563562};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.79747898e-01;
	    ystd = 2.56712017e-01;
	    surfT = {4.03907696e-01,-1.27139046e-05};
	    pokluda={-1.76975968e+00, 8.69783455e+00};
	    fresnel={9.58356342e-01, -1.48024666e-06, -1.56365652e-01, -5.54086399e-03};
