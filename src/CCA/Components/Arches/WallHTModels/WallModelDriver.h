...
namespace Uintah{
  ...
  private:
	...
	pokluda_NP(ProblemSpecP db_model){
	  ...
	  if (ash_type == "indonesian"){
	    emiss_coeff = {-0.01325774, 0.76947707, 0.04946399, -1.89210921, 1.58619193, -0.01110779, -0.17247507, 0.21173737, 0.26360401, -0.36089757, 0.09880597, -0.02899764, 0.05042396, 0.11711279, -0.19244022, 0.06078965, -0.01503580, 0.05061467, -0.08104291, 0.03184961, 0.02851790, -0.01705938, 0.01002303, 0.00663616, -0.00319116, 0.69316767, -0.00765589, -0.37210005};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.46342074e-01;
	    ystd = 2.86822200e-01;
	    surfT = {5.80176135e-01,-7.82543187e-05};
	    pokluda={-1.00866428e-01, 1.07734909e+01};
	    fresnel={9.66910886e-01, -9.66846099e-07, -1.61831834e-01, -5.56193142e-03};
	  } else if (ash_type == "german_lignite"){ // sort of northD lignite
	    emiss_coeff = {0.04900869, 0.65519317, 0.08639436, -1.75777089, 1.45988189, -0.01697395, -0.13737705, 0.17230585, 0.24169049, -0.31978392, 0.08669600, -0.01288239, 0.03524204, 0.10830602, -0.17231098, 0.05379189, -0.02055617, 0.04924087, -0.07677330, 0.03001339, 0.02765874, -0.01691571, 0.01036896, 0.00736627, -0.00294765, 0.67646908, -0.00779755, -0.34135288};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.30722561e-01;
	    ystd = 2.95271668e-01;
	    surfT = {4.54764831e-01,1.11098562e-05};
	    pokluda={-7.69871939e-01, 9.06527532e+00};
	    fresnel={9.66193642e-01, -9.90976839e-07, -1.65707870e-01, -5.74290407e-03};
	  } else if(ash_type == "ND_lignite"){ // German lignite
	    emiss_coeff = {-0.17399550, 1.25739571, -0.21106407, -2.36532044, 2.08223505, -0.04147586, -0.17344191, 0.29689866, 0.14111935, -0.27942477, 0.07893926, -0.03814567, 0.13554347, 0.08408721, -0.21090898, 0.06870478, 0.03102050, 0.02657479, -0.10870755, 0.04399858, 0.01008216, -0.03669535, 0.02044134, -0.00498630, 0.00566287, 0.71076408, -0.00139360, -0.49556878};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.71500277e-01;
	    ystd = 2.59818746e-01;
	    surfT = {4.23447583e-01,3.99712112e-05};
	    pokluda={1.46381603e+00, 7.70764580e+00};
	    fresnel={9.46643111e-01, -4.83508843e-06, -2.56800645e-03, -1.02516552e-03};
	  }else if (ash_type == "sufco"){
	    emiss_coeff = {0.13780423, 0.50822243, 0.12584029, -1.57419731, 1.29275016, -0.03129518, -0.09039247, 0.12592482, 0.21200421, -0.26840651, 0.07166424, 0.00847841, 0.01579859, 0.09999122, -0.15244184, 0.04696194, -0.03258806, 0.05124883, -0.07325460, 0.02857064, 0.03058931, -0.01595034, 0.01053170, 0.01012314, -0.00375861, 0.64230070, -0.00934946, -0.30124026};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.10053601e-01;
	    ystd = 3.01390923e-01;
	    surfT = {4.99663849e-01,-4.78930294e-05};
	    pokluda={-9.95122374e-01, 9.14122527e+00};
	    fresnel={9.63304480e-01, -1.44384596e-06, -1.70714336e-01, -5.59889179e-03};
	  } else if (ash_type == "black_thunder"){
	    emiss_coeff = {0.12909394, 0.51321724, 0.13000583, -1.58354780, 1.29822926, -0.03037662, -0.09463816, 0.12911106, 0.21807735, -0.27585795, 0.07373978, 0.00779193, 0.01707230, 0.10057713, -0.15345873, 0.04727574, -0.03101491, 0.05011684, -0.07294069, 0.02844550, 0.02933323, -0.01598964, 0.01050656, 0.00966236, -0.00348558, 0.64546551, -0.00895242, -0.30230045};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.12550985e-01;
	    ystd = 3.01166188e-01;
	    surfT = {4.61808130e-01,-7.09388109e-06};
	    pokluda={-2.57605576e-01, 7.54042788e+00};
	    fresnel={9.65976718e-01, -1.11294924e-06, -1.65766087e-01, -5.65969063e-03};
	  } else if (ash_type == "river_basin"){
	    emiss_coeff = {0.13273748, 0.52270177, 0.11859227, -1.58869226, 1.30723612, -0.03493909, -0.08531154, 0.12781557, 0.19862363, -0.25559501, 0.06821154, 0.01184946, 0.02272252, 0.09385155, -0.14915192, 0.04586692, -0.02667870, 0.04650723, -0.07532327, 0.02942419, 0.02678476, -0.01888819, 0.01216189, 0.00812249, -0.00206058, 0.64423520, -0.00812955, -0.30471368};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.08773107e-01;
	    ystd = 3.03000945e-01;
	    surfT = {6.65251325e-01,-1.01475542e-04};
	    pokluda={1.68610814e-01, 7.64107965e+00};
	    fresnel={9.63659247e-01, -1.85003100e-06, -1.75984280e-01, -6.79287152e-03};
	  } else if (ash_type == "illinois_no6"){
	    emiss_coeff = {-0.08623869, 0.94321549, -0.02636026, -2.07862703, 1.77172706, -0.00998569, -0.20482862, 0.25902204, 0.26973507, -0.39086858, 0.10825056, -0.04442436, 0.07158617, 0.12372854, -0.21496292, 0.06885685, -0.00719546, 0.05103842, -0.08752627, 0.03470233, 0.02771561, -0.01805204, 0.01015357, 0.00561260, -0.00311206, 0.70713480, -0.00714044, -0.41791175};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 7.63279862e-01;
	    ystd = 2.73476391e-01;
	    surfT = {4.13077467e-01,-1.17417260e-05};
	    pokluda={-1.57824731e+00, 8.84236968e+00};
	    fresnel={9.63681095e-01, -1.00150532e-06, -1.56694896e-01, -5.01924152e-03};
	    ...
	    pokluda={-5.10314026e-02, 1.26264329e+00};
	    fresnel={9.58939398e-01, -1.94306615e-06, -1.52516593e-01, -5.40993057e-03};
	  }else if (ash_type == "Sawdust"){ //Biomass
	    emiss_coeff = {0.15232498, 0.52384151, 0.09984559, -1.57580052, 1.30442371, -0.04325339, -0.06112965, 0.11475969, 0.15905172, -0.20896006, 0.05516192, 0.02045163, 0.02851480, 0.08187140, -0.13939356, 0.04270075, -0.02222587, 0.04199073, -0.07856715, 0.03076408, 0.02385809, -0.02312147, 0.01466296, 0.00639124, -0.00019175, 0.63713088, -0.00726427, -0.30457445};
	    xmean = {1.30000000e+03, 1.25326087e-03};
	    xstd = {6.17341227e+02, 1.33273598e-03};
	    ymean = 6.99191913e-01;
	    ystd = 3.05049175e-01;
	    surfT = {4.62777997e-01,2.58188607e-05};
	    pokluda={7.59674058e-01, 7.72349835e+00};
	    fresnel={9.54356778e-01, -3.60329558e-06, -2.68823964e-01, -9.39292882e-03};
	  } else {
	    throw InvalidValue("Error, coal_name wasn't recognized in pokluda ash emissivity data-base. ", __FILE__, __LINE__);
	  }
	}
	...
	void model(double &e, const double &C, double &T, double &Dp, double &tau, std::vector<double> Dp_vec, std::vector<double> vdot) {
	  ...
	  for(int env = 0; env != Nenv; env++) {
	    ...
	    d_eff = std::max(10e-6,std::min(6.*p_volume*NP/Sf,4000e-6));
	    //std::cout << "surface_tension " << surface_tension << std::endl;
	    //std::cout << "visc " << visc << std::endl;
	    //std::cout << "T: " << T << " tau: " << tau << " Dp_vec[env]: " << Dp_vec[env] << " d_eff: " << d_eff << std::endl; 
	    //std::cout << "erf: " << (log10tau-pokluda[0])/(std::sqrt(2.)*pokluda[1])  << " " << std::erf((log10tau-pokluda[0])/(std::sqrt(2.)*pokluda[1])) << std::endl; 
