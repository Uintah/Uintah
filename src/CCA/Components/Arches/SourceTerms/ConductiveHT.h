#ifndef Uintah_Component_Arches_ConductiveHT_h
#define Uintah_Component_Arches_ConductiveHT_h
...
class ConductiveHT: public SourceTermBase {
public:

  ConductiveHT( std::string srcName, ArchesLabel* field_labels,
  ...
  class Builder
    ...
    public:
      ...
      ConductiveHT* build()
      { return scinew ConductiveHT( _name, _field_labels, _required_label_names, _type ); };
