...
template<typename TT>
template<typename ExecutionSpace, typename MemorySpace>
void DSmaMMML<TT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
...
DSmaMMML<TT>::timestep_init( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& executionObject ){
...
template<typename TT>
template<typename ExecutionSpace, typename MemorySpace>
void DSmaMMML<TT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
