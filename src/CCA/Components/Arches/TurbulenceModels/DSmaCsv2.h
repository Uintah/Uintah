...
template<typename TT>
template<typename ExecutionSpace, typename MemSpace>
void DSmaCsv2<TT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& executionObject ){
  if (m_create_labels_IsI_t_viscosity) {
...
template<typename TT>
template<typename ExecutionSpace, typename MemSpace>
void DSmaCsv2<TT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemSpace>& executionObject ){
