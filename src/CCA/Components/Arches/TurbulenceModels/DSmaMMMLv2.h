...
public:
    ...
    class Builder : public TaskInterface::TaskBuilder {
      ...
      DSmaMMMLv2* build()
      { return scinew DSmaMMMLv2<TT>( _task_name, _matl_index ); }
...
template<typename TT>
template<typename ExecutionSpace, typename MemorySpace>
void DSmaMMMLv2<TT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
...
template<typename TT>
template<typename ExecutionSpace, typename MemorySpace>
void DSmaMMMLv2<TT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
