...
template<typename TT>
template<typename ExecutionSpace, typename MemorySpace>
void DSmaCs<TT>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
...
template<typename TT>
template<typename ExecutionSpace, typename MemorySpace>
void DSmaCs<TT>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecutionSpace, MemorySpace>& executionObject ){
