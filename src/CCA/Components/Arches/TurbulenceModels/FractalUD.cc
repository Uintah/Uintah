...
namespace Uintah{
  ...
  TaskAssignedExecutionSpace FractalUD::loadTaskInitializeFunctionPointers()
  {
    return create_portable_arches_tasks<TaskInterface::INITIALIZE>( this
                                       ...
                                       //, &FractalUD::initialize<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                       );
  }
  ...
  TaskAssignedExecutionSpace FractalUD::loadTaskEvalFunctionPointers()
  {
    return create_portable_arches_tasks<TaskInterface::TIMESTEP_EVAL>( this
                                       ...
                                       //, &FractalUD::eval<KOKKOS_DEFAULT_DEVICE_TAG>            // Task supports Kokkos builds
                                       );
  }
  ...
  void FractalUD::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
      ...
      SFCXVariable<double>& uD_ctr = tsk_info->get_field<SFCXVariable<double> >("uD_ctr");
      SFCXVariable<double>& ucell_XvelD = tsk_info->get_field<SFCXVariable<double> >("ucell_XvelD");
      SFCXVariable<double>& ucell_YvelD = tsk_info->get_field<SFCXVariable<double> >("ucell_YvelD");
      SFCXVariable<double>& ucell_ZvelD = tsk_info->get_field<SFCXVariable<double> >("ucell_ZvelD");

      SFCYVariable<double>& vD_ctr = tsk_info->get_field<SFCYVariable<double> >("vD_ctr");
      SFCYVariable<double>& vcell_XvelD = tsk_info->get_field<SFCYVariable<double> >("vcell_XvelD");
      SFCYVariable<double>& vcell_YvelD = tsk_info->get_field<SFCYVariable<double> >("vcell_YvelD");
      SFCYVariable<double>& vcell_ZvelD = tsk_info->get_field<SFCYVariable<double> >("vcell_ZvelD");

      SFCZVariable<double>& wD_ctr = tsk_info->get_field<SFCZVariable<double> >("wD_ctr");
      SFCZVariable<double>& wcell_XvelD = tsk_info->get_field<SFCZVariable<double> >("wcell_XvelD");
      SFCZVariable<double>& wcell_YvelD = tsk_info->get_field<SFCZVariable<double> >("wcell_YvelD");
      SFCZVariable<double>& wcell_ZvelD = tsk_info->get_field<SFCZVariable<double> >("wcell_ZvelD");
      //U2D
      // SFCXVariable<double>& u2D_ctr = tsk_info->get_field<SFCXVariable<double> >("u2D_ctr");
      // SFCYVariable<double>& v2D_ctr   =  *(tsk_info->get_uintah_field<SFCYVariable<double> >("v2D_ctr"));
      // SFCZVariable<double>& w2D_ctr = tsk_info->get_field<SFCZVariable<double> >("w2D_ctr");
      ...
      //
      SFCXVariable<double>& uustress = tsk_info->get_field<SFCXVariable<double> >("uustress");
      SFCXVariable<double>& uvstress = tsk_info->get_field<SFCXVariable<double> >("uvstress");
      SFCXVariable<double>& uwstress = tsk_info->get_field<SFCXVariable<double> >("uwstress");
      //
      SFCYVariable<double>& vustress = tsk_info->get_field<SFCYVariable<double> >("vustress");
      SFCYVariable<double>& vvstress = tsk_info->get_field<SFCYVariable<double> >("vvstress");
      SFCYVariable<double>& vwstress = tsk_info->get_field<SFCYVariable<double> >("vwstress");
      //
      SFCZVariable<double>& wustress = tsk_info->get_field<SFCZVariable<double> >("wustress");
      SFCZVariable<double>& wvstress = tsk_info->get_field<SFCZVariable<double> >("wvstress");
      SFCZVariable<double>& wwstress = tsk_info->get_field<SFCZVariable<double> >("wwstress");
  ...
  void FractalUD::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject<ExecSpace, MemSpace>& execObj ){
      ...
      constSFCXVariable<double>& uFaceZ = tsk_info->get_field<constSFCXVariable<double> >(Uz_face_name);
      constSFCYVariable<double>& vFaceX = tsk_info->get_field<constSFCYVariable<double> >(Vx_face_name);
      constSFCYVariable<double>& vFaceY = tsk_info->get_field<constSFCYVariable<double> >(Vy_face_name);
      constSFCYVariable<double>& vFaceZ = tsk_info->get_field<constSFCYVariable<double> >(Vz_face_name);
      constSFCZVariable<double>& wFaceX = tsk_info->get_field<constSFCZVariable<double> >(Wx_face_name);
      constSFCZVariable<double>& wFaceY = tsk_info->get_field<constSFCZVariable<double> >(Wy_face_name);
      constSFCZVariable<double>& wFaceZ = tsk_info->get_field<constSFCZVariable<double> >(Wz_face_name);
      constSFCXVariable<double>& U_ctr = tsk_info->get_field<constSFCXVariable<double> > (m_u_vel_name);
      constSFCYVariable<double>& V_ctr = tsk_info->get_field<constSFCYVariable<double> > (m_v_vel_name);
      constSFCZVariable<double>& W_ctr = tsk_info->get_field<constSFCZVariable<double> > (m_w_vel_name);

      // UD
      SFCXVariable<double>& uD_ctr          = tsk_info->get_field<SFCXVariable<double> >(m_VelDelta_names[0]);
      SFCXVariable<double>& ucell_XvelD     = tsk_info->get_field<SFCXVariable<double> >("ucell_XvelD");
      SFCXVariable<double>& ucell_YvelD     = tsk_info->get_field<SFCXVariable<double> >("ucell_YvelD");
      SFCXVariable<double>& ucell_ZvelD     = tsk_info->get_field<SFCXVariable<double> >("ucell_ZvelD");
      ...
      //U2D
      SFCXVariable<double>& u2D_ctr         = tsk_info->get_field<SFCXVariable<double> >("u2D_ctr");
      SFCYVariable<double>& v2D_ctr         = tsk_info->get_field<SFCYVariable<double> >("v2D_ctr");
      SFCZVariable<double>& w2D_ctr         = tsk_info->get_field<SFCZVariable<double> >("w2D_ctr");
      //
      SFCXVariable<double>& uustress = tsk_info->get_field<SFCXVariable<double> >("uustress");
      SFCXVariable<double>& uvstress = tsk_info->get_field<SFCXVariable<double> >("uvstress");
