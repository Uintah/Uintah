...
//  2) Do a find and replace on CLASSNAME to change the class name. 
//  3) Add details of your property. 
...
CLASSNAME::CLASSNAME( std::string prop_name, SimulationStateP& shared_state ) : PropertyModelBase( prop_name, shared_state )
{
  ...
  // additional local labels as needed by this class: 
  std::string name = "something"; 
  _something_label = VarLabel::create( name, CCVariable<double>::getTypeDescription() ); 
