#ifndef Uintah_Component_Arches_ColdFlowPropertiesRP_h
#define Uintah_Component_Arches_ColdFlowPropertiesRP_h

#include <CCA/Components/Arches/Task/TaskInterface.h>

namespace Uintah{

  class ColdFlowPropertiesRP : public TaskInterface {

public:

    typedef std::vector<ArchesFieldContainer::VariableInformation> VIVec;

    ColdFlowPropertiesRP( std::string task_name, int matl_index );
    ~ColdFlowPropertiesRP();
    ...
    //Build instructions for this (ColdFlowPropertiesRP) class.
    class Builder : public TaskInterface::TaskBuilder {
      ...
      ColdFlowPropertiesRP* build()
      { return scinew ColdFlowPropertiesRP( _task_name, _matl_index ); }
