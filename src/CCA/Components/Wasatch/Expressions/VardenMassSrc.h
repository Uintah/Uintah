#ifndef VardenMassSrc_Expr_h
#define VardenMassSrc_Expr_h
 ...
 *
 */
class VardenMassSrc : public Expr::Expression<SVolField>
{  
  ...
  VardenMassSrc( const Expr::TagList& momTags,
