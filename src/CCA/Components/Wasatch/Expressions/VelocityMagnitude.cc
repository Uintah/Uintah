...
{
  const typename Expr::FieldManagerSelector<Vel1T>::type& v1fm = fml.template field_manager<Vel1T>();
  const typename Expr::FieldManagerSelector<Vel2T>::type& v2fm = fml.template field_manager<Vel2T>();
  const typename Expr::FieldManagerSelector<Vel3T>::type& v3fm = fml.template field_manager<Vel3T>();
