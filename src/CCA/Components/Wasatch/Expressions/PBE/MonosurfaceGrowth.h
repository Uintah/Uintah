...
public:
  ...
  public:
    ...
    {
      if (isconstcoef_) return new MonosurfaceGrowth<FieldT>( phit_, growthcoefval_, momentorder_ );
      else              return new MonosurfaceGrowth<FieldT>( phit_, growthcoeft_,   momentorder_ );
    }
