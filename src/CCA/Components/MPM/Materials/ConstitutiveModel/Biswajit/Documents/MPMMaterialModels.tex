...
(in the contex of von Mises plasticity) is given below.
  ...
  yield condition
  \begin{equation}
    f := \sqrt{\frac{3}{2}}\Norm{\Bs}{} - \sigma_y \le 0  ~~\text{or,}~~
  ...
  \begin{equation}
    \Bu = \sqrt{3} \frac{\Bs}{\Norm{\Bs}{}}; \quad
    \gamma := \sqrt{3}\Lambda\Norm{\Bs}{}  \quad \Longrightarrow
  ...
  \begin{equation}\label{eq:taudot}
    \sqrt{2} \dot{\tau} = \sqrt{3} \frac{\Bs:\dot{\Bs}}{\Norm{\Bs}{}}
  \end{equation}
  ...
  \begin{equation}
    \frac{2}{\sqrt{3}} (d^*)^2 - (\Beta:\Bu^s + \Norm{\Beta}{}) d^*
       + 3\gamma_n (\Beta:\Bu^s - \Norm{\Beta}{}) = 0
  \end{equation}
  ...
  \begin{align}
    \tilde{\Bs}_{n+1} & = \Bs_n + 2\mu\left(\eta\Delta t  - \sqrt{3}\Delta\gamma
         \cfrac{\tilde{\Bs}_{n+1}}{\Norm{\Bs_{n+1}}{}}\right) \\
...
\end{verbatim}
The code is in \verb|.../MPM/Materials/ConstitutiveModel/PlasticityModels/DefaultHypoElasticEOS.cc|.
...
\end{verbatim}
The code is in \verb|.../MPM/Materials/ConstitutiveModel/PlasticityModels/HyperElasticEOS.cc|.  If an EOS is not specified then this model is the {\bf default}.
...
\end{verbatim}
The code is in \verb|.../MPM/Materials/ConstitutiveModel/PlasticityModels/MieGruneisenEOS.cc|.
...
\subsubsection{Melting Temperature}
  ...
  The inputs can be found in \verb|.../MPM/Materials/ConstitutiveModel/PlasticityModel/PTWShear.h|.
