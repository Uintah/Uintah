 module spline2
 implicit none
 public :: complex_spline2_xy
 public :: complex_spline2_z
 public :: real_spline2_and_deriv
 public :: real_spline2_pp 

contains  
 subroutine complex_spline2_xy(order,nfft,spline)
 implicit none
 ...
 subroutine complex_spline2_z(order,h_cut,nfft,spline)
 implicit none
...
! h_cut = nfftz/2
 ...
 subroutine real_spline2_and_deriv(order,x,spline,spline_DERIV)
 implicit none
