...
// DO-NOT-DELETE splicer.begin(BridgeTest.Com._hincludes)
// insert code here (includes or arbitrary code)
// DO-NOT-DELETE splicer.end(BridgeTest.Com._hincludes)
...
namespace BridgeTest { 
   ...
   */
  class Com_impl : public virtual ::BridgeTest::Com 
  ...
  public:
    ...
    // (fixes bug #275)
      Com_impl( struct BridgeTest_Com__object * ior ) : StubBase(ior,true), 
...
// DO-NOT-DELETE splicer.begin(BridgeTest.Com._hmisc)
// insert code here (miscellaneous things)
// DO-NOT-DELETE splicer.end(BridgeTest.Com._hmisc)
