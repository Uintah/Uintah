...
#endif
#ifndef included_NewPort_GoPort_hxx
#include "NewPort_GoPort.hxx"
#endif
...
// DO-NOT-DELETE splicer.begin(NewPort.GoPort._hincludes)
// insert code here (includes or arbitrary code)
// DO-NOT-DELETE splicer.end(NewPort.GoPort._hincludes)
...
namespace NewPort { 
  ...
  public:
    ...
    // (fixes bug #275)
      GoPort_impl( struct NewPort_GoPort__object * ior ) : StubBase(ior,true), 
...
// DO-NOT-DELETE splicer.begin(NewPort.GoPort._hmisc)
// insert code here (miscellaneous things)
// DO-NOT-DELETE splicer.end(NewPort.GoPort._hmisc)
