...
namespace SIDL {
  template<>
  class array< ::whoc::Com>;
}

#ifndef included_SIDL_cxx_hh
#include "SIDL_cxx.hh"
#endif
#ifndef included_whoc_Com_IOR_h
...
namespace whoc { 
  ...
  public:
    typedef struct whoc_Com__object ior_t;
    typedef struct whoc_Com__external ext_t;
    typedef struct whoc_Com__sepv sepv_t;

    // default constructor
    Com() : d_self(0), d_weak_reference(false) { }

    // static constructor
    static ::whoc::Com _create();
...
namespace SIDL {
  template<>
  class array< ::whoc::Com> : public array_mixin< struct whoc_Com__array,
    struct whoc_Com__object*, ::whoc::Com>{
  public:
    /**
     * default constructor
     */
    array() : array_mixin< struct whoc_Com__array, struct whoc_Com__object*,
      ::whoc::Com>() {}
     ...
     * copy constructor
     */
    array( const array< ::whoc::Com >& original ) {
     ...
     * assignment operator
     */
    array< ::whoc::Com >& operator=( const array< ::whoc::Com >& rhs ) {
   ...
   */
  array( struct whoc_Com__array* src ) : array_mixin< struct whoc_Com__array,
    struct whoc_Com__object*, ::whoc::Com>(src) {}

  /**
   * static constructor: createRow
   */
  static array < ::whoc::Com >
  createRow(int32_t dimen, const int32_t lower[], const int32_t upper[]) {
    array < ::whoc::Com > a;
    a._set_ior( (struct whoc_Com__array*)
   ...
   * copy
   */
  void copy( const array< ::whoc::Com>& src ) {
  ...
  void smartCopy() {
    ...
    _set_ior( (struct whoc_Com__array*) p);
  }
