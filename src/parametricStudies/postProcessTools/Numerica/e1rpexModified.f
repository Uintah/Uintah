...
C                                                                      *
C     Modified by Todd Harman, 2009 & 2025                             *
C     To compile:                                                      *
C         gfortran -o exactRiemann e1rpex.Modified.f                   *
*                                                                      *
*     Usage:                                                           *
C         e1rpex <inputFile> <outputFile> <nCells>                     *
C                  or                                                  *
C         e1pres                                                       *
C             <user input: inputFile>                                  *
C             <user input: outputfile>                                 *
C             <user input: nCells>                                     *
C                                                                      *
...
*
      COMMON /STATES/ DL, UL, PL, CL, DR, UR, PR, CR
      DATA TOLPRE, NRITER/1.0E-015, 20/
*
...
C     Declaration of variables
*
      DOUBLE PRECISION    AK, BK, CK, DK, F, FD, P, PK, PRATIO, QRT,
     &        GAMMA, G1, G2, G3, G4, G5, G6, G7, G8
*
      COMMON /GAMMAS/ GAMMA, G1, G2, G3, G4, G5, G6, G7, G8
*
