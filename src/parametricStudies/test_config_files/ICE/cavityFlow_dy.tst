...
<start>
<upsFile>cavityFlow_dy.ups</upsFile>
...
<Test>
    <Title>5000</Title>
    <sus_cmd>mpirun -np 6 sus </sus_cmd>
    <postProcess_cmd>compare_cavityFlow.m -aDir 2 -mat 0 -plot true -Re 5000</postProcess_cmd>
    <replace_lines>
      <maxTime>   20    </maxTime>
    </replace_lines>
    <replace_values>
...
<Test>
    <Title>7500</Title>
    <sus_cmd>mpirun -np 6 sus </sus_cmd>
    <postProcess_cmd>compare_cavityFlow.m -aDir 2 -mat 0 -plot true -Re 7500</postProcess_cmd>
    <replace_lines>
      <maxTime>   15    </maxTime>
    </replace_lines>
    <replace_values>
...
<Test>
    <Title>10000</Title>
    <sus_cmd>mpirun -np 6 sus </sus_cmd>
    <postProcess_cmd>compare_cavityFlow.m -aDir 2 -mat 0 -plot true -Re 10000</postProcess_cmd>
    <replace_lines>
      <maxTime>   10    </maxTime>
    </replace_lines>
    <replace_values>
