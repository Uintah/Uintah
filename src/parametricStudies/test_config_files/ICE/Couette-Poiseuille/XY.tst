...
<AllTests>
  ...
  <replace_values>
    ...
    <entry path = "Uintah_specification/Grid/BoundaryConditions/Face[@side='x-']/BCType[@id = '0' and @label ='Pressure' and @var='Dirichlet']/value" value = '101215' />
    <entry path = "Uintah_specification/Grid/BoundaryConditions/Face[@side='x+']/BCType[@id = '0' and @label ='Pressure' and @var='Dirichlet']/value" value = '101315.' />
    -->
...
<Test>
    ...
    <postProcess_cmd>compare_Couette-Poiseuille.m -pDir 0 -sliceDir 1 -mat 0 -P 1 -periodicBCs false -plot true</postProcess_cmd>
    <x>10</x>
    <replace_lines>
...
<Test>
    <Title>50</Title>
    <sus_cmd> mpirun -np 4 sus </sus_cmd>
    <postProcess_cmd>compare_Couette-Poiseuille.m -pDir 0 -sliceDir 1 -mat 0 -plot true</postProcess_cmd>
    <x>50</x>
    <replace_lines>
