...
/*
 *  ScalarFieldRGshort.h: short Scalar Fields defined on a Regular grid
 *
 *  Written by:
...
#ifndef SCI_project_ScalarFieldRGshort_h
#define SCI_project_ScalarFieldRGshort_h 1
...
class ScalarFieldRGshort : public ScalarFieldRGBase {
public:
    Array3<short> grid;

    void resize(int, int, int);
    ScalarFieldRGshort();
    ScalarFieldRGshort(const ScalarFieldRGshort&);
    virtual ~ScalarFieldRGshort();
...
inline
double
ScalarFieldRGshort::get_value( const Point& ivoxel )
{
...
inline
double
ScalarFieldRGshort::get_value( int x, int y, int z )
{
  return grid( x, y, z );
}
...
// Initial commit
//
// Revision 1.4  1999/07/07 21:10:42  dav
