...
run "git clone -c http.sslVerify=false --depth 1 https://software.crsim.utah.edu:8443/James_Research_Group/SpatialOps.git SpatialOps"
...
run "cd src"
run "rm -rf ExprLib"
run "git clone -c http.sslVerify=false --depth 1 https://software.crsim.utah.edu:8443/James_Research_Group/ExprLib.git ExprLib"
...
run "cd src"
run "rm -rf TabProps"
run "git clone -c http.sslVerify=false --depth 1 https://software.crsim.utah.edu:8443/James_Research_Group/TabProps.git TabProps"
...
run "cd src"
run "rm -rf RadProps"
run "git clone -c http.sslVerify=false --depth 1 https://software.crsim.utah.edu:8443/James_Research_Group/RadProps.git RadProps"
