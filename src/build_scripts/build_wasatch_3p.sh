...
if test "$7" = "yes"; then
  ...
  if [[ `hostname` = titan* ]]; then
    CUDA="-DENABLE_CUDA=ON -DDISABLE_INTROSPECTION=ON -DCUDA_ARCHITECTURE_MINIMUM=\"3.5\" -DCUDA_HOST_COMPILER=/opt/gcc/4.9.0/bin/g++ -DCUDA_TOOLKIT_ROOT=$CUDATOOLKIT_HOME"
  else
...
SPATIAL_OPS_TAG=abb34f07debc564606397f6a308683c607856ab2
...
NSCBC_TAG=517867aa183af2db1e1a3d0b8559dd131dde5660
