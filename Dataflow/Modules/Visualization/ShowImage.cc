...
/*
 *  ShowImage.cc:  Unfinished modules
 *
 *  Written by:
 *   Steven G. Parker
...
extern "C" Module* make_ShowImage(const clString& id)
{
  return scinew ShowImage(id);
}

ShowImage::ShowImage(const clString& id)
  : Module("ShowImage", id, Filter), format("format", id, this),
