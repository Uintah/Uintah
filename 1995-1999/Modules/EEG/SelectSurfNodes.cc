...
public:
    ...
    SelectSurfNodes(const SelectSurfNodes&, int deep);
...
SelectSurfNodes::SelectSurfNodes(const SelectSurfNodes& copy, int deep)
: Module(copy, deep), method("method", id, this),
  sel_geom_idx(0), pts_changed(0), sphereSize("sphereSize", id, this), igen(0)
{
    NOT_FINISHED("SelectSurfNodes::SelectSurfNodes");
}
...
Module* SelectSurfNodes::clone(int deep)
{
    return new SelectSurfNodes(*this, deep);
}
