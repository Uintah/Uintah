...
public:
    ...
    Thermal(const Thermal&, int deep);
    virtual ~Thermal();
...
Thermal::Thermal(const Thermal& copy, int deep)
: Module(copy, deep),
  iters("iters", id, this), scale("scale", id, this), 
...
Module* Thermal::clone(int deep)
{
    return new Thermal(*this, deep);
}
