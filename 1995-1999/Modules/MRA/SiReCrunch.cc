...
public:
    ...
    SiReCrunch(const SiReCrunch&, int deep);
    virtual ~SiReCrunch();
...
extern "C" {
Module* make_SiReCrunch(const clString& id)
{
...
SiReCrunch::SiReCrunch(const SiReCrunch& copy, int deep)
: Module(copy, deep)
{
    NOT_FINISHED("SiReCrunch::SiReCrunch");
}
...
Module* SiReCrunch::clone(int deep)
{
    return new SiReCrunch(*this, deep);
}
