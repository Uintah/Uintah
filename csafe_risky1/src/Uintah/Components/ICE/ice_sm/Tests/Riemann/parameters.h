...
#define X_MAX_LIM       105              /* Max. array size in the x dir.  xHiLimit + 2 */
#define Y_MAX_LIM       5               /* Max. array size in the y dir.  yHiLimit + 2 */
...
#define compute_delt_based_on_velocity 3      
                                            ...
                                            /* =2 speed of sound                            */
                                            /* =3 fabs(velocity) + speed of souncd          */
...
#define GRAPHDESC  "Rieman Shock Tube Problem;  p_L/p_R = 10; rho_L = 1.0, rho_R = 0.125, u_L = 100 u_R = -50"
#define GRAPHDESC2 "CFL = 0.9; 2nd Order Advection No Limiter; delX = 0.075, delY = 1.0, x-direction,  Green = exact solution; Red = ICE"
#define GRAPHDESC3 ""
#define GRAPHDESC4 ""
