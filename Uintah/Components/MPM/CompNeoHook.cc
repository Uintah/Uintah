...
void CompNeoHook::readParameters(ifstream& in, double *p_array)
{
...
ConstitutiveModel* CompNeoHook::readParametersAndCreate(ifstream& in)
{
  double p_array[2];
...
ConstitutiveModel* CompNeoHook::readRestartParametersAndCreate(ifstream& in)
{
  Matrix3 dg(0.0);
