...
*___________________________________*/
#define switchDebug_advect_and_advance_in_time          1     /*  = 1 output to stderr, =2 plot data       */
...
/*__________________________________
*   Iterative Pressure switches
*   OLD AS OF 1/7/00 and not being used
*   and should probably be thrown away
*___________________________________*/
#define press_correction_vel_FC                         1     /* pressure correction term in the face     */
#define switchDebug_delta_press_CC                      0     /* Plotting inside of delta_press_cc         */
#define switchDebug_pressure_interation                 0     /* Pressure_iteration.cc                    */

#define switchDebug_vel_Face_n_iteration                0
                                                              /* Inside of face velocity interation       */
                                                              /*  =1 *vel_FC values & press_CC printout   */
                                                              /*  =2 *vel_FC, *vel_half_FC & press_CC     */

#define switchDebug_vel_initial_iteration               0     /* Inside of face velocity interation       */
#define switchDebug_convective_viscous_terms            0     /* Inside of onvective_viscous_terms        */
