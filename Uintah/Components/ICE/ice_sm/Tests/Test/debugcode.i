...
*   Variable 2
*___________________________________*/
        strcpy(graph_label,"Main Program ymom_source\0");
        data_array1    = convert_darray_4d_to_vector(
                                ymom_source,
                                GC_LO(xLoLimit),       GC_HI(xHiLimit),  GC_LO(yLoLimit),
                                GC_HI(yHiLimit),       (zLoLimit),       (zHiLimit),
...
*___________________________________*/        
       ...
       sprintf(graph_label, "Main Program uvel_FC, Mat. %d \0",m);
        ...
        sprintf(graph_label, "Main Program vvel_FC, Mat. %d \0",m);
        plot_face_centered_data(
                                GC_LO(xLoLimit),        GC_HI(xHiLimit),    GC_LO(yLoLimit),
                                GC_HI(yHiLimit),        (zLoLimit),         (zHiLimit),
                                delX,                   delY,               vvel_FC,
        ...
        sprintf(graph_label, "Main Program press_FC, Mat. %d \0",m);
        plot_face_centered_data(
                                GC_LO(xLoLimit),        GC_HI(xHiLimit),    GC_LO(yLoLimit),
                                GC_HI(yHiLimit),        (zLoLimit),         (zHiLimit),
                                delX,                   delY,               press_FC,
...
*   Variable 1
*___________________________________*/   
        strcpy(graph_label,"accumulate_momentum_source_sinks, ymom_source_CC\0");                
        data_array1    = convert_darray_4d_to_vector(
                                ymom_source,
                                GC_LO(xLoLimit),       GC_HI(xHiLimit),     GC_LO(yLoLimit),
                                GC_HI(yHiLimit),       (zLoLimit),          (zHiLimit),
