...
itcl_class Phil_Tbon_Tbon {
	...
	label $w.title -text "TBON Parameters"
	...
	button $w.color.changer -text "Change Color" -command $cc
	...
	pack $w.color.top $w.color.changer \
		-in $w.color -side top -fill both -pady 2
