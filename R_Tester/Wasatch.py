...
#	("particle-test-driven-cavity-upper-half-IC", "particle-test-driven-cavity-upper-half-IC.ups",   4,  "Linux",   ["exactComparison","no_memoryTest"] ),
  ...
  ("varden-3D-lowres-jet-IMPULSE",                  "varden-3D-lowres-jet-IMPULSE.ups",       8,  "Linux",  ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
  ("varden-projection-mms",                         "varden-projection-mms.ups",              3,  "Linux",  ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
  ("varden-projection-2d-oscillating-periodic-mms-xy", "varden-projection-2d-oscillating-periodic-mms-xy.ups", 4,  "Linux",  ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
  ("varden-projection-2d-oscillating-periodic-mms-xz", "varden-projection-2d-oscillating-periodic-mms-xz.ups", 4,  "Linux",  ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
  ("varden-projection-2d-oscillating-periodic-mms-yz", "varden-projection-2d-oscillating-periodic-mms-yz.ups", 4,  "Linux",  ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
  ("varden-projection-advection-xdir",              "varden-projection-advection-xdir.ups",   3,  "Linux",  ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
  ("varden-projection-advection-ydir",              "varden-projection-advection-ydir.ups",   3,  "Linux",  ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
  ("varden-projection-advection-zdir",              "varden-projection-advection-zdir.ups",   3,  "Linux",  ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
  ("varden-projection-advection-xdir-analytic-dens","varden-projection-advection-xdir-analytic-dens.ups", 3, "Linux", ["exactComparison","no_restart","do_not_validate","no_memoryTest"] ),
