...
// Symbol Type:   class
// Babel Version: 0.7.0
// SIDL Created:  20020731 15:22:40 MST
// Generated:     20020731 15:22:43 MST
...
#define included_whoc_IDPort_hh
...
namespace SIDL {
  template<>
  class array<whoc::IDPort>;
}

#ifndef included_SIDL_cxx_hh
#include "SIDL_cxx.hh"
#endif
#ifndef included_whoc_IDPort_IOR_h
...
namespace whoc { 
  ...
  public:
    typedef struct whoc_IDPort__object ior_t;
    typedef struct whoc_IDPort__external ext_t;
    typedef struct whoc_IDPort__sepv sepv_t;

    // default constructor
    IDPort() : d_self(0), d_weak_reference(false) { }

    // static constructor
    static whoc::IDPort _create();
...
namespace SIDL {
  template<>
  class array<whoc::IDPort> : public array_mixin< struct whoc_IDPort__array,
    struct whoc_IDPort__object*, whoc::IDPort>{
  public:
    /**
     * default constructor
     */
    array() : array_mixin< struct whoc_IDPort__array,
      struct whoc_IDPort__object*, whoc::IDPort>() {}
     ...
     * copy constructor
     */
    array( const array< whoc::IDPort >& original ) {
     ...
     * assignment operator
     */
    array< whoc::IDPort >& operator=( const array< whoc::IDPort >& rhs ) {
   ...
   */
  array( struct whoc_IDPort__array* src ) : array_mixin< struct 
    whoc_IDPort__array, struct whoc_IDPort__object*, whoc::IDPort>(src) {}

  /**
   * static constructor: createRow
   */
  static array < whoc::IDPort >
  createRow(int32_t dimen, const int32_t lower[], const int32_t upper[]) {
    array < whoc::IDPort > a;
    a._set_ior( (struct whoc_IDPort__array*)
   ...
   * copy
   */
  void copy( const array<whoc::IDPort>& src ) {
  ...
  void smartCopy() {
    ...
    _set_ior( (struct whoc_IDPort__array*) p);
  }
