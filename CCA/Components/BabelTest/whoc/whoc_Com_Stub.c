 ...
 * Generated:     20020813 11:08:03 CDT
...
static const struct whoc_Com__external* _getIOR(void)
{
  ...
  if (!_ior) {
    ...
    if (!_ior) {
      fputs("Unable to find the implementation for whoc.Com; please set SIDL_DLL_PATH\n", stderr);
      exit(-1);
    }
#endif
  }
