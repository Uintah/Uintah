...
namespace who { 
  ...
  public:
    typedef struct who_UIPort__object ior_t;
    typedef struct who_UIPort__external ext_t;
    typedef struct who_UIPort__sepv sepv_t;

    // default constructor
    UIPort() : d_self(0), d_weak_reference(false) { }

    // static constructor
    static ::who::UIPort _create();
...
namespace SIDL {
  template<>
  class array< ::who::UIPort> : public array_mixin< struct who_UIPort__array,
    struct who_UIPort__object*, ::who::UIPort>{
  public:
    /**
     * default constructor
     */
    array() : array_mixin< struct who_UIPort__array, struct who_UIPort__object*,
      ::who::UIPort>() {}
     ...
     * copy constructor
     */
    array( const array< ::who::UIPort >& original ) {
     ...
     * assignment operator
     */
    array< ::who::UIPort >& operator=( const array< ::who::UIPort >& rhs ) {
   ...
   */
  array( struct who_UIPort__array* src ) : array_mixin< struct 
    who_UIPort__array, struct who_UIPort__object*, ::who::UIPort>(src) {}

  /**
   * static constructor: createRow
   */
  static array < ::who::UIPort >
  createRow(int32_t dimen, const int32_t lower[], const int32_t upper[]) {
    array < ::who::UIPort > a;
    a._set_ior( (struct who_UIPort__array*)
   ...
   * copy
   */
  void copy( const array< ::who::UIPort>& src ) {
  ...
  void smartCopy() {
    ...
    _set_ior( (struct who_UIPort__array*) p);
  }
