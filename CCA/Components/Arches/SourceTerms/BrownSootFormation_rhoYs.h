#ifndef Uintah_Component_Arches_BrownSootFormation_rhoYs_h
#define Uintah_Component_Arches_BrownSootFormation_rhoYs_h
...
* \code 
*   <Sources>
*     <src label = "my_source" type = "BrownSootFormation_rhoYs" >
...
class BrownSootFormation_rhoYs: public SourceTermBase {
public: 

  BrownSootFormation_rhoYs( std::string srcName, ArchesLabel* field_labels, 
                std::vector<std::string> reqLabelNames, std::string type );

  ~BrownSootFormation_rhoYs();
    ...
    public: 
      ...
      Builder( std::string name, std::vector<std::string> required_label_names, ArchesLabel* field_labels )
        : _name(name), _field_labels(field_labels), _required_label_names(required_label_names){
          _type = "BrownSootFormation_rhoYs"; 
        };
      ~Builder(){}; 

      BrownSootFormation_rhoYs* build()
      { return scinew BrownSootFormation_rhoYs( _name, _field_labels, _required_label_names, _type ); };
