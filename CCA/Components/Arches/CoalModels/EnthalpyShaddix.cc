...
EnthalpyShaddix::problemSetup(const ProblemSpecP& params, int qn)
{
  ...
  if (params_root->findBlock("CFD")->findBlock("ARCHES")->findBlock("Coal_Properties")) {
    ...
    db_coal->require("raw_coal_enthalpy", Hc0);
    db_coal->require("char_enthalpy", Hh0);
    db_coal->require("ash_enthalpy", Ha0);
    db_coal->getWithDefault( "ksi",ksi,1); // Fraction of the heat released by char oxidation that goes to the particle
