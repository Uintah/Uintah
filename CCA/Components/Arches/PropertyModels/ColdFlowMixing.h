#ifndef Uintah_Component_Arches_ColdFlowMixing_h
#define Uintah_Component_Arches_ColdFlowMixing_h
...
namespace Uintah{ 
  ...
  class ColdFlowMixing : public PropertyModelBase {

    public: 

      ColdFlowMixing( std::string prop_name, SimulationStateP& shared_state );
      ~ColdFlowMixing(); 
      ...
      class Builder
        ...
        public: 
          ...
          ColdFlowMixing* build()
          { return scinew ColdFlowMixing( _name, _shared_state ); };
