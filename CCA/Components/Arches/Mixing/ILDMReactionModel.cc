...
{ 
 ...
 d_lsoot = true;
 //rxn_db->require("SpeciesInTable", d_numSpecInTbl);
 d_numSpecInTbl = 13;
  d_mixModel = mixModel;
...
void
ILDMReactionModel::computeRxnStateSpace(Stream unreactedMixture, vector<double> mixRxnVar, 
