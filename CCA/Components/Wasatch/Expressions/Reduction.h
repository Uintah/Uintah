 ...
 *  \brief  Provides an expression-based approach to defining reduction variables.
 */
template< typename ReductionOpT > // the type of reduction operation: Reductions::Sum<double> etc...
class Reduction<double, ReductionOpT>
: public ReductionBase//, public Expr::PlaceHolder<double>
{
  const double* src_;
  Reduction( const Expr::Tag& resultTag,
            const Expr::Tag& srcTag,
