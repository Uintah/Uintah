...
namespace Uintah {
  ...
  template<class Types>
  void
  HypreDriver<Types>::makeLinearSystem(const HypreInterface& interface)
    /*_____________________________________________________________________
  ...
  template<class Types>
  void HypreDriver::getSolution(const HypreInterface& interface)
    /*_____________________________________________________________________
  ...
  /*_____________________________________________________________________
    class HypreDriver implementation for CC variables, Struct interface
    _____________________________________________________________________*/

  void
  HypreDriver<CCTypes>::makeLinearSystemStruct(void)
    /*_____________________________________________________________________
      Function HypreDriver<CCTypes>::makeLinearSystemStruct
  ...
  } // end HypreDriver<CCTypes>::makeLinearSystemStruct()


  void HypreDriver<CCTypes>::getSolutionStruct(void)
    /*_____________________________________________________________________
      Function HypreDriver<CCTypes>::makeLinearSystemStruct
  ...
  } // end HypreDriver<CCTypes>::getSolutionStruct()

  /*_____________________________________________________________________
    class HypreDriver implementation for CC variables, SStruct interface
    _____________________________________________________________________*/
