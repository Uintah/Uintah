...
void
Poisson2::scheduleTimeAdvance(const LevelP&, SchedulerP&, int , int )
{
  cout << "Poisson2 component does not support ARM yet.\n";
  throw InternalError("Poisson2 component does not support AMR yet.");
}
