...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\textwidth]{ProblemA_1Level/grid4.eps}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.45\textwidth]{ProblemA_1Level/DiscSolution32_L1P1.eps}
\includegraphics[width=0.45\textwidth]{ProblemA_1Level/DiscError32_L1P1.eps}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.45\textwidth]{ProblemA_1Level/DiscSolution64_L1P1.eps}
\includegraphics[width=0.45\textwidth]{ProblemA_1Level/DiscError64_L1P1.eps}
\end{center}
\caption{Left: discrete solution $u^h$ at level 1, patch 1, for
...
\input ProblemA_1Level/DiscErrorL1P1
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.45\textwidth]{ProblemA_1Level/TruncError8_L1P1.eps}
\includegraphics[width=0.45\textwidth]{ProblemA_1Level/TruncError16_L1P1.eps}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.45\textwidth]{ProblemA_1Level/TruncError32_L1P1.eps}
\includegraphics[width=0.45\textwidth]{ProblemA_1Level/TruncError64_L1P1.eps}
\end{center}
\caption{Left: truncation error $\tau^h$ at level 1, patch 1. Left:
...
\input ProblemA_1Level/TruncErrorL1P1
