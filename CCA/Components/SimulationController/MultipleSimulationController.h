#ifndef UINTAH_HOMEBREW_MULTIPLESIMULATIONCONTROLLER_H
#define UINTAH_HOMEBREW_MULTIPLESIMULATIONCONTROLLER_H
...
****************************************/
   //! Controls the execution of multiple components simulation.    
   class MultipleSimulationController : public SimulationController {
   public:
      MultipleSimulationController(const ProcessorGroup* myworld);
      virtual ~MultipleSimulationController();
   ...
   private:
      ...
      bool needRecompile(double t, double delt, const GridP& grid,
			 ...
			 LoadBalancer* lb);
      MultipleSimulationController(const MultipleSimulationController&);
      MultipleSimulationController& operator=(const MultipleSimulationController&);
