itcl_class ModelCreation_FieldsData_SelectAndReplaceFieldsData {
   inherit Module

    constructor {config} {
        set name SelectAndReplaceFieldsData
        set_defaults
    }
    ...
    method set_defaults {} {
      ...
      set $this-selection "SELECTION = (DATA < A);"
    ...
    method ui {} {
        ...
        iwidgets::labeledframe $w.ss -labeltext "selection"
        set selection [$w.ss childsite]
        option add *textBackground white	
        iwidgets::scrolledtext $selection.selection -height 40 -hscrollmode dynamic
        $selection.selection insert end [set $this-selection]
        pack $w.ss -side top -anchor w -fill both 
        pack $selection.selection -side top -fill both 
