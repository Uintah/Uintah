...
%begin{latexonly}
  \newcommand{\tstone}%
  {\centerline{\includegraphics[width=4.5in]{figs/tst1.ps}}}
%end{latexonly}
\begin{htmlonly}
  \newcommand{\tstone}{%
...
%begin{latexonly}
  \newcommand{\tsttwo}%
  {\centerline{\includegraphics[width=4.5in]{figs/tst2.ps}}}
%end{latexonly}
\begin{htmlonly}
  \newcommand{\tsttwo}{%
...
%begin{latexonly}
  \newcommand{\tstthree}%
  {\centerline{\includegraphics[width=4.5in]{figs/tst3.ps}}}
%end{latexonly}
\begin{htmlonly}
  \newcommand{\tstthree}{%
