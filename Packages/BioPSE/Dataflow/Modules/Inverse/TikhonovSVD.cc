...
namespace BioPSE 
{
  ...
  class BioPSESHARE TikhonovSVD : public Module 
  {
  	...
  	public:
		...
		void	tikhonov_fun(ColumnMatrix& X_reg, DenseMatrix& U, ColumnMatrix& Uy, DenseMatrix& S, DenseMatrix& V, 
					DenseMatrix& X, double lam);
		void	prep_lcurve_data(double *rho, double *eta, ColumnMatrix& Uy, DenseMatrix& U, 
  ...
  //////////////////////////////////////////////////////////////////////
  void TikhonovSVD::tikhonov_fun(ColumnMatrix& X_reg, DenseMatrix& U, ColumnMatrix& Uy, 
					DenseMatrix& S, DenseMatrix& V, DenseMatrix& X, double lam)
  {
	int i,j;
	int rank=S.nrows();
	double temp;
  ...
  void TikhonovSVD::execute()
  {
	...
	tikhonov_fun(*solution, *matrixU, *Uy, *matrixS, *matrixV, *matrixX, lambda);
