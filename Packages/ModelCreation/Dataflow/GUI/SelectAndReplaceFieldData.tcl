itcl_class ModelCreation_FieldsData_SelectAndReplaceFieldData {
   inherit Module

    constructor {config} {
        set name SelectAndReplaceFieldData
        set_defaults
    }
    ...
    method ui {} {
        ...
        set function [$w.ff childsite]
        option add *textBackground white	
        iwidgets::scrolledtext $function.function -height 40 -hscrollmode dynamic
