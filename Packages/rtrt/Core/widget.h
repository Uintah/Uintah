...
namespace rtrt
{
  ...
  class Widget
    ...
    public:
      ...
      virtual void paintTransFunc( GLfloat texture_dest[textureWidth][textureWidth][4] ) = 0;
  ...
  class RectWidget: public Widget
    ...
    public:
      ...
      virtual void manipulate( float x, float dx, float y, float dy );
      virtual void paintTransFunc( GLfloat texture_dest[textureWidth][textureWidth][4] );
      virtual bool insideWidget( int x, int y );
