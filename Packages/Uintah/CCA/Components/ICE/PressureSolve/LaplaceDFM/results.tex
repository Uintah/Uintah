...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.8\textwidth]{grid4.eps}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=1\textwidth]{grid8.eps}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.45\textwidth]{DiscSolution32_L1P1.eps}
\includegraphics[width=0.45\textwidth]{DiscError32_L1P1.eps}
\end{center}
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.45\textwidth]{DiscSolution64_L1P1.eps}
\includegraphics[width=0.45\textwidth]{DiscError64_L1P1.eps}
\end{center}
\caption{Left: discrete solution $u^h$ at level 1, patch 1, for
