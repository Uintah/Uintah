                        ...
                        double Kmat[24][24]) const
{
  ...
  double t873, t878, t883, t889, t894, t9, t964, t969, t974, t979, t985, t990;
    ...
    Kmat[7][0] = Kmat[0][7];t676*B[0][0]+t681*B[3][0]+t686*B[5][0];
    t691 = B[1][7]*D[1][1]+B[3][7]*D[1][3]+B[4][7]*D[1][4];
    t697 = B[1][7]*D[1][4]+B[3][7]*D[3][4]+B[4][7]*D[4][4];
    Kmat[7][1] = Kmat[1][7];t691*B[1][1]+t681*B[3][1]+t697*B[4][1];
    ...
    Kmat[22][0] = Kmat[0][22];t2116*B[0][0]+t2121*B[3][0]+t2126*B[5][0];
    ...
    Kmat[23][0] = Kmat[0][23];t2212*B[0][0]+t2217*B[3][0]+t2222*B[5][0];
...
void
ConstitutiveModel::BnltDBnl(double Bnl[3][24], 
                            double sig[3][3],
