...
extern "C" void radarray_(int* rgamma_low, int* rgamma_high, double* rgamma_ptr,
...
static void fort_radarray(OffsetArray1<double>& rgamma,
...
OffsetArray1<double>& sd3)
{
  ...
  radarray_(&rgamma_low, &rgamma_high, rgamma.get_objs(),
