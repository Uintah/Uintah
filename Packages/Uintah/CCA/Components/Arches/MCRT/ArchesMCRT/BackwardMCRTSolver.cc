...
inline BackwardMCRTSolver::BackwardMCRTSolver(BoundaryCondition* bndry_cond,
...
inline BackwardMCRTSolver::~BackwardMCRTSolver();



void
BackwardMCRTSolver::problemSetup(const ProblemSpecP& params){
...
void
BackwardMCRTSolver::boundarycondition(const ProcessorGroup* pc,
				      const Patch* patch,
...
void
BackwardMCRTSolver::intensitySolve(const ProcessorGroup* pc,
				   const Patch* patch,
				   CellInformation* cellinfo, 
				   ArchesVariables* vars,
				   ArchesConstVariables* constvars){
...
// Is this function necessary in BackwardMCRTSolver class?
void
BackwardMCRTSolver::initRealSurfOutInten(){
