...
StructHexVolField<Tensor>::query_tensor_interface() const
{
  return scinew TFInterface<StructHexVolField<Tensor> >(this);
}


template <>
VectorFieldInterface *
StructHexVolField<Vector>::query_vector_interface() const
{
  return scinew VFInterface<StructHexVolField<Vector> >(this);
}


template <>
ScalarFieldInterface *
StructHexVolField<double>::query_scalar_interface() const
{
  return scinew SFInterface<StructHexVolField<double> >(this);
}

template <>
ScalarFieldInterface *
StructHexVolField<float>::query_scalar_interface() const
{
  return scinew SFInterface<StructHexVolField<float> >(this);
}

template <>
ScalarFieldInterface *
StructHexVolField<int>::query_scalar_interface() const
{
  return scinew SFInterface<StructHexVolField<int> >(this);
}

template <>
ScalarFieldInterface *
StructHexVolField<short>::query_scalar_interface() const
{
  return scinew SFInterface<StructHexVolField<short> >(this);
}

template <>
ScalarFieldInterface *
StructHexVolField<char>::query_scalar_interface() const
{
  return scinew SFInterface<StructHexVolField<char> >(this);
}

template <>
ScalarFieldInterface *
StructHexVolField<unsigned int>::query_scalar_interface() const
{
  return scinew SFInterface<StructHexVolField<unsigned int> >(this);
}

template <>
ScalarFieldInterface *
StructHexVolField<unsigned short>::query_scalar_interface() const
{
  return scinew SFInterface<StructHexVolField<unsigned short> >(this);
}

template <>
ScalarFieldInterface *
StructHexVolField<unsigned char>::query_scalar_interface() const
{
  return scinew SFInterface<StructHexVolField<unsigned char> >(this);
}
