...
template void Pio(Piostream&, Point&);
...
static void _dummy_(Piostream& p1, Array3<int>& p2)
{
    Pio(p1, p2);
}

static void _dummy2_(Piostream& p1, Point& p2)
{
    Pio(p1, p2);
}

static void _dummy3_(Piostream& p1, Array1<Point>& p2)
{
    Pio(p1, p2);
}
