...
/*
 *  ScalarFieldRGushort.h: ushort Scalar Fields defined on a Regular grid
 *
 *  Written by:
...
#ifndef SCI_project_ScalarFieldRGushort_h
#define SCI_project_ScalarFieldRGushort_h 1
...
class SCICORESHARE ScalarFieldRGushort : public ScalarFieldRGBase {
public:
    Array3<ushort> grid;

    void resize(int, int, int);
    ScalarFieldRGushort();
    ScalarFieldRGushort(const ScalarFieldRGushort&);
    virtual ~ScalarFieldRGushort();
...
inline
double
ScalarFieldRGushort::get_value( const Point& ivoxel )
{
...
inline
double
ScalarFieldRGushort::get_value( int x, int y, int z )
{
  return grid( x, y, z );
}
...
//
// $Log$
// Revision 1.1  2000/07/12 15:45:09  dmw
