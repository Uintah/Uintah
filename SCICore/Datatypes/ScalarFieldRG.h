...
/*
 *  ScalarFieldRG.h: double Scalar Fields defined on a Regular grid
 *
 *  Written by:
...
class SCICORESHARE ScalarFieldRG : public ScalarFieldRGBase {
public:
    Array3<double> grid;
...
inline
double
ScalarFieldRG::get_value( const Point& ivoxel )
{
...
inline
double
ScalarFieldRG::get_value( int x, int y, int z )
{
  return grid( x, y, z );
}
