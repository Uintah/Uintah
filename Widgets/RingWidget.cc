...
enum { RingW_ConstULDR, RingW_ConstURDL, RingW_ConstHypo, RingW_ConstPlane,
       ...
       RingW_ConstSDist, RingW_ConstCDist, RingW_ConstMidpoint };
enum { RingW_SphereUL, RingW_SphereUR, RingW_SphereDR, RingW_SphereDL,
       RingW_SliderCyl, RingW_Ring };
...
: BaseWidget(module, lock, NumVars, NumCons, NumGeoms, NumMatls, NumPcks, widget_scale*0.1)
{
   ...
   constraints[RingW_ConstCDist] = new DistanceConstraint("ConstCDist",
							  ...
							  variables[RingW_Center],
							  variables[RingW_SDist]);
   constraints[RingW_ConstCDist]->VarChoices(Scheme1, 1, 1, 1);
   constraints[RingW_ConstCDist]->VarChoices(Scheme2, 1, 1, 1);
   constraints[RingW_ConstCDist]->VarChoices(Scheme3, 2, 2, 2);
   constraints[RingW_ConstCDist]->Priorities(P_Lowest, P_Default, P_Default);
   constraints[RingW_ConstMidpoint] = new DistanceConstraint("ConstMidpoint",
							     NumSchemes,
							     variables[RingW_PointUL],
   ...
   constraints[RingW_ConstMidpoint]->Priorities(P_Lowest, P_Default, P_Default);
   ...
   picks[RingW_PickCyls] = new GeomPick(geometries[RingW_Ring], module);
...
RingWidget::widget_execute()
{
   ...
   Vector slide(Cross(normal,variables[RingW_Slider]->Get()-cen));
