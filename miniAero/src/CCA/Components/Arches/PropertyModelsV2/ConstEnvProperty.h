#ifndef Uintah_Component_Arches_ConstEnvProperty_h
#define Uintah_Component_Arches_ConstEnvProperty_h
...
namespace Uintah{ 
  ...
  class Operators; 
  class ConstEnvProperty : public TaskInterface { 

public: 

    ConstEnvProperty( std::string task_name, int matl_index ); 
    ~ConstEnvProperty(); 
    ...
    //Build instructions for this (ConstEnvProperty) class. 
    class Builder : public TaskInterface::TaskBuilder { 
      ...
      ConstEnvProperty* build()
      { return scinew ConstEnvProperty( _task_name, _matl_index ); }
