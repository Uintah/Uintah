...
#ifndef fspec_mm_explicit_oldvalue
#define fspec_mm_explicit_oldvalue

#ifdef __cplusplus

extern "C" void mm_explicit_oldvalue_(int* idxLo,
                                      int* idxHi,
...
static void fort_mm_explicit_oldvalue( Uintah::IntVector & idxLo,
                                       Uintah::IntVector & idxHi,
                                       Uintah::CCVariable<double> & phi,
                                       Uintah::constCCVariable<double> & old_phi,
                                       Uintah::constCCVariable<double> & ae,
                                       Uintah::constCCVariable<double> & aw,
                                       Uintah::constCCVariable<double> & an,
                                       Uintah::constCCVariable<double> & as,
                                       Uintah::constCCVariable<double> & at,
                                       Uintah::constCCVariable<double> & ab,
                                       Uintah::constCCVariable<double> & ap,
                                       Uintah::constCCVariable<double> & su,
                                       ...
                                       int & mmwallid )
{
  ...
  mm_explicit_oldvalue_( idxLo.get_pointer(),
                         idxHi.get_pointer(),
                         ...
                         &ae_low_x, &ae_low_y, &ae_low_z, &ae_high_x, &ae_high_y, &ae_high_z, const_cast<double*>(ae.getPointer()),
                         &aw_low_x, &aw_low_y, &aw_low_z, &aw_high_x, &aw_high_y, &aw_high_z, const_cast<double*>(aw.getPointer()),
                         &an_low_x, &an_low_y, &an_low_z, &an_high_x, &an_high_y, &an_high_z, const_cast<double*>(an.getPointer()),
                         &as_low_x, &as_low_y, &as_low_z, &as_high_x, &as_high_y, &as_high_z, const_cast<double*>(as.getPointer()),
                         &at_low_x, &at_low_y, &at_low_z, &at_high_x, &at_high_y, &at_high_z, const_cast<double*>(at.getPointer()),
                         &ab_low_x, &ab_low_y, &ab_low_z, &ab_high_x, &ab_high_y, &ab_high_z, const_cast<double*>(ab.getPointer()),
                         &ap_low_x, &ap_low_y, &ap_low_z, &ap_high_x, &ap_high_y, &ap_high_z, const_cast<double*>(ap.getPointer()),
                         &su_low_x, &su_low_y, &su_low_z, &su_high_x, &su_high_y, &su_high_z, const_cast<double*>(su.getPointer()),
...
C This is the FORTRAN code portion of the file:
      ...
      subroutine mm_explicit_oldvalue(idxLo, idxHi, phi_low_x, 
     & phi_low_y, phi_low_z, phi_high_x, phi_high_y, phi_high_z, phi, 
     ...
     &  sns_low, sns_high, sns, stb_low, stb_high, stb, dtime, 
...
#endif /* fspec_mm_explicit_oldvalue */
