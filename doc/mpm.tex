...
\begin{Verbatim}[fontsize=\footnotesize]
    <MPM>
     <!-- These are commonly used options -->
      <artificial\_damping\_coeff           spec="OPTIONAL DOUBLE 'positive'"/>
...
\begin{description}
\item[Compressible Neo-Hookean Models] There are a number of implementations
...
given.  These models are very robust, and as hyperelastic models don't
...
\item[Compressible Mooney-Rivlin Model] This model is generally parameterized
...
\item[Kayenta] This is the model formerly known as the Sandia Geomodel.  Use
...
\item[Water]  This is a model for water, reported in \cite{water_model_ref}.
...
\item[Ideal Gas]  This is simply an equation of state, with no shear stress.
Usage is given by:
...
\item[ElasticPlastic] Description forthcoming.
