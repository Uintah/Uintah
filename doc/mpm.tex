...
\begin{figure}[p]
  \center
  \scalebox{0.2}{\includegraphics{incplane_mu_495.png}}
...
\begin{figure}[p]
  \center
  \scalebox{0.2}{\includegraphics{incplane_mu_0.png}}
  \caption{Sphere rolling down an ``inclined" plane.  The gravity vector
is oriented at a 45 degree angle relative to the plane.  Particles are colored
...
\begin{figure}[p]
  \center
  \scalebox{0.2}{\includegraphics{foam_part.png}}
...
\begin{figure}[p]
  \center
  \scalebox{0.2}{\includegraphics{holeInPlate.png}}
