       ...
       */
       ...
       function HM_f_ItemSetup() {
           ...
           if(this.hasMore && HM_CurrentMenu.showImage) {
               ...
               with(this.imgLyr) {
                   document.write("<IMG SRC='" + (HM_RightToLeft ? HM_ImageSrcLeft : HM_ImageSrc) + "' WIDTH=" + HM_ImageSize + " VSPACE=0 HSPACE=0 BORDER=0>");
                   document.close();
