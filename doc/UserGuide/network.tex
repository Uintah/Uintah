...
\begin{figure}[htb]
  ...
  \end{makeimage}
  \moddialog
%  \centerline{\epsfig{file=figures/moddialog.eps,width=6in}}
%    \framebox{\parbox[3in]{\columnwidth}{The\dotfill Figure\\
%    \vspace{2in}\\
%    With some \dotfill dummy text}}
...
\sr{}'s \dfn{scheduler}.  The scheduler knows when modules need to be
...
of a module by selecting the \menuitem{Execute} item from a module's popup
menu.
