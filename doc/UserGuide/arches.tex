...
%Figure \ref{fig:staggered_grid} shows an example of a two-dimensional grid and the staggering arrangement.
%
%% Staggered Grid
%\begin{figure}
 % \begin{center}
%    \scalebox{.85}{\includegraphics{figs/LES_pool_fire/staggered_grid.png}}
...
%
%Jennifer edited
%Jeremy: removed and moved "however"
