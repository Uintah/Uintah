...
Intermediate $B$, in the presence of any gas phase collision partner $M$, reacts in a highly exothermic fashion producing a bimolecular flame based on the assumption that $E_g=0$ for gas $B$, such that:
