...
%begin{latexonly}
  ...
  {\centerline{\epsfig{file=figures/widget-gauge.eps,height=4in,
...
%begin{latexonly}
  ...
  {\centerline{\epsfig{file=figures/widget-frame.eps,height=4in,
...
%begin{latexonly}
  \newcommand{\boxwidget}%
  {\centerline{\epsfig{file=figures/widget-box.eps,height=4in,
...
\paragraph{Appearance: } The Box Widget consists of twelve cylinders
