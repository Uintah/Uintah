...
\begin{htmlonly}
  \newcommand{\viewerwindow}{%
  \htmladdimg[align=top,width=600,alt="module"]
...
\begin{htmlonly}
  \newcommand{\extendedwindow}{%
  \htmladdimg[align=top,width=600,alt="extended view window"]
...
%begin{latexonly}
  ...
  {\centerline{\epsfig{file=figures/widget-gauge.eps.gz,height=4in,
  bbllx=0, bblly=0, bburx=457, bbury=340}}}
%end{latexonly}
\begin{htmlonly}
  \newcommand{\gaugewidget}{%
  \htmladdimg[align=top,width=457,alt="gaugewidget"]
...
%begin{latexonly}
  ...
  {\centerline{\epsfig{file=figures/widget-frame.eps.gz,height=4in,
  bbllx=0, bblly=0, bburx=328, bbury=268}}}
%end{latexonly}
\begin{htmlonly}
  \newcommand{\framewidget}{%
  \htmladdimg[align=top,width=328,alt="framewidget"]
...
%begin{latexonly}
  \newcommand{\boxwidget}%
  {\centerline{\epsfig{file=figures/widget-box.eps.gz,height=4in,
  bbllx=0, bblly=0, bburx=458, bbury=342}}}
%end{latexonly}
\begin{htmlonly}
  \newcommand{\boxwidget}{%
  \htmladdimg[align=top,width=458,alt="boxwidget"]
...
%begin{latexonly}
  ...
  {\centerline{\epsfig{file=figures/widget-ring.eps.gz,height=4in,
  bbllx=0, bblly=0, bburx=458, bbury=342}}}
%end{latexonly}
\begin{htmlonly}
  \newcommand{\ringwidget}{%
...
\index{\viewer{}!extended controls}
...
\htmladdnormallink{Installation Manual}{http://installation-manual} for
