...
\latexhtml{\srig{}\footnote{On the web see \installdocurl{}.  In the
    distribution see
    \filename{doc/InstallGuide/pseInstall.html}}}{\htmladdnormallink{\etitle{\srig{}}}{\installdocrurl}}
...
\item \secref{Starting \sr}{sec:startingup}  Procedure for starting \sr{}
...
%  and \pse{} packages (which provide nearly all of \sr{}'s computational
%  services). 
\end{description}
