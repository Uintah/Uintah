...
the \TT{<Scheduler>} section of your input file, or simply add the "\TT{nthreads <n>}" (shown below) to your command to launch the \texttt{sus}
executable.
...
control thread and create 15 \TT{(nthreads -1)} additional task execution threads.
