...
for small runs on a single desktop or laptop. The \TT{SingleProcessorScheduler}
...
the \TT{<Scheduler>} section of your input file. An example command line to
use
...
the \TT{<Scheduler>} section of your input file, with the addition of
...
control thread and 15 \TT{(nthreads -1)} task execution threads.
