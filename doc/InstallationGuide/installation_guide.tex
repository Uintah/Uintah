...
The latest official release of VisIt is 2.0.2.  The VisIt build system
...
For example, the 2.0.2 release for Ubuntu could be installed with:
\begin{verbatim}
chmod +x visit-install
./visit-install 2.0.2 linux-x86_64-ubuntu8 ``visit_bin_dir''
\end{verbatim}

If you are installing version 2.0.2, there was a bug in the release that
hard codes an incorrect path to gcc and g++.  To fix it, open the file:
\begin{verbatim}
emacs ``visit_bin_dir''/2.0.2/``platform''/include/PluginVsInstall.cmake
\end{verbatim}
...
\begin{verbatim}
https://wci.llnl.gov/codes/visit/2.0.2/BUILD_NOTES
\end{verbatim}
