...
\section{Mac OSX Snow Leopard Installation (10.6.3)}
	...
	\subsection{gfortran}
		Install the binary package for gfortran from: \url{http://hpc.sourceforge.net/}. Then, set the path properly. If you are using bash, this is done as:
		\begin{verbatim}
	...
	\subsection{openmpi}
		...
		\begin{verbatim}
			...
			./configure --prefix=/Users/username/uintah/packages/hypre-2.6.0b-install 
												 \--with-MPI-include=/Users/username/uintah/packages/openmpi-1.4.1-install/include 
												 \--with-MPI-lib-dirs=/Users/username/uintah/packages/openmpi-1.4.1-install/lib 
		...
		\subsection{PETSc}
		For the current release of Uintah, Petsc2.3.3 has been found to work well. Download the source from here: \url{http://www.mcs.anl.gov/petsc/petsc-as/download/index.html}.
		Then browse to the packages directory and configure as follows:
		{\small
		\begin{verbatim}
			cd ~/uintah/packages
			tar -xvf petsc-2.2.0b-p15.tar.gz
			cd petsc-2.2.0b-p15
			./config/configure.py \--with-shared \--with-debugging=0 
			\--with-mpi-include=/Users/username/uintah/packages/openmpi-1.4.1-install/include 
			\--with-mpi-lib=/Users/username/uintah/packages/openmpi-1.4.1-install/lib/libmpi.dylib 
			\--without-fortran \--prefix=/Users/username/uintah/packages/petsc-2.3.3-p15-install
		\end{verbatim}}
		Finally,
		{\small
		\begin{verbatim}
			make all test
			make install
			PETSC_DIR=/Users/username/uintah/packages/petsc-2.3.3-p15-install; export PETSC_DIR
		\end{verbatim}}
		...
		\begin{verbatim}
			...
			\--with-teem=/Users/username/uintah/packages/teem-install 
