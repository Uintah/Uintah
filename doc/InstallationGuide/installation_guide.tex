...
supercomputers. The \textbf{\emph{VisIt}} and \textbf{\emph{Teem}}
applications are used to visualize data generated from
\textbf{Uintah}.
...
prior to installation of \textbf{Uintah}.  The configure script used
by \textbf{Uintah} depends on the presence of these libraries.
...
\begin{verbatim}
sudo yum install make openmpi-devel openmpi-libs lapack-devel \
...
\begin{verbatim}
sudo zypper install make openmpi-devel openmpi-libs lapack-devel \
gcc-gfortran blas-devel gcc-c++ libxml2-devel subversion \ 
make tar diffutils libX11-devel libXext-devel patch wget \
mesa-libGL-devel mesa-libGLU-devel libXt-devel 
\end{verbatim} 
...
\begin{verbatim}
sudo yum install make openmpi-devel openmpi-libs lapack \
...
\begin{verbatim}
    ...
    --with-visit=/full_path/visit_bin_dir/  --with-teem='location for
teem'
...
Goto the directory \TT{ \textasciitilde/uintah} and create the following directories:
