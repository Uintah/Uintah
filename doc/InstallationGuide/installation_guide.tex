...
\begin{itemize}
  ...
  \item libhdf5-serial-1.6.6-0 
  \item libhdf5-serial-dev
\end{itemize}
...
\noindent If you are interested in compiling the Wasatch component execute:
\begin{verbatim}
  aptitude install libhdf5-serial-1.6.6-0 
  aptitude install libhdf5-serial-dev
  aptitude install git-core
  aptitude install cmake > 2.8 (from squeeze)

  download boost-1.44 from www.boost.org
  bootstrap.sh --prefix=path/to/installation/prefix
  bjam threading=single install
\end{verbatim}

\noindent Once these libraries are installed, Teem and VisIt can be installed
