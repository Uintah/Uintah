...
\newcommand{\xmlvalidurl}{http://eegah.cvrti.utah.edu/srvalidate.html}
...
\end{verbatim}
  ...
  where \filename{<top-of-cvs-tree>} is the path to the top of your
  SCIRun \cvs{} tree. 
...
\begin{description}
  ...
  \begin{description}
    ...
    \begin{description}
      ...
      \end{description}
      \elementitem{/authors}
      \elementitem{summary} Short (1 or 2 sentence) summary of component's
    ...
    \begin{description}
      \elementitem{ccfile} Names 1 c++ file,
...
\begin{description}
  ...
  \begin{description}
    ...
    version, which can only be used inside the \element{p} element, is
    discussed above
    \elementitem{/latex}%
  \end{description}
  \elementitem{/description} 
...
"<top-of-cvs-tree>/doc/Utilities/XML/component.dtd">
\end{verbatim}
  Replace \screen{<top-of-cvs-tree>} with the path to the top of your
  \sr{} \cvs{} tree.
...
\item Insert the top level \element{component} element using \emacs{}
  ...
  After doing this you will be prompted for the \element{component}
...
\item The \element{gui} element is not automatically inserted by \emacs{} 
  ...
  though so you will probably need to insert the \element{gui}
...
may break \sr{} for yourself and others.  You may wish to use the online \htmladdnormallinkfoot{Validation Tool for SCIRun XML Files}{\xmlvalidurl}.
