...
\item Put your document's figures in the directory created above.  Provide
  figures in 2 formats: JPG or GIF and EPS.
...
Your document must consist of 1 file only. 

Place figures in your document's directory or a sub-directory of your
...
\item[Use] \label{sec:use} \mbox{}
  ...
  \gui{}.  Include at least 1 image (in 2 formats, \acronym{EPS}, and
  \acronym{JPEG} or \acronym{GIF}) of your module's graphical user
...
\latexcommand{ModuleRefCredits}, \latexcommand{ModuleRefSubSection},
