...
\chapter{Starting \sr{} and Power Apps}
\label{ch:startingup}
...
Mac OSX users must increase the limit on the number of open files:

Users of csh-type shells must type:
...
To start a Power App, change your current working directory to \sr{}'s
...
to start the BioTensor application.
