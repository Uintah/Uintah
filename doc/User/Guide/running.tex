...
\begin{description}
  ...
  \begin{description}
    ...
    \begin{description}
      ...
      \menuitemdesc{New} This sub-menu contains items of interest to
      developers only.
      
      \menuitemdesc{Add Info} Use this item to add network specific
  ...
  \begin{description}
    ...
    of the contents of the \biopse{} package is given in \secref{The
  ...
  The use of the Globla View Frame is described in \secref{Navigating
    a Network}{sec:navnetwork}.
...
\end{verbatim}
  ...
  list.  Note that \ptext{build\_dir} is the directory in which the
  \command{configure} and \command{make} commands were run.
