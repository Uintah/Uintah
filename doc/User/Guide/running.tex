...
Typing \keyboard{scirun} with no arguments starts \sr{} with a blank
...
\begin{description}
  ...
  \begin{description}
    ...
    have been installed.  They also have category sub-menus
...
\sr{} loads these packages instead of packages specified at configure time. Each package on the list must have been previously compiled.
  ...
  \command{configure} and \command{make} command are run.
