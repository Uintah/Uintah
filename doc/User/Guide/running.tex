...
Mac OSX users must increase the number of open files limit.
...
%% \section{Starting Power Apps}
%% \label{sec:startpa}

%% To start a Power App for a \sr{} installation from source code, change
%% the working directory to \sr{}'s build directory, for example:

%% \begin{alltt}
%%   cd SCIRun/sgi32
%% \end{alltt}

%% and then type the name of the Power App.  For example:

%% \begin{alltt}
%%   ./BioTensor
%% \end{alltt}

%% For an installation from an RPM, change the working directory to
...
%% and type the name of the Power App, for example:
