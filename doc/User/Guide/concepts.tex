...
\dfn{SCIResorts}.  SCIResorts use \sr{}'s data flow engine for
computation and application specific data flow networks for problem
solving.  However, SCIResorts hide the complexity of the data flow
environment behind a simplified application specific graphical user
interface.

The following SCIResorts are available:

\begin{description}
  \descitem{BioTensor} See the \htmladdnormallinkfoot{BioTensor
    tutorial}{\latexhtml{http://software.sci.utah.edu/doc/User/BioTensorTutorial}{../../BioTensorTutorial}}
