...
A \sr{} field is an object that contains a geometric mesh and a
collection of data values mapped on to that mesh.  Data can be stored
at the nodes, edges, faces, and cells of the mesh.
...
\meshdoc{60}{hexvol}{Hex Vol Mesh}{A Hex Volume mesh is a subdivision of space into hexagonal elements.}
