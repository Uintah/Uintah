...
\begin{description}
  ...
  type data using \sr{}'s converter programs (see \secref{Importing
...
\descitem{\category{DataIO}}

\descitem{\category{Filters}} 

\descitem{\category{NrrdData}} 
...
\begin{description}
\descitem{\category{Readers}} Modules that read MDSplus and HDF5 data.
\end{description}
%%% Local Variables: 
%%% mode: latex
