...
A network is constructed using modules \datatype{FieldReader},
\datatype{ManageFieldData}, and \datatype{MatrixWriter}.  A
\datatype{FieldReader} module reads a file-based field object.
...
object from a (\filename{txt}) data file.
...
import then option \option{-noHeader \ptext{nrows} \ptext{ncols}
...
On import, option \option{-noHeader} passes the number of color map entries
