...
%
\begin{figure}
  \includegraphics[scale=.85]{Poiseuille.png}
...
%
%______________________________________________________________________
\section*{\center Combined Couette-Poiseuille Flow}
\subsection*{\underline{Problem Description}}
...
\item [Postprocessing command:]\hfill \\
\TT{inputs/UintahRelease/ICE/plot\_shockTube\_1L shockTube.uda y}\\
...
\item [Command used to run input file:]\hfill\\ \TT{sus inputs/UintahRelease/ICE/shocktube\_AMR.ups}
\item [Postprocessing command:]\hfill \\
\TT{inputs/UintahRelease/ICE/plot\_shockTube\_AMR shockTube\_AMR.uda y}\\
...
\item [Postprocessing command:]\hfill \\
\TT{inputs/ICE/Scripts/plot\_explosion\_AMR Explosion\_AMR.uda y}\\
...
\end{figure}
\newpage
\section*{\center ANFO Rate Stick}
\subsection*{\underline{Problem Description}}
