...
public:
    ...
    BuildFDMatrix(const BuildFDMatrix&, int deep);
...
BuildFDMatrix::BuildFDMatrix(const BuildFDMatrix& copy, int deep)
: Module(copy, deep)
{
    NOT_FINISHED("BuildFDMatrix::BuildFDMatrix");
}
...
Module* BuildFDMatrix::clone(int deep)
{
    return scinew BuildFDMatrix(*this, deep);
}
