...
itcl_class GenColorMap {
	...
	global $this-gen_rangemap
	set $this-gen_rangemap 0

	$this-c setmap Voltage2
    }
	...
	$colmap.mbar.type.menu add command -label "Voltage2" \
		-command "$this colormapWarning Voltage2"
	...
	$colmap.mbar.type.menu add command -label "Red" \
		-command "$this colormapWarning Red"
