...
public:
    ...
    MeshRefiner(const MeshRefiner&, int deep);
    virtual ~MeshRefiner();
...
MeshRefiner::MeshRefiner(const MeshRefiner& copy, int deep)
: Module(copy, deep)
{
}
...
Module* MeshRefiner::clone(int deep)
{
    return new MeshRefiner(*this, deep);
}
