...
public:
    ...
    SiReInput(const SiReInput&, int deep);
    virtual ~SiReInput();
...
SiReInput::SiReInput(const SiReInput& copy, int deep)
: Module(copy, deep), PFileStr("PFileStr", id, this), 
  ShrinkFactor("ShrinkFactor", id, this), NPasses("NPasses", id, this)

{
    NOT_FINISHED("SiReInput::SiReInput");
}
...
Module* SiReInput::clone(int deep)
{
    return new SiReInput(*this, deep);
}
