...
<Test>
    ...
    <x>FM-5e9_FSTD_2.5</x>
    <replace_values>
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/damage_model/failure_mean :5e9
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/damage_model/failure_std :2.5
    </replace_values>
</Test>
<Test>
    <Title>FM-7.5e9_FSTD_2.5</Title>
    <sus_cmd> nice mpirun -np 16 sus </sus_cmd>
    <postProcess_cmd></postProcess_cmd>
    <x>FM-7.5e9_FSTD_2.5</x>
    <replace_values>
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/damage_model/failure_mean :7.5e9
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/damage_model/failure_std :2.5
    </replace_values>
</Test>
<Test>
    ...
    <replace_values>
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/damage_model/failure_mean :1e10
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/damage_model/failure_std :2.5
    </replace_values>
</Test>
-->
...
<Test>
    <Title>FM-7.5e9_FSTD_10</Title>
    <sus_cmd> nice mpirun -np 16 sus </sus_cmd>
    <postProcess_cmd></postProcess_cmd>
    <x>FM-7.5e9_FSTD_10</x>
    <replace_values>
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/damage_model/failure_mean :7.5e9
         /Uintah_specification/MaterialProperties/MPM/material[@name='cylinder']/damage_model/failure_std :10
    </replace_values>
