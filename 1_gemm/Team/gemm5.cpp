...
#else
	//for gpu
	#define DEFAULT_VECTOR_LENGTH (WARP_SIZE*1)
#endif
...
struct Gemm_Scalar
{
	...
	int mats, N, M, NumTeams, ThreadsPerTeams, NN;
  	...
  	Gemm_Scalar(plain_view a, plain_view b, plain_view c, int NumTeams , int ThreadsPerTeams, int N1, int M1): 
		A(a), B(b), C(c), NumTeams(NumTeams), ThreadsPerTeams(ThreadsPerTeams), N(N1), M(M1/DEFAULT_VECTOR_LENGTH)
	{
		//printf("DEFAULT_VECTOR_LENGTH: %d, M: %d\n", DEFAULT_VECTOR_LENGTH, M);
		mats = M / NumTeams	;	//mat chunks per team
		if(mats==0) mats = 1;	//assign at least 1 matrix
				...
				int ce = cb + TILE;
					...
					for(int m = mb; m < me; m++)	//matrix without subview
					{
						for(int i = rb; i < re; i=i+TILE) 	//NN loop
						{
							...
							Kokkos::parallel_for(Kokkos::ThreadVectorRange(thread, DEFAULT_VECTOR_LENGTH), KOKKOS_LAMBDA (const int& v){

								value_type  c00(0.0), c01(0.0), c02(0.0), c03(0.0), c04(0.0),
										    c10(0.0), c11(0.0), c12(0.0), c13(0.0), c14(0.0),
										    c20(0.0), c21(0.0), c22(0.0), c23(0.0), c24(0.0),
										    c30(0.0), c31(0.0), c32(0.0), c33(0.0), c34(0.0),
										    c40(0.0), c41(0.0), c42(0.0), c43(0.0), c44(0.0);

								value_type  a00(0.0), a01(0.0), a02(0.0), a03(0.0), a04(0.0),
										    a10(0.0), a11(0.0), a12(0.0), a13(0.0), a14(0.0),
										    a20(0.0), a21(0.0), a22(0.0), a23(0.0), a24(0.0),
										    a30(0.0), a31(0.0), a32(0.0), a33(0.0), a34(0.0),
										    a40(0.0), a41(0.0), a42(0.0), a43(0.0), a44(0.0);
								
								value_type  b00(0.0), b01(0.0), b02(0.0), b03(0.0), b04(0.0),
										    b10(0.0), b11(0.0), b12(0.0), b13(0.0), b14(0.0),
										    b20(0.0), b21(0.0), b22(0.0), b23(0.0), b24(0.0),
										    b30(0.0), b31(0.0), b32(0.0), b33(0.0), b34(0.0),
										    b40(0.0), b41(0.0), b42(0.0), b43(0.0), b44(0.0);
								...
								for(int k = 0; k<N ; k=k+TILE) 	
								{
									a00 = A(m, i, k, v); a01 = A(m, i, k+1, v); a02 = A(m, i, k+2, v); a03 = A(m, i, k+3, v); a04 = A(m, i, k+4, v); 
									a10 = A(m, i+1, k, v); a11 = A(m, i+1, k+1, v); a12 = A(m, i+1, k+2, v); a13 = A(m, i+1, k+3, v); a14 = A(m, i+1, k+4, v); 
									a20 = A(m, i+2, k, v); a21 = A(m, i+2, k+1, v); a22 = A(m, i+2, k+2, v); a23 = A(m, i+2, k+3, v); a24 = A(m, i+2, k+4, v); 
									a30 = A(m, i+3, k, v); a31 = A(m, i+3, k+1, v); a32 = A(m, i+3, k+2, v); a33 = A(m, i+3, k+3, v); a34 = A(m, i+3, k+4, v); 
									a40 = A(m, i+4, k, v); a41 = A(m, i+4, k+1, v); a42 = A(m, i+4, k+2, v); a43 = A(m, i+4, k+3, v); a44 = A(m, i+4, k+4, v); 

									b00 = B(m, i, k, v); b01 = B(m, i, k+1, v); b02 = B(m, i, k+2, v); b03 = B(m, i, k+3, v); b04 = B(m, i, k+4, v); 
									b10 = B(m, i+1, k, v); b11 = B(m, i+1, k+1, v); b12 = B(m, i+1, k+2, v); b13 = B(m, i+1, k+3, v); b14 = B(m, i+1, k+4, v); 
									b20 = B(m, i+2, k, v); b21 = B(m, i+2, k+1, v); b22 = B(m, i+2, k+2, v); b23 = B(m, i+2, k+3, v); b24 = B(m, i+2, k+4, v); 
									b30 = B(m, i+3, k, v); b31 = B(m, i+3, k+1, v); b32 = B(m, i+3, k+2, v); b33 = B(m, i+3, k+3, v); b34 = B(m, i+3, k+4, v); 
									b40 = B(m, i+4, k, v); b41 = B(m, i+4, k+1, v); b42 = B(m, i+4, k+2, v); b43 = B(m, i+4, k+3, v); b44 = B(m, i+4, k+4, v); 
								...
								C(m, i, j, v) = c00; C(m, i, j+1, v) = c01; C(m, i, j+2, v) = c02; C(m, i, j+3, v) = c03; C(m, i, j+4, v) = c04;
								C(m, i+1, j, v) = c10; C(m, i+1, j+1, v) = c11; C(m, i+1, j+2, v) = c12; C(m, i+1, j+3, v) = c13; C(m, i+1, j+4, v) = c14;
								C(m, i+2, j, v) = c20; C(m, i+2, j+1, v) = c21; C(m, i+2, j+2, v) = c22; C(m, i+2, j+3, v) = c23; C(m, i+2, j+4, v) = c24;
								C(m, i+3, j, v) = c30; C(m, i+3, j+1, v) = c31; C(m, i+3, j+2, v) = c32; C(m, i+3, j+3, v) = c33; C(m, i+3, j+4, v) = c34;
								C(m, i+4, j, v) = c40; C(m, i+4, j+1, v) = c41; C(m, i+4, j+2, v) = c42; C(m, i+4, j+3, v) = c43; C(m, i+4, j+4, v) = c44;
...
#pragma omp parallel for
		...
		//kernel
		  ...
		  Gemm_Scalar<double> gemm(a_d, b_d, c_d, NumTeams, ThreadsPerTeams, N, M);
