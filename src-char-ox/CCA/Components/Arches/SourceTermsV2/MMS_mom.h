...
//--------------------------------------------------------------------------------------------------
template <typename T>
void MMS_mom<T>::initialize( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject& executionObject ){
...
void MMS_mom<T>::eval( const Patch* patch, ArchesTaskInfoManager* tsk_info, ExecutionObject& executionObject ){
