...
VolumeVisScene::VolumeVisScene(GuiContext* ctx)
  : Module("VolumeVisScene", ctx, Filter, "Scenes", "rtrt"),
    scene_type_gui(get_ctx()->subVar("scene_type_gui")),
    data_file_gui(get_ctx()->subVar("data_file_gui")),
    do_phong_gui(get_ctx()->subVar("do_phong_gui")),
    ncolors_gui(get_ctx()->subVar("ncolors_gui")),
    t_inc_gui(get_ctx()->subVar("t_inc_gui")),
    spec_coeff_gui(get_ctx()->subVar("spec_coeff_gui")),
    ambient_gui(get_ctx()->subVar("ambient_gui")),
    diffuse_gui(get_ctx()->subVar("diffuse_gui")),
    specular_gui(get_ctx()->subVar("specular_gui")),
    val_gui(get_ctx()->subVar("val_gui")),
    override_data_min_gui(get_ctx()->subVar("override_data_min_gui")),
    override_data_max_gui(get_ctx()->subVar("override_data_max_gui")),
    data_min_in_gui(get_ctx()->subVar("data_min_in_gui")),
    data_max_in_gui(get_ctx()->subVar("data_max_in_gui")),
    frame_rate_gui(get_ctx()->subVar("frame_rate_gui")),
    timeobj(0)
{
