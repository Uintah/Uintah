...
ARENASOIL_TEST_LIST = [
  ...
  ARENASOIL_TEST_LIST[10],  # multiaxial strain dry
  ARENASOIL_TEST_LIST[11],  # Boulder clay wet centrifuge def grad
  ]
### --------------------- ###
...
for test_name in ARENASOIL_TEST_LIST:
...
def selectParticles(uda_dir, output_dir, test_name):
  ...
  command = (selectpart_exe + " -mat 0 -box 0 0 0 1 1 1 -timesteplow 0 -timestephigh 0 " + 
             uda_dir)
  print(command)
