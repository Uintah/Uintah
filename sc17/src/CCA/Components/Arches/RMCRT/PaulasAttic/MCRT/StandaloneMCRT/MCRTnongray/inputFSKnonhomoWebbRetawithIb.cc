...
ToArray(gSize, Rkgcold, "RwvnabcsNosorting2.dat"); // get Rwvn -- CDF obtained from planck function weighted
ToArray(gkSize, gkcold, "LBLabsc-wvnm-T1000Trad1000-CO201H2O02CO003.dat"); // get wvnm-abcs

// get data for T=1500 K section
ToArray(gSize, Rkghot, "RwvnabcsNosorting1500K-CO202H2O04CO006.dat"); // get Rwvn -- CDF obtained from planck function weighted
