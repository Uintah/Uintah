...
MultivariateNormalDSimPart::~MultivariateNormalDSimPart()
{
}
  
void
MultivariateNormalDSimPart::compute( vector<double> &theta, 
				     vector<double> &star )
{
  int n = theta.size();
...
double
MultivariateNormalDSimPart::lpr( vector<double> &)
{
  return 0;
}
