...
input or one output port.  File readers are an example of a module with only an output port.
The \htmladdnormallink{\emph{Viewer}}{viewer.html}
...
become a functioning program that do what the network tells it to.
...
\sci{} anticipates users  createing new modules. \sci{} 
