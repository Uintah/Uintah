...
itcl_class Packages/Phil_Tbon_TbonS {
	...
	label $w.title -text "Hybrid TBON/Seed Parameters"
	...
	make_labeled_radio $w.top.radio2 "Brick Size (Data):" {} top \
		$this-databricksize {{"256 (4x4x4)" 256} {"2048 (8x8x8)" 2048} {"4096 (16x16x16)" 4096} {"16384 (16x16x16)" 16384}}
