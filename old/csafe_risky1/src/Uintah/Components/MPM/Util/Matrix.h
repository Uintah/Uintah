...
template<class T> BoundedArray<SCICore::Geometry::Vector> operator * (const Matrix<T> &left,
                                        const BoundedArray<SCICore::Geometry::Vector> &right);
...
//
// Revision 1.7  1999/02/25 18:18:51  jas
// Inlined the matrix * matrix operation.
//
// Revision 1.6  1999/02/25 05:42:27  guilkey
// Inlined several functions to enhance performance.
//
// Revision 1.5  1999/02/19 20:24:18  guilkey
// Added operator to do Matrix * BoundedArray<Vector>
//
// Revision 1.4  1999/02/17 19:29:31  jas
// Added capability of resizing a matrix (bigger or smaller).
//
// Revision 1.3  1999/01/26 00:06:32  campbell
// Added ident capabilities
//
