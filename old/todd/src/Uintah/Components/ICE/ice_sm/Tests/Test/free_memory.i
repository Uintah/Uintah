...
/*  Free the memory                                                         */
/* -----------------------------------------------------------------------  */
   free_darray_3d( uvel_CC_old,            0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
   free_darray_3d( vvel_CC_old,            0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
   free_darray_3d( wvel_CC_old,            0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
   free_darray_3d( vel_difference,         0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
