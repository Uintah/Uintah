...
/**/ uvel_exact     = darray_3d(0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
/**/ vvel_exact     = darray_3d(0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
/**/ rho_exact      = darray_3d(0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
/**/ press_exact    = darray_3d(0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
/**/ Temp_exact     = darray_3d(0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
...
/**/    {
/**/    Solve_Blast_Wave_problem(
/**/                        xLoLimit,       yLoLimit,       zLoLimit,             
/**/                        xHiLimit,       yHiLimit,       zHiLimit,             
/**/                        delX,           delY,           delZ,
/**/                        ignition_pt_xdir,               ignition_pt_ydir,
/**/                        (t),            E,              rho0,           
/**/                        gamma[1],       R[1],
/**/                        uvel_initial,   vvel_initial,
/**/                        rho_initial,    press_initial,  Temp_initial,
/**/                        &blastWave_radius,
/**/                        uvel_exact,     vvel_exact,     
/**/                        rho_exact,      press_exact,    Temp_exact);    
/**/                        
/**/                        BW_radius_cell = ignition_pt_xdir + blastWave_radius/delX;
/**/                    /* fprintf(stderr, "BW_radius Cell %i\n",BW_radius_cell); */
        }
 /*==========TESTING==========`*/   
...
* -----------------------------------------------------------------------  */
    ...
    free_darray_3d( uvel_exact,        0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
    free_darray_3d( vvel_exact,        0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
    free_darray_3d( rho_exact,         0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
    free_darray_3d( press_exact,       0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
    free_darray_3d( Temp_exact,        0, X_MAX_LIM, 0, Y_MAX_LIM, 0, Z_MAX_LIM);
