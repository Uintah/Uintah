...
#define X_MAX_LIM       202              /* Max. array size in the x dir.  xHiLimit + 2 */
#define Y_MAX_LIM       4              /* Max. array size in the y dir.  yHiLimit + 2 */
...
#define GRAPHDESC  "Inviscid Burgers: Initial shock discontinuity"
#define GRAPHDESC2 "CFL = 0.9, 2nd order advection, compatible flux limiter, Single Material"
#define GRAPHDESC3 ""
#define GRAPHDESC4 ""
