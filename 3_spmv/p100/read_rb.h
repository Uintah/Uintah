...
typedef Kokkos::View<value_type*, Kokkos::LayoutRight, Kokkos::Cuda> viewtype;
typedef Kokkos::View<int*, Kokkos::LayoutRight, Kokkos::Cuda> intviewtype;
typedef Kokkos::View<value_type*, Kokkos::LayoutRight, Kokkos::Cuda>::HostMirror viewtype_mirror;
typedef Kokkos::View<int*, Kokkos::LayoutRight, Kokkos::Cuda>::HostMirror intviewtype_mirror;
...
struct spm {
	...
	spm(int num_of_rows, int num_of_cols, int num_of_entries) : m_num_of_rows(num_of_rows), m_num_of_cols(num_of_cols), m_num_of_entries(num_of_entries)
	{
		...
		m_ptr_in_col_id		= Kokkos::create_mirror(m_ptr_in_col_id_gpu);
		m_col_id			= Kokkos::create_mirror(m_col_id_gpu);
		m_csr_data			= Kokkos::create_mirror(m_csr_data_gpu);
	}
