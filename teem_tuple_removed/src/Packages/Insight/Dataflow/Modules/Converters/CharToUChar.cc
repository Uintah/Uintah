...
class PSECORESHARE CharToUChar : public Module {
public:
  // Declare Ports
...
DECLARE_MAKER(CharToUChar)
CharToUChar::CharToUChar(GuiContext* ctx)
  : Module("CharToUChar", ctx, Source, "Converters", "Insight")
{
}

CharToUChar::~CharToUChar(){
}

template<class InputImageType, class OutputImageType>
bool CharToUChar::run( itk::Object *obj_InputImage) 
{
...
template<class InputImageType, class OutputImageType>
bool CharToUChar::run2( itk::Object *obj_InputImage) 
{
  InputImageType *data_InputImage = dynamic_cast<  InputImageType * >(obj_InputImage);
...
void CharToUChar::execute(){
  ...
  if(0) { }
  else if(run< itk::Image<char, 2>, itk::Image<unsigned char, 2> >( data_InputImage )) {} 
  else if(run< itk::Image<char, 3>, itk::Image<unsigned char, 3> >( data_InputImage )) {} 
  else if(run2< itk::Image<itk::Vector<char>, 2>, itk::Image<itk::Vector<unsigned char>, 2> >( data_InputImage )) {} 
  else if(run2< itk::Image<itk::Vector<char>, 3>, itk::Image<itk::Vector<unsigned char>, 3> >( data_InputImage )) {} 
  else {
    // error
...
void CharToUChar::tcl_command(GuiArgs& args, void* userdata)
{
