...
itcl_class Teem_Unu_Unu2op {
	...
	global $this-nrrd_on_left
	set $this-nrrd_on_left 1
    }
	...
	checkbutton $w.f.options.first_nrrd \
	    -text "Use Nrrd as First Input" \
	    -variable $this-nrrd_on_left
	pack $w.f.options.first_nrrd -side top -expand yes -fill x
