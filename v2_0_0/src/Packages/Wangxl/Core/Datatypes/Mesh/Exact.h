#ifndef SCI_Wangxl_Datatypes_Mesh_Exact_h
#define SCI_Wangxl_Datatypes_Mesh_Exact_h
...
REAL insphereexact(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe)
{
  ...
  REAL abdet[1000/*2304*/], cddet[1000/*2304*/], cdedet[1000/*3456*/];
  int ablen, cdlen;
  REAL deter[2000/*5760*/];
  int deterlen;
  int i;
...
REAL insphereadapt(REAL *pa, REAL *pb, REAL *pc, REAL *pd, REAL *pe, REAL permanent)
{
  ...
  double ret = insphereexact(pa, pb, pc, pd, pe);
