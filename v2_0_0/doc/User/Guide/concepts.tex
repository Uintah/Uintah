...
\section{\SR{} Modules and Networks}
...
\chref{Working with Networks}{ch:workwithnets} for more information
...
\section{Inside Tool Kit}

Inside Tool Kit (ITK) is an open source software library for
performing segmentation and registration. 

When ITK is present and SCIRun is appropriately configured, ITK filters
incapulate in SCIRun modules for use in SCIRun networks.

SCIRun incaptulates ITK filters using xml based filter description
files. Users can incapulate additional filters by writing xml
descriptions of the filters.

The process of incapsulating ITK filters and SCIRun modules is
described ????
