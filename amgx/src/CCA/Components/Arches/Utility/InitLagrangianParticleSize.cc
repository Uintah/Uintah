...
//
void 
InitLagrangianParticleSize::register_timestep_init( std::vector<VariableInformation>& variable_registry ){ 
}
...
void 
InitLagrangianParticleSize::register_timestep_eval( std::vector<VariableInformation>& variable_registry, const int time_substep ){ 
}
