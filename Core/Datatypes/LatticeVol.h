...
bool LatticeVol<Data>::get_gradient(Vector &g, Point &p) {
  ...
  double d100=lvd->value(LatVolMesh::cell_index(ix1,iy0,iz0));
  double d010=lvd->value(LatVolMesh::cell_index(ix0,iy1,iz0));
  double d110=lvd->value(LatVolMesh::cell_index(ix1,iy1,iz0));
  double d001=lvd->value(LatVolMesh::cell_index(ix0,iy0,iz1));
  double d101=lvd->value(LatVolMesh::cell_index(ix1,iy0,iz1));
  double d011=lvd->value(LatVolMesh::cell_index(ix0,iy1,iz1));
  double d111=lvd->value(LatVolMesh::cell_index(ix1,iy1,iz1));
