...
/*
 *  ScalarFieldRGint.h: int Scalar Fields defined on a Regular grid
 *
 *  Written by:
...
public:
    ...
    ScalarFieldRGint();
    ScalarFieldRGint(const ScalarFieldRGint&);
    virtual ~ScalarFieldRGint();
...
inline
double
ScalarFieldRGint::get_value( const Point& ivoxel )
{
...
inline
double
ScalarFieldRGint::get_value( int x, int y, int z )
{
  return grid( x, y, z );
}
