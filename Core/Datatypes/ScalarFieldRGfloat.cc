...
#define ScalarFieldRGfloat_VERSION 3
...
int ScalarFieldRGfloat::interpolate(const Point& p, double& value, double eps,
				   double)
{
    using SCICore::Math::Interpolate;
...
//
// replaced ScalarFieldRGxxx with ScalarFieldRGfloat. it also replaces
