...
#include <Packages/Uintah/Core/Variables/ParticleVariableBase.h>
...
#include <Packages/Uintah/Core/Variables/ParticleData.h>
...
#ifdef __PGI
#include <Packages/Uintah/Core/Variables/ParticleVariable_special.cc>
#endif
