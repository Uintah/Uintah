...
/* #define HAVE_LOCKED_STATIC_GLOBALS (1) */
  ...
  static struct pde_LinSolver__epv s_rem_epv__pde_linsolver;
  ...
  static void* remote_pde_LinSolver__cast(
    ...
    const char* name, sidl_BaseInterface* _ex)
  {
    ...
    *_ex = NULL; /* default to no exception */
    ...
    if ((*self->d_epv->f_isType)(self,name, _ex)) {
      ...
      cast =  (*func)(((struct pde_LinSolver__remote*)self->d_data)->d_ih, _ex);
    }
  ...
  static void remote_pde_LinSolver__delete(
    struct pde_LinSolver__object* self,
  ...
  static void remote_pde_LinSolver__raddRef(
    struct pde_LinSolver__object* self,struct sidl_BaseInterface__object* *_ex)
  {
  ...
  static sidl_bool
  remote_pde_LinSolver__isRemote(
      struct pde_LinSolver__object* self, 
      struct sidl_BaseInterface__object* *_ex) {
    *_ex = NULL;
    return TRUE;
  ...
  static void
  remote_pde_LinSolver__set_hooks(
    ...
    *_ex = NULL;
    {
      ...
      "Exception unserialized from pde.LinSolver._set_hooks.",
          &throwaway_exception);
  ...
  static void
  remote_pde_LinSolver__set_contracts(
    /* in */ struct pde_LinSolver__object*self ,
    /* in */ sidl_bool enable,
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.LinSolver._set_contracts.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static void
  remote_pde_LinSolver__dump_stats(
    /* in */ struct pde_LinSolver__object*self ,
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.LinSolver._dump_stats.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static void remote_pde_LinSolver__exec(
    struct pde_LinSolver__object* self,const char* methodName,
    ...
    /* out */ struct sidl_BaseInterface__object **_ex)
  {
    ...
    *_ex = NULL;
    {
      struct pde_LinSolver__remote* r_obj = (struct 
        pde_LinSolver__remote*)self->d_data;
      LOCK_STATIC_GLOBALS;
      r_obj->d_refcount++;
#ifdef SIDL_DEBUG_REFCOUNT
      fprintf(stderr, "babel: addRef %p new count %d (type %s)\n",
        r_obj, r_obj->d_refcount, 
        "pde.LinSolver Remote Stub");
  ...
  static void
  remote_pde_LinSolver_deleteRef(
    /* in */ struct pde_LinSolver__object*self ,
    /* out */ struct sidl_BaseInterface__object **_ex)
  {
    LANG_SPECIFIC_INIT();
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.LinSolver.isSame.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.LinSolver.isType.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  remote_pde_LinSolver_getClassInfo(
    /* in */ struct pde_LinSolver__object*self ,
    /* out */ struct sidl_BaseInterface__object **_ex)
  {
    LANG_SPECIFIC_INIT();
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.LinSolver.getClassInfo.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.LinSolver.jacobi.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static void
  remote_pde_LinSolver_setServices(
    /* in */ struct pde_LinSolver__object*self ,
    ...
    *_ex = NULL;
    {
      ...
      if (_be != NULL) {
        struct sidl_BaseInterface__object* throwaway_exception = NULL;
        sidl_BaseException_addLine(_be, 
      "Exception unserialized from pde.LinSolver.setServices.",
          &throwaway_exception);
        *_ex = (struct sidl_BaseInterface__object*) sidl_BaseInterface__cast(
          _be,&throwaway_exception);
        goto EXIT;
  ...
  static void pde_LinSolver__init_remote_epv(void)
  {
    // assert( HAVE_LOCKED_STATIC_GLOBALS );
    struct pde_LinSolver__epv*          epv = &s_rem_epv__pde_linsolver;
    struct gov_cca_Component__epv*      e0  = &s_rem_epv__gov_cca_component;
    struct gov_cca_Port__epv*           e1  = &s_rem_epv__gov_cca_port;
    struct pdeports_LinSolverPort__epv* e2  = 
    ...
    epv->f__cast               = remote_pde_LinSolver__cast;
    epv->f__delete             = remote_pde_LinSolver__delete;
    epv->f__exec               = remote_pde_LinSolver__exec;
    epv->f__getURL             = remote_pde_LinSolver__getURL;
    epv->f__raddRef            = remote_pde_LinSolver__raddRef;
    epv->f__isRemote           = remote_pde_LinSolver__isRemote;
    epv->f__set_hooks          = remote_pde_LinSolver__set_hooks;
    epv->f__set_contracts      = remote_pde_LinSolver__set_contracts;
    epv->f__dump_stats         = remote_pde_LinSolver__dump_stats;
    epv->f__ctor               = NULL;
    epv->f__ctor2              = NULL;
    epv->f__dtor               = NULL;
    epv->f_addRef              = remote_pde_LinSolver_addRef;
    epv->f_deleteRef           = remote_pde_LinSolver_deleteRef;
    epv->f_isSame              = remote_pde_LinSolver_isSame;
    epv->f_isType              = remote_pde_LinSolver_isType;
    epv->f_getClassInfo        = remote_pde_LinSolver_getClassInfo;
    epv->f_jacobi              = remote_pde_LinSolver_jacobi;
    epv->f_setServices         = remote_pde_LinSolver_setServices;
    ...
    e2->f__exec          = (void (*)(void*,const char*,struct 
      sidl_rmi_Call__object*,struct sidl_rmi_Return__object*,struct 
      sidl_BaseInterface__object **)) epv->f__exec;
    e2->f_jacobi         = (int32_t (*)(void*,struct sidl_double__array*,struct 
  ...
  static struct pde_LinSolver__object*
  pde_LinSolver__remoteConnect(const char *url, sidl_bool ar, struct 
    sidl_BaseInterface__object* *_ex)
  {
    struct pde_LinSolver__object* self = NULL;

    struct pde_LinSolver__object* s0;
    struct sidl_BaseClass__object* s1;

    struct pde_LinSolver__remote* r_obj = NULL;
    ...
    *_ex = NULL;
    ...
    if(objectID) {
      struct pde_LinSolver__object* retobj = NULL;
      struct sidl_BaseInterface__object *throwaway_exception;
      sidl_BaseInterface bi = (
        sidl_BaseInterface)sidl_rmi_InstanceRegistry_getInstanceByString(
        objectID, _ex); SIDL_CHECK(*_ex);
      (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
      retobj = (struct pde_LinSolver__object*) (*bi->d_epv->f__cast)(
        bi->d_object, "pde.LinSolver", _ex);
      if(!ar) { 
        (*bi->d_epv->f_deleteRef)(bi->d_object, &throwaway_exception);
      }
      return retobj;
    }
    instance = sidl_rmi_ProtocolFactory_connectInstance(url, "pde.LinSolver", 
      ar, _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct pde_LinSolver__object*) malloc(
        sizeof(struct pde_LinSolver__object));

    r_obj =
      (struct pde_LinSolver__remote*) malloc(
        sizeof(struct pde_LinSolver__remote));
    ...
    if(!self || !r_obj) {
      ...
      sidl_MemAllocException_add(ex, __FILE__, __LINE__, 
        "pde.LinSolver.EPVgeneration", _ex);
      SIDL_CHECK(*_ex);
    ...
    if (!s_remote_initialized) {
      pde_LinSolver__init_remote_epv();
    }
    UNLOCK_STATIC_GLOBALS;
    ...
    s0->d_epv  = &s_rem_epv__pde_linsolver;
  ...
  static struct pde_LinSolver__object*
  pde_LinSolver__IHConnect(sidl_rmi_InstanceHandle instance, struct 
    sidl_BaseInterface__object* *_ex)
  {
    struct pde_LinSolver__object* self = NULL;
  ...
  static struct pde_LinSolver__object*
  pde_LinSolver__remoteCreate(const char *url, struct 
    sidl_BaseInterface__object **_ex)
  {
    ...
    sidl_rmi_InstanceHandle instance = sidl_rmi_ProtocolFactory_createInstance(
      url, "pde.LinSolver", _ex ); SIDL_CHECK(*_ex);
    if ( instance == NULL) { return NULL; }
    self =
      (struct pde_LinSolver__object*) malloc(
        sizeof(struct pde_LinSolver__object));
  ...
  pde_LinSolver__connectI(const char* url, sidl_bool ar, struct 
    sidl_BaseInterface__object **_ex)
  {
    return pde_LinSolver__remoteConnect(url, ar, _ex);
  }
 ...
 */
int32_t
pde::LinSolver::jacobi( /* in array<double,2> */const ::sidl::array<double>& A, 
  /* in array<double> */const ::sidl::array<double>& b, /* out array<double> 
  */::sidl::array<double>& x )

{
  int32_t _result;
  ior_t* const loc_self = (struct pde_LinSolver__object*) 
    ::pde::LinSolver::_get_ior();
  struct sidl_double__array* _local_x;
  sidl_BaseInterface__object * _exception;
  /*pack args to dispatch to ior*/
  _result = (*(loc_self->d_epv->f_jacobi))(loc_self, /* in array<double,2> */ 
    A._get_ior(), /* in array<double> */ b._get_ior(), /* out array<double> */ 
    &_local_x, &_exception );
  /*dispatch to ior*/
  if (_exception != NULL ) {
 ...
 */
void
pde::LinSolver::setServices( /* in */const ::gov::cca::Services& services )
// throws:
//   ::gov::cca::CCAException
//   ::sidl::RuntimeException
...
// static constructor
::pde::LinSolver
pde::LinSolver::_create() {
  struct sidl_BaseInterface__object * _exception = NULL;
  ::pde::LinSolver self( (*_get_ext()->createObject)(NULL, &_exception), false 
    );
  if (_exception != NULL) {
    throwException0("::pde::LinSolver"
...
::pde::LinSolver::ior_t*
pde::LinSolver::_wrapObj(void* private_data) {
  struct sidl_BaseInterface__object *_exception = NULL;
  ::pde::LinSolver::ior_t* returnValue = (*_get_ext()->createObject)(
    private_data ,&_exception);
  if (_exception) {
    throwException0("::pde::LinSolver._wrap", _exception);
  }
  return returnValue;
}
...
// remote constructor
::pde::LinSolver
pde::LinSolver::_create(const std::string& url) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception = NULL;
  ior_self = pde_LinSolver__remoteCreate( url.c_str(), &_exception );
  if (_exception != NULL ) {
    throwException0("::pde::LinSolver remoteCreate", _exception);
  }
  return ::pde::LinSolver( ior_self, false );
}

// remote connector
::pde::LinSolver
pde::LinSolver::_connect(const std::string& url, const bool ar ) {
  ior_t* ior_self;
  struct sidl_BaseInterface__object *_exception = NULL;
  ior_self = pde_LinSolver__remoteConnect( url.c_str(), ar?TRUE:FALSE, 
    &_exception );
  if (_exception != NULL ) {
    throwException0("::pde::LinSolver connect",_exception);
  }
  return ::pde::LinSolver( ior_self, false );
}

// copy constructor
pde::LinSolver::LinSolver ( const ::pde::LinSolver& original ) {
  _set_ior((struct pde_LinSolver__object*) original.::pde::LinSolver::_get_ior(
    ));
  if(d_self) {
    addRef();
  }
...
// assignment operator
::pde::LinSolver&
pde::LinSolver::operator=( const ::pde::LinSolver& rhs ) {
  if ( d_self != rhs.d_self ) {
    if ( d_self != 0 ) {
      deleteRef();
    }
    _set_ior((struct pde_LinSolver__object*) rhs.::pde::LinSolver::_get_ior());
    if(d_self) {
      addRef();
    }
    d_weak_reference = false;
...
pde::LinSolver::LinSolver ( ::pde::LinSolver::ior_t* ior ) : 
  ...
  ::pdeports::LinSolverPort((ior==NULL) ? NULL : &((
    *ior).d_pdeports_linsolverport)) {}

// Alternate constructor: does not call addRef()
// (sets d_weak_reference=isWeak)
// For internal use by Impls (fixes bug#275)
pde::LinSolver::LinSolver ( ::pde::LinSolver::ior_t* ior, bool isWeak ) : 
...
int ::pde::LinSolver::_set_ior_typesafe( struct sidl_BaseInterface__object *obj,
...
void ::pde::LinSolver::_exec( const std::string& methodName, 
                        sidl::rmi::Call& inArgs,
                        sidl::rmi::Return& outArgs) { 
  ::pde::LinSolver::ior_t* const loc_self = _get_ior();
  struct sidl_BaseInterface__object *throwaway_exception;
 ...
 */
void
pde::LinSolver::_set_hooks( /* in */bool enable )
// throws:
//   ::sidl::RuntimeException
 ...
 */
void
pde::LinSolver::_set_contracts( /* in */bool enable, /* in */const 
 ...
 */
void
pde::LinSolver::_dump_stats( /* in */const ::std::string& filename, /* in 
...
struct pde_LinSolver__object* pde::LinSolver::_cast(const void* src)
{
  ...
  if(!connect_loaded) {
    struct sidl_BaseInterface__object *throwaway_exception;
    sidl_rmi_ConnectRegistry_registerConnect("pde.LinSolver", (
      void*)pde_LinSolver__IHConnect, &throwaway_exception);
    connect_loaded = 1;
  }
  if ( src != 0 ) {
    ...
    cast = reinterpret_cast< ior_t*>((*base->d_epv->f__cast)(base->d_object, 
      "pde.LinSolver", &throwaway_exception));
  }
  return cast;
}

// Static data type
const ::pde::LinSolver::ext_t * pde::LinSolver::s_ext = 0;

// private static method to get static data type
const ::pde::LinSolver::ext_t *
pde::LinSolver::_get_ext()
  throw ( ::sidl::NullIORException)
{
  if (! s_ext ) {
#ifdef SIDL_STATIC_LIBRARY
    s_ext = pde_LinSolver__externals();
#else
    s_ext = (struct pde_LinSolver__external*)sidl_dynamicLoadIOR(
      "pde.LinSolver","pde_LinSolver__externals") ;
#endif
    sidl_checkIORVersion("pde.LinSolver", s_ext->d_ior_major_version, 
