...
#define included_pde_PDEreader_IOR_h
...
#include "pdeports_PDEdescriptionPort_IOR.h"
#endif
...
struct pde_PDEreader__epv {
  /* Implicit builtin methods */
  /* 0 */
  void* (*f__cast)(
    /* in */ struct pde_PDEreader__object* self,
    /* in */ const char* name,
  ...
  int32_t (*f_getPDEdescription)(
    ...
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in pde.PDEreader-v0.1 */
};
...
struct pde_PDEreader__post_epv {
...
struct pde_PDEreader__object {
  ...
  struct pde_PDEreader__epv*                 d_epv;
  struct pde_PDEreader__cstats               d_cstats;
  void*                                      d_data;
};

struct pde_PDEreader__external {
  struct pde_PDEreader__object*
...
extern struct pde_PDEreader__object*
pde_PDEreader__createObject(void* ddata,struct sidl_BaseInterface__object ** 
  _ex);

extern void pde_PDEreader__init(
  struct pde_PDEreader__object* self, void* ddata, struct 
    sidl_BaseInterface__object ** _ex);

extern void pde_PDEreader__getEPVs(
  ...
  struct pdeports_PDEdescriptionPort__epv 
    **s_arg_epv__pdeports_pdedescriptionport,
  struct pdeports_PDEdescriptionPort__epv 
    **s_arg_epv_hooks__pdeports_pdedescriptionport,
  struct pde_PDEreader__epv **s_arg_epv__pde_pdereader,
  struct pde_PDEreader__epv **s_arg_epv_hooks__pde_pdereader);

extern void pde_PDEreader__fini(
  struct pde_PDEreader__object* self, struct sidl_BaseInterface__object ** _ex);

extern void pde_PDEreader__IOR_version(int32_t *major, int32_t *minor);
...
struct sidl_BaseInterface__object* 
  skel_pde_PDEreader_fconnect_sidl_BaseInterface(const char* url, sidl_bool ar, 
  struct sidl_BaseInterface__object * *_ex);
struct pde_PDEreader__remote{
  int d_refcount;
