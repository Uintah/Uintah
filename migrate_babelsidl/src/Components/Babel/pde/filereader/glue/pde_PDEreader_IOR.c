/*
 * File:          pde_PDEreader_IOR.c
 * Symbol:        pde.PDEreader-v0.1
 * Symbol Type:   class
 * Babel Version: 1.4.0 (Revision: 6574 release-1-4-0)
 * Description:   Intermediate Object Representation for pde.PDEreader
 * 
...
#ifdef HAVE_PTHREAD
static struct sidl_recursive_mutex_t pde_PDEreader__mutex= SIDL_RECURSIVE_MUTEX_INITIALIZER;
#define LOCK_STATIC_GLOBALS sidl_recursive_mutex_lock( &pde_PDEreader__mutex )
#define UNLOCK_STATIC_GLOBALS sidl_recursive_mutex_unlock( &pde_PDEreader__mutex )
/* #define HAVE_LOCKED_STATIC_GLOBALS (sidl_recursive_mutex_trylock( &pde_PDEreader__mutex )==EDEADLOCK) */
#else
...
static struct pde_PDEreader__epv s_my_epv__pde_pdereader;

static struct pde_PDEreader__epv s_my_epv_contracts__pde_pdereader;

static struct pde_PDEreader__epv s_my_epv_hooks__pde_pdereader;
...
static struct pdeports_PDEdescriptionPort__epv 
  s_my_epv__pdeports_pdedescriptionport;
static struct pdeports_PDEdescriptionPort__epv 
  s_my_epv_hooks__pdeports_pdedescriptionport;
...
static struct pde_PDEreader__pre_epv s_preEPV;
static struct pde_PDEreader__post_epv s_postEPV;
...
extern void pde_PDEreader__set_epv(
  struct pde_PDEreader__epv* epv,
    struct pde_PDEreader__pre_epv* pre_epv,
    struct pde_PDEreader__post_epv* post_epv);

extern void pde_PDEreader__call_load(void);
#ifdef __cplusplus
}
#endif

static void
pde_PDEreader_addRef__exec(
        struct pde_PDEreader__object* self,
...
pde_PDEreader_isSame__exec(
  ...
  iobj = skel_pde_PDEreader_fconnect_sidl_BaseInterface(iobj_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  iobj_bc = sidl_rmi_InstanceRegistry_getInstanceByString(iobj_str, 
    _ex);SIDL_CHECK(*_ex);
  if(iobj_bc != NULL) {
    iobj= (struct pde_PDEreader__object*) (*iobj_bc->d_epv->f__cast)(iobj_bc, 
      "pde.PDEreader", _ex);
    if(iobj != NULL) {
...
static void
pde_PDEreader_getClassInfo__exec(
        struct pde_PDEreader__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
...
static void
pde_PDEreader_getPDEdescription__exec(
        struct pde_PDEreader__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  /* stack space for arguments */
  struct sidl_double__array* nodes_data = NULL;
  struct sidl_double__array** nodes = &nodes_data;
  struct sidl_int__array* boundaries_data = NULL;
  struct sidl_int__array** boundaries = &boundaries_data;
  struct sidl_int__array* dirichletNodes_data = NULL;
  struct sidl_int__array** dirichletNodes = &dirichletNodes_data;
  struct sidl_double__array* dirichletValues_data = NULL;
  struct sidl_double__array** dirichletValues = &dirichletValues_data;
  int32_t _retval = 0;
  sidl_BaseInterface _throwaway_exception = NULL;
  sidl_BaseInterface _ex3   = NULL;
  sidl_BaseException _SIDLex = NULL;
  ...
  /* make the call */
  _retval = (self->d_epv->f_getPDEdescription)(
    self,
    nodes,
    boundaries,
    dirichletNodes,
  ...
  /* pack out and inout argments */
  sidl_rmi_Return_packDoubleArray( outArgs, "nodes",*nodes,0,0,0, 
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Return_packIntArray( outArgs, "boundaries",*boundaries,0,0,0, 
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Return_packIntArray( outArgs, "dirichletNodes",*dirichletNodes,0,0,0,
    _ex);SIDL_CHECK(*_ex);
  sidl_rmi_Return_packDoubleArray( outArgs, "dirichletValues",*dirichletValues,
    0,0,0, _ex);SIDL_CHECK(*_ex);
  EXIT:
  /* clean-up dangling references */
  sidl__array_deleteRef((struct sidl__array*)*nodes);
  sidl__array_deleteRef((struct sidl__array*)*boundaries);
...
static void
pde_PDEreader_setServices__exec(
        struct pde_PDEreader__object* self,
        struct sidl_rmi_Call__object* inArgs,
        struct sidl_rmi_Return__object* outArgs,
        struct sidl_BaseInterface__object ** _ex) {
  ...
  services = skel_pde_PDEreader_fconnect_gov_cca_Services(services_str, TRUE, 
    _ex);SIDL_CHECK(*_ex);
#else
  services_bc = sidl_rmi_InstanceRegistry_getInstanceByString(services_str, 
    _ex);SIDL_CHECK(*_ex);
  if(services_bc != NULL) {
    services= (struct pde_PDEreader__object*) (*services_bc->d_epv->f__cast)(
      services_bc, "pde.PDEreader", _ex);
    if(services != NULL) {
...
static void ior_pde_PDEreader__set_contracts(
  struct pde_PDEreader__object* self,
  sidl_bool   enable,
...
static void ior_pde_PDEreader__dump_stats(
  struct pde_PDEreader__object* self,
  const char* filename,
  const char* prefix,
  struct sidl_BaseInterface__object **_ex)
...
static void ior_pde_PDEreader__ensure_load_called(void) {
  /*
  ...
  if (! s_load_called ) {
    s_load_called=1;
    pde_PDEreader__call_load();
  }
}

/* CAST: dynamic type casting support. */
static void* ior_pde_PDEreader__cast(
  struct pde_PDEreader__object* self,
  const char* name, sidl_BaseInterface* _ex)
{
  ...
  *_ex = NULL; /* default to no exception */
  cmp = strcmp(name, "pdeports.PDEdescriptionPort");
  if (!cmp) {
    (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
    cast = &((*self).d_pdeports_pdedescriptionport);
    return cast;
  }
  else if (cmp < 0) {
    ...
    if (!cmp) {
      ...
      cmp = strcmp(name, "pde.PDEreader");
      if (!cmp) {
        (*self->d_epv->f_addRef)(self, _ex); SIDL_CHECK(*_ex);
        cast = ((struct pde_PDEreader__object*)self);
        return cast;
      }
    }
  }
...
static void ior_pde_PDEreader__set_hooks(
  struct pde_PDEreader__object* self,
...
static void ior_pde_PDEreader__delete(
  struct pde_PDEreader__object* self, struct sidl_BaseInterface__object **_ex)
{
  *_ex  = NULL; /* default to no exception */
  pde_PDEreader__fini(self, _ex);
  memset((void*)self, 0, sizeof(struct pde_PDEreader__object));
  free((void*) self);
}

static char*
ior_pde_PDEreader__getURL(
  struct pde_PDEreader__object* self,
  struct sidl_BaseInterface__object **_ex)
{
  char* ret  = NULL;
...
static void
ior_pde_PDEreader__raddRef(
    struct pde_PDEreader__object* self, sidl_BaseInterface* _ex) {
  sidl_BaseInterface_addRef((sidl_BaseInterface)self, _ex);
}

static sidl_bool
ior_pde_PDEreader__isRemote(
    struct pde_PDEreader__object* self, sidl_BaseInterface* _ex) {
  *_ex  = NULL; /* default to no exception */
  return FALSE;
}

struct pde_PDEreader__method {
  const char *d_name;
  void (*d_func)(struct pde_PDEreader__object*,
...
ior_pde_PDEreader__exec(
  ...
  struct sidl_BaseInterface__object **_ex )
{
  static const struct pde_PDEreader__method  s_methods[] = {
    { "_cast", pde_PDEreader__cast__exec },
    { "addRef", pde_PDEreader_addRef__exec },
    { "deleteRef", pde_PDEreader_deleteRef__exec },
    { "getClassInfo", pde_PDEreader_getClassInfo__exec },
    { "getPDEdescription", pde_PDEreader_getPDEdescription__exec },
    { "isSame", pde_PDEreader_isSame__exec },
    { "isType", pde_PDEreader_isType__exec },
    { "setServices", pde_PDEreader_setServices__exec }
  };
  int i, cmp, l = 0;
  int u = sizeof(s_methods)/sizeof(struct pde_PDEreader__method);
  *_ex  = NULL; /* default to no exception */
...
static void pde_PDEreader__init_epv(void)
{
/*
 * assert( HAVE_LOCKED_STATIC_GLOBALS );
 */

  struct pde_PDEreader__epv*               epv  = &s_my_epv__pde_pdereader;
  struct gov_cca_Component__epv*           e0   = &s_my_epv__gov_cca_component;
  struct gov_cca_Port__epv*                e1   = &s_my_epv__gov_cca_port;
  struct pdeports_PDEdescriptionPort__epv* e2   = &s_my_epv__pdeports_pdedescriptionport;
  ...
  epv->f__cast                 = ior_pde_PDEreader__cast;
  epv->f__delete               = ior_pde_PDEreader__delete;
  epv->f__exec                 = ior_pde_PDEreader__exec;
  epv->f__getURL               = ior_pde_PDEreader__getURL;
  epv->f__raddRef              = ior_pde_PDEreader__raddRef;
  epv->f__isRemote             = ior_pde_PDEreader__isRemote;
  epv->f__set_hooks            = ior_pde_PDEreader__set_hooks;
  epv->f__set_contracts        = ior_pde_PDEreader__set_contracts;
  epv->f__dump_stats           = ior_pde_PDEreader__dump_stats;
  epv->f__ctor                 = NULL;
  epv->f__ctor2                = NULL;
  epv->f__dtor                 = NULL;
  epv->f_addRef                = (void (*)(struct pde_PDEreader__object*,struct sidl_BaseInterface__object **)) s1->f_addRef;
  epv->f_deleteRef             = (void (*)(struct pde_PDEreader__object*,struct sidl_BaseInterface__object **)) s1->f_deleteRef;
  epv->f_isSame                = (sidl_bool (*)(struct pde_PDEreader__object*,struct sidl_BaseInterface__object*,struct sidl_BaseInterface__object **)) s1->f_isSame;
  epv->f_isType                = (sidl_bool (*)(struct pde_PDEreader__object*,const char*,struct sidl_BaseInterface__object **)) s1->f_isType;
  epv->f_getClassInfo          = (struct sidl_ClassInfo__object* (*)(struct pde_PDEreader__object*,struct sidl_BaseInterface__object **)) s1->f_getClassInfo;
  epv->f_getPDEdescription     = NULL;
  epv->f_setServices           = NULL;

  pde_PDEreader__set_epv(epv, &s_preEPV, &s_postEPV);
  ...
  /*
   * Override function pointers for pdeports.PDEdescriptionPort with mine, as needed.
   */
  ...
  e2->f_getPDEdescription     = (int32_t (*)(void*,struct sidl_double__array**,struct sidl_int__array**,struct sidl_int__array**,struct sidl_double__array**,struct sidl_BaseInterface__object **)) epv->f_getPDEdescription;
  ...
  ior_pde_PDEreader__ensure_load_called();
}

/*
 * pde_PDEreader__getEPVs: Get my version of all relevant EPVs.
 */

void pde_PDEreader__getEPVs (
  ...
  struct pdeports_PDEdescriptionPort__epv **s_arg_epv__pdeports_pdedescriptionport,
  struct pdeports_PDEdescriptionPort__epv **s_arg_epv_hooks__pdeports_pdedescriptionport,
  struct pde_PDEreader__epv **s_arg_epv__pde_pdereader,
  struct pde_PDEreader__epv **s_arg_epv_hooks__pde_pdereader)
{
  LOCK_STATIC_GLOBALS;
  if (!s_method_initialized) {
    pde_PDEreader__init_epv();
  }
  ...
  *s_arg_epv__pdeports_pdedescriptionport = &s_my_epv__pdeports_pdedescriptionport;
  *s_arg_epv_hooks__pdeports_pdedescriptionport = &s_my_epv_hooks__pdeports_pdedescriptionport;
  *s_arg_epv__pde_pdereader = &s_my_epv__pde_pdereader;
  *s_arg_epv_hooks__pde_pdereader = &s_my_epv_hooks__pde_pdereader;
}
/*
 * __getSuperEPV: returns parent's non-overrided EPV
 */

static struct sidl_BaseClass__epv* pde_PDEreader__getSuperEPV(void) {
...
initClassInfo(sidl_ClassInfo *info, struct sidl_BaseInterface__object **_ex)
{
  ...
  *_ex  = NULL; /* default to no exception */
  ...
  if (!s_classInfo) {
    ...
    if (impl) {
      sidl_ClassInfoI_setName(impl, "pde.PDEreader", _ex);
...
static void
initMetadata(struct pde_PDEreader__object* self, sidl_BaseInterface* _ex)
{
...
/*
 * pde_PDEreader__createObject: Allocate the object and initialize it.
 */

struct pde_PDEreader__object*
pde_PDEreader__createObject(void* ddata, struct sidl_BaseInterface__object ** _ex)
{
  struct pde_PDEreader__object* self =
    (struct pde_PDEreader__object*) sidl_malloc(
      sizeof(struct pde_PDEreader__object),
      "Object allocation failed for struct pde_PDEreader__object",
        __FILE__, __LINE__, "pde_PDEreader__createObject", _ex);
  if (!self) goto EXIT;
  pde_PDEreader__init(self, ddata, _ex); SIDL_CHECK(*_ex);
...
void pde_PDEreader__init(
  struct pde_PDEreader__object* self,
   void* ddata,
  struct sidl_BaseInterface__object **_ex)
{
  struct pde_PDEreader__object*  s0 = self;
  ...
  *_ex = 0; /* default no exception */
  ...
  s0->d_pdeports_pdedescriptionport.d_epv = &s_my_epv__pdeports_pdedescriptionport;
  s0->d_epv                               = &s_my_epv__pde_pdereader;

  s0->d_gov_cca_component.d_object = self;

  s0->d_gov_cca_port.d_object = self;

  s0->d_pdeports_pdedescriptionport.d_object = self;
...
void
pde_PDEreader__IOR_version(int32_t *major, int32_t *minor)
{
  *major = s_IOR_MAJOR_VERSION;
  *minor = s_IOR_MINOR_VERSION;
}

static const struct pde_PDEreader__external
s_externalEntryPoints = {
  pde_PDEreader__createObject,
  pde_PDEreader__getSuperEPV,
  2, 
  0
};
...
const struct pde_PDEreader__external*
pde_PDEreader__externals(void)
{
