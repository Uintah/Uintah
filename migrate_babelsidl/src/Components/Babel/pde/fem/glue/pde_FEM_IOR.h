...
#include "pdeports_FEMmatrixPort_IOR.h"
#endif
...
struct pde_FEM__epv {
  ...
  /* 0 */
  void* (*f__cast)(
    /* in */ struct pde_FEM__object* self,
    /* in */ const char* name,
  ...
  int32_t (*f_makeFEMmatrices)(
    ...
    /* out */ int32_t* size,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in pde.FEM-v0.1 */
};
...
struct pde_FEM__object {
  ...
  struct pde_FEM__epv*                  d_epv;
  struct pde_FEM__cstats                d_cstats;
  void*                                 d_data;
};

struct pde_FEM__external {
  struct pde_FEM__object*
...
extern struct pde_FEM__object*
pde_FEM__createObject(void* ddata,struct sidl_BaseInterface__object ** _ex);

extern void pde_FEM__init(
  struct pde_FEM__object* self, void* ddata, struct sidl_BaseInterface__object 
    ** _ex);

extern void pde_FEM__getEPVs(
...
extern void pde_FEM__fini(
  struct pde_FEM__object* self, struct sidl_BaseInterface__object ** _ex);

extern void pde_FEM__IOR_version(int32_t *major, int32_t *minor);
