/*
 * File:          pdeports_MeshPort_IOR.h
 * Symbol:        pdeports.MeshPort-v0.1
 * Symbol Type:   interface
 * Babel Version: 1.4.0 (Revision: 6574 release-1-4-0)
 * Description:   Intermediate Object Representation for pdeports.MeshPort
 * 
...
#define included_pdeports_MeshPort_IOR_h
...
struct pdeports_MeshPort__array;
...
struct pdeports_MeshPort__pre_epv {
...
struct pdeports_MeshPort__post_epv {
...
struct pdeports_MeshPort__object {
  struct pdeports_MeshPort__epv* d_epv;
  void*                          d_object;
};
 ...
 */
/*
 * Symbol "pdeports._MeshPort" (version 1.0)
 */

struct pdeports__MeshPort__array;
struct pdeports__MeshPort__object;

/*
 * Declare the method entry point vector.
 */

struct pdeports__MeshPort__epv {
  /* Implicit builtin methods */
  void* (*f__cast)(
  ...
  int32_t (*f_triangulate)(
    ...
    /* out array<int> */ struct sidl_int__array** triangles,
    /* out */ struct sidl_BaseInterface__object **_ex);
  /* Methods introduced in pdeports._MeshPort-v1.0 */
};
...
struct pdeports__MeshPort__cstats {
  sidl_bool use_hooks;
};
...
struct pdeports__MeshPort__object {
  ...
  struct pdeports__MeshPort__epv*   d_epv;
  void*                             d_data;
};


struct pdeports__MeshPort__remote{
  int d_refcount;
