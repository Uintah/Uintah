...
Anneal::Anneal(const Anneal& copy, int deep)
: Module(copy, deep)
{
   NOT_FINISHED("Anneal::Anneal");
}
...
Module* Anneal::clone(int deep)
{
   return scinew Anneal(*this, deep);
}

void Anneal::execute()
{
int i,j,ielectrode,i_E,i_elec;
double sb,ss,st,voltage,error_best;
parameterset param,bestparam;
