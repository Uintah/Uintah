...
public:
    ...
    SiReAll(const SiReAll&, int deep);
    virtual ~SiReAll();
...
SiReAll::SiReAll(const SiReAll& copy, int deep)
: Module(copy, deep)
{
    NOT_FINISHED("SiReAll::SiReAll");
}
...
Module* SiReAll::clone(int deep)
{
    return new SiReAll(*this, deep);
}
