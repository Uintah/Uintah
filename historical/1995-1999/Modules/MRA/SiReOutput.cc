...
public:
    ...
    SiReOutput(const SiReOutput&, int deep);
    virtual ~SiReOutput();
...
SiReOutput::SiReOutput(const SiReOutput& copy, int deep)
: Module(copy, deep)
{
    NOT_FINISHED("SiReOutput::SiReOutput");
}
...
Module* SiReOutput::clone(int deep)
{
    return new SiReOutput(*this, deep);
}
