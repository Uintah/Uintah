...
#	puts "here!"
	...
	if {[winfo exists $w.plot]} {
	    ...
	    opengl $w.plot.gl -geometry 300x300 -doublebuffer false -direct false -rgba true -redsize 2 -greensize 2 -bluesize 2 -depthsize 0
	...
	if {[winfo exists $w.plot.snoop]} {
	    ...
	    opengl $w.plot.snoop.gl -geometry 300x300 -doublebuffer false -direct false -rgba true -redsize 2 -greensize 2 -bluesize 2 -depthsize 0
